...
source_url: https://ahrefs.com/blog/earn-more-links/
...
Because most of us base our [content strategy](https://ahrefs.com/blog/content-marketing-strategy/) on the “most linked” content on a topic.

Too often, that focuses attention on great websites rather than [great content](https://ahrefs.com/blog/how-to-write-great-content/). Many of the “top performers” are mediocre articles that earn links solely because they’re on popular sites.
...
Take a topic like “retirement planning.” A mediocre, 900-word post like [this one](https://www.forbes.com/sites/megangorman/2018/05/27/generation-x-our-top-2-retirement-planning-priorities/) earned backlinks from 51 referring domains for Forbes.com:

Meanwhile, [a comprehensive, 5,000-word post](https://financialmentor.com/retirement-planning/preparing-for-retirement/18230) on a medium-size financial planning website earned links from 21:
...
We started by dropping “retirement planning” into [Content Explorer](https://ahrefs.com/content-explorer), which gives us about 77,000 results.
...
The lowest [Domain Rating (DR)](https://ahrefs.com/blog/domain-rating/) is 77, and most sites in the top 10 enjoy a domain rating in the 90s.
...
**Date**: Reduced to the last two years to focus on current topics;**Language**: English only, since the community is in the United States;**Total shares:**10 and above to add a baseline of social success;**Domain Rating**: 15 and above to add a baseline of site quality (while not excluding smaller sites);**Referring domains:**5 and above to add a baseline of backlink success;**Organic traffic**: 30 and above to focus on search-worthy topics.

You may want to adjust the baseline figures outlined above depending on your needs and the total number of results.

[Domain Rating (DR)](https://ahrefs.com/blog/domain-rating/)is an effective way to remove low-quality content or spammy sites from your list—it’s generally possible to “fake” one of those metrics with a PBN or Twitter botnet; it’s quite difficult to achieve all four.
...
Two tools offer quick ways to add domain-level metrics from Ahrefs to a list of individual URLs: [URL Profiler](https://urlprofiler.com/) and [Screaming Frog](https://www.screamingfrog.co.uk/seo-spider/).

Connect either tool to the [Ahrefs API](https://ahrefs.com/apps) and drop in your list of URLs. (Both work well, although URL Profiler is a bit quicker since it collects less data for each URL.)

### Step 4: Organize your data

Add a column to the export file from Content Explorer and [use =VLOOKUP](https://ahrefs.com/blog/google-sheets-formulas-seo/) to add the domain-level data from URL Profiler or Screaming Frog.
...
In fact, some perform *worse* than the average post on the site. To find [exceptional content](https://ahrefs.com/blog/content-marketing-examples/), we need to identify the overachievers.
...
[Site Explorer](https://ahrefs.com/site-explorer) > enter competing domain > Competing domains
...
[Keywords Explorer](https://ahrefs.com/keywords-explorer) > enter a few relevant keywords > Traffic share by domains
...
Corporations seem like a ripe opportunity. With this knowledge, we can return to [Content Explorer](https://ahrefs.com/content-explorer) to conduct topical research about corporate outings and team building.
