---
title: "Content Outlines: How to Write Better Content Faster"
source_url: https://ahrefs.com/blog/content-outline/
...
[What a content outline is](#1-what-is-a-content-outline)[Why you should always outline your content](#2-why-you-should-outline-your-content)[Our content outline template](#3-download-our-content-outline-template)[How to outline your content in five simple steps](#4-how-to-outline-your-content-in-five-steps)
...
**An outline guarantees you include important things****for**– These include having the right keywords and satisfying the searchers’ intent by addressing their most common questions.[search engine optimization (SEO)](https://ahrefs.com/blog/what-is-seo/)**An outline helps you improve the flow of your article before you start writing**– If you just dive into the writing, your ideas can be all over the place and you may have to spend a lot of time reorganizing the information to be more logical… and this process can be a*nightmare*without an outline.**You can more easily outsource content at scale with proper outlines**– With a great outline, even a mediocre writer can produce great content. If you want to scale up your content production with any level of quality control, good outlines are a necessity.

So how do you write a great content outline?

[Click here to make a copy](https://docs.google.com/document/u/4/d/1Vg9qJMZJyVCOmAAyuQysTmHmNUUEDTN9wg_NR2KnyHc/copy) of our content outline template.
...
[Building backlinks](https://ahrefs.com/blog/what-are-backlinks/)for SEO.- Growing your email list.
...
I never write an article without doing some [basic keyword research](https://ahrefs.com/seo/keyword-research) first. Even if the intention of your article isn’t to rank for keywords on search engines, having SEO built into every article you write is still good practice.
...
You can easily perform simple keyword research like this by putting keywords related to what you want to write about into Ahrefs’ [Keywords Explorer](https://ahrefs.com/keywords-explorer) and browsing the results.

For our article about how to make the best bowl of ramen noodles, I start by searching for “ramen noodles” in [Keywords Explorer](https://ahrefs.com/keywords-explorer):
...
Scroll down, and you’ll see that the search results in the [SERP](https://ahrefs.com/blog/serps/) overview consist of two product pages (Maruchan and Amazon). Those are followed by some extremely authoritative websites:
...
In fact, the [featured snippet](https://ahrefs.com/blog/featured-snippets/) website has a [Domain Rating (DR) score](https://ahrefs.com/blog/domain-rating/#:~:text=What%20is%20Domain%20Rating%3F,Sidenote.) of just 20, which signals that even a newer website with fewer backlinks can likely rank for this keyword.
...
Search intent is important because it determines the kind of content you should create for a given keyword. There are four primary [types of search intent](https://ahrefs.com/blog/types-of-search/):
...
Refer to [our guide to search intent](https://ahrefs.com/blog/search-intent/) for more information on each of these. For now, let’s continue with the example we used above on “how to make ramen noodles.”
...
*Easy*Ramen Noodles- Ramen Noodles
*in the Microwave* *Perfect*and*Instant*Ramen Noodles
...
Think about how you can make your article stand out among the crowd like these guys did. Dig into the SERPs and the “People Also Ask” boxes to try and determine what the searchers are going after. Read forum posts like those on [Reddit](https://www.reddit.com/) and try to find ways you can address problems people are having that your competitors aren’t talking about.
...
Check out [this guide to writing the best blog titles](https://ahrefs.com/blog/blog-title-formulas/) for more information.

### 5. Outline your article with headings and subheadings

Here’s where the bulk of the outline work comes in. Choosing headings, ordering those headings, and explaining what should go in each section will determine the quality of the final result. It’s also important for [on-page SEO](https://ahrefs.com/seo/on-page-seo).
...
You can see I have H2s for all the main headings. Further down, I also have each step as an H3 (you can see that when you [make a copy of the outline template](https://docs.google.com/document/u/4/d/1Vg9qJMZJyVCOmAAyuQysTmHmNUUEDTN9wg_NR2KnyHc/copy)).
