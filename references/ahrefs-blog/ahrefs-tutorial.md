...
source_url: https://ahrefs.com/blog/ahrefs-tutorial/
...
[Site Explorer](https://ahrefs.com/site-explorer) is our competitive research tool. With Site Explorer, you can see a website’s:
...
- Enter your domain
- Go to the
**Best by links**report - Set the
**HTTP code filter**to 404
...
- Enter your domain
- Go to the
**Organic keywords**report - Set a
**Positions**filter from 1 - 10 (you need to be on the first page to win it) - Set a
**SERP features**filter to “where target doesn’t rank” and check featured snippet
...
For example, say we want to analyze the backlink profile of HubSpot’s [blog post on email marketing statistics](https://blog.hubspot.com/marketing/email-marketing-stats). We want to create a competing page targeting that topic, so we want to know how HubSpot got so many links to their page.
...
FYI, that’s exactly what we did for our [SEO statistics post](https://ahrefs.com/blog/seo-statistics/). Since then, we’ve earned thousands of backlinks and ranked #1 consistently.
...
- Enter your competitor’s domain
- Go to the
**Best by links**report - Set a
**HTTP code**filter to 404 not found
...
[Keywords Explorer](https://ahrefs.com/keywords-explorer) is our keyword research tool.
...
**Include**filter for these modifiers (how, what, when, where, why, tutorial, tips)
...
[Site Audit](https://ahrefs.com/site-audit) lets you crawl your website to find and monitor for 100+ technical and on-page SEO issues.
...
- Go to
**Page Explorer** - Hit
**Advanced**filter - Create a rule to find URLs that have an external link containing amzn.to (Amazon’s short link).
- Set an
**Organic traffic**filter to show pages that get at least 1,000 monthly organic visits
...
For example, let’s say we want to add internal links to our [blog post on keyword research](https://ahrefs.com/seo/keyword-research). In the report, we can set a **Target page** filter and paste the URL to our keyword research guide.

We now have over 200 potential pages we can link from.

[Rank Tracker](https://ahrefs.com/rank-tracker) lets you monitor your Google rankings over time. You can track rankings from any country, city, zip, or postal code. On top of that, you can segment your keywords using tags and track your performance against your competitors.
...
[Content Explorer](https://ahrefs.com/content-explorer) is a search engine for marketers with billions of pages in its index. Search for any topic, and you’ll see all pages that match your query, along with their SEO and social metrics.
...
- Set a
**Referring domains**filter <10 (to find low-competition topics) - Set a
**Page traffic**filter >500 (to find topics with high traffic potential) - Set a
**Word count**filter >500 (to find blog content)
...
- Set a
**DR**filter of 30-65 (to find low- to mid-authority websites) - Set a
**Website traffic**filter of >5,000 (to find sites that get a good amount of search traffic) - Set a
**Word count**filter of >500 (to narrow results to blog content)
...
Web Explorer allows you to search through all pages, domains, and links that are indexed by [Yep](https://yep.com/), which is our search engine. This index is around 500 billion pages, ~36 times larger than Content Explorer’s index.
...
We’ve barely scratched the surface with all available use cases in Ahrefs. That’s why we’ve also created a [7-hour certification course](https://ahrefs.com/academy/certification-course) that digs deep into how Ahrefs works. I highly recommend checking it out.

Even though we’ve covered our core tools, we have some other tools as well.

Check out [Competitive Analysis](https://app.ahrefs.com/competitive-analysis), which includes tools like [Content Gap](https://ahrefs.com/content-gap) and [Link Intersect](https://ahrefs.com/link-intersect).

Our [Batch Analysis](https://ahrefs.com/batch-analysis) tool lets you get SEO metrics on up to 200 targets in seconds:

And don’t forget to install our [free SEO toolbar](https://ahrefs.com/seo-toolbar) where you can get Ahrefs metrics laid over your SERPs and web pages.

Any questions or comments? [Let me know on X (Twitter)](https://twitter.com/siquanong).
