...
source_url: https://ahrefs.com/blog/wix-seo/
...
[Wix](https://www.wix.com/) has a bit of a bad reputation for SEO. This is because from its launch in 2006 until its first big update in 2016, it lacked many basic SEO functionalities like adding alt text and being able to change URL structures.

However, that is no longer the case. You can now do virtually every [on-page SEO](https://ahrefs.com/seo/on-page-seo) task using the Wix platform. It even hired expert SEOs, such as [Mordy Oberstein](https://twitter.com/MordyOberstein) and [Crystal Carter](https://twitter.com/CrystalontheWeb), who have pushed for more SEO features and better communication.
...
Here’s a [quote by John Mueller](https://www.searchenginejournal.com/google-john-mueller-wordpress-versus-wix/), Google’s senior search analyst, on the topic of Wix SEO:
...
**Website builders will typically load slower than custom code**– Wix inevitably has code bloat from features you will never use. This is true even if you use WordPress and install a theme builder like Elementor or Thrive Architect, so this isn’t exclusive to Wix. That said, it’s only a minor issue, and it already has great[Core Web Vitals](https://ahrefs.com/blog/core-web-vitals/)compared to other CMS types.**Less-than-ideal multilingual support**– If you plan on publishing your blog posts in multiple languages, you may want to skip Wix. For example, you don’t have full control over the URLs for different language versions of your site. However, some of these aspects are[in its feature requests](https://support.wix.com/en/article/wix-multilingual-request-customizing-local-urls)and may be available soon.**Limited advanced SEO control**– Wix lacks some advanced SEO features. For example, it’s difficult to edit the auto-generated[sitemap](https://ahrefs.com/seo/glossary/sitemap). Additionally, Wix generates cryptic file names for images (e.g., 09a0ab7~mv2.jpg/), which is not good for ranking on Google Images.
...
From there, you’ll be asked a few questions to get started, such as your business name and the top three to five keywords you want your website to rank for. If you’re not sure which keywords to target, I highly recommend reading [our guide to keyword research](https://ahrefs.com/seo/keyword-research).
...
SEO Setup Checklist will guide you through the process of updating your pages’ [meta tags](https://ahrefs.com/blog/seo-meta-tags/), making your website mobile-friendly, and more.
...
You’ll notice one of the steps is to connect your site to [Google Search Console](https://search.google.com/search-console/about) (GSC). This is Google’s suite of tools designed for website owners like you to more easily monitor your search rankings and find issues preventing your pages from being indexed by [Googlebot](https://ahrefs.com/blog/googlebot/).

You can set up GSC with the click of a button using the SEO Setup Checklist. If you want to learn more, check out [our complete guide to Google Search Console](https://ahrefs.com/blog/google-search-console/).

Once GSC is set up, you can connect [Google Analytics](https://analytics.google.com/) (GA) to your website to get more insights into where your traffic is coming from and which pages your visitors are going to.
...
Wix will instruct you on how to create a Google Analytics Property ID and connect that ID with your Wix website. If you need more help, we also have a [guide on Google Analytics 4](https://ahrefs.com/blog/how-to-use-google-analytics/).
...
Rather than making this whole article about content, I will leave you with a resource. Go check out [our guide to SEO content](https://ahrefs.com/seo/seo-content) to learn more.

### 4. Add internal links

[Backlinks](https://ahrefs.com/blog/what-are-backlinks/)—links from another website pointing to your website—are one of the most important [ranking factors in Google’s algorithm](https://ahrefs.com/blog/google-ranking-factors/). However, they can be difficult to obtain.
...
Check out [our internal linking guide](https://ahrefs.com/blog/internal-links-for-seo/) to learn more about this important SEO task.
...
Instead, you can use [Ahrefs Webmaster Tools](https://ahrefs.com/webmaster-tools) to automatically run weekly or monthly audits of your website. This free tool will give you a health score from 0 to 100 on how “healthy” your website is from an SEO perspective.
...
One more benefit to using a website builder like Wix is that it’s a complete solution and takes care of the hosting and security. In fact, [John doesn’t recommend](https://www.searchenginejournal.com/google-john-mueller-wordpress-versus-wix/) self-hosting your websites.
