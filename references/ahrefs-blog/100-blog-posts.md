---
title: "I Wrote 100+ Blog Posts for the Ahrefs Blog. Here's What I Learned."
source_url: https://ahrefs.com/blog/100-blog-posts/
...
So, I decided to reflect on my journey. I did two Ask Me Anything (AMA) sessions to see what people wanted to know: [one on Twitter X](https://twitter.com/siquanong/status/1737659157803901072) and

[another on LinkedIn](https://www.linkedin.com/posts/si-quan-ong_ive-written-100-blog-posts-for-the-ahrefs-activity-7140166423636537345-Rt5y/). I was pleasantly surprised that so many people were interested, so thank you to everyone for the kind questions.
...
For example, I could have listed every potential link-building strategy in [my post on white hat link-building](https://ahrefs.com/blog/white-hat-link-building-techniques/). While that might have been useful for some, it would have been overwhelming for most. Not to mention, there would have been no indication of what works in real life.

So, I kept it simple and focused only on the tactics that SEOs vouched for.

My best-performing article is my post on [affiliate marketing](https://ahrefs.com/blog/affiliate-marketing/). I didn’t “write” it; all I did was repurpose [Sam’s video](https://www.youtube.com/watch?v=W-nbsnXtSZI).

My worst-performing article is… I have too many to count. I put a lot of work into some of them. My post on [Quora marketing](https://ahrefs.com/blog/quora-marketing/) had me spending time on the platform, but it never got any strong traction. I had to sign up and prompt 39 AI writing tools for my post on [AI writing tools](https://ahrefs.com/blog/ai-writing-tools/), but the joke never landed. My favorite post—[marketing skills](https://ahrefs.com/blog/marketing-skills/)—was written from my six years of experience as a digital marketer but got nowhere either.
...
Rankings don’t last forever. That’s why refreshing content is an integral part of [our SEO content strategy](https://ahrefs.com/blog/seo-content-strategy/).

For example, I’ve updated the post on affiliate marketing twice. I’ve also updated [alternative search engines](https://ahrefs.com/blog/alternative-search-engines/) twice, [SEO statistics](https://ahrefs.com/blog/seo-statistics/) twice (and counting), [evergreen content](https://ahrefs.com/blog/evergreen-content/) twice, and [top Google searches](https://ahrefs.com/blog/top-google-searches/) countless times.
...
For example, I’ve done several guest posts myself. That’s how I could offer plenty of unique tips when I wrote [my post on guest blogging](https://ahrefs.com/blog/guest-blogging/). I even presented plenty of evidence of my guest posts, my interactions with publishers, and more.
...
For example, our [post on long-tail keywords](https://ahrefs.com/blog/long-tail-keywords/) tried to correct the misconception that long-tail keywords are long (i.e., 3+ words) keywords. In reality, they are long-tail due to their position on the search demand curve.

It’s a similar story for my [post on creating an SEO campaign](https://ahrefs.com/blog/seo-campaign/). Most guides on that topic were simply a masquerade for another “beginner’s guide to SEO.” I tried to focus specifically on what a “campaign” was and the three major steps to setting one up.

My first few posts on the Ahrefs blog were long. Too long, in fact. They were rambly and meandering. This was partly because I believed that long = good. [Skyscraper](https://ahrefs.com/blog/skyscraper-technique/), right?
...
If you want to improve your writing and content marketing, why not [join me on the same journey](https://twitter.com/siquanong) to write 100 and more?
