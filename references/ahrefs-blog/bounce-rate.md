---
title: "What Is Bounce Rate? How to Interpret and Work with It"
source_url: https://ahrefs.com/blog/bounce-rate/
...
[How Google Analytics calculates bounce rate](#bounce-rate-calculation)[Is bounce rate important?](#bounce-rate-importance)[Bounce rate vs. exit rate vs. dwell time](#bounce-rate-exit-rate-dwell-time)[How to interpret and use bounce rate](#interpreting-bounce-rate)[What is a good bounce rate?](#good-bounce-rate)[How to improve your bounce rate](#how-to-improve-your-bounce-rate)
...
**Ad blockers**. These usually prevent tracking codes from firing, so you won’t see these users in your analytics at all.**Slow-loading pages**: Impatient users might bounce before the tracking code loads.**Session timeouts**: There are[multiple ways](https://support.google.com/analytics/answer/2731565)sessions can expire even if the user plans to engage with the website further.**Improper tracking setup**: We’ll look into that later.
...
**Campaign #1:**0.07%**Campaign #2:**0.22%**Campaign #3:**0.94%**Campaign #4:**1.03%**Campaign #5:**5.02%**Campaign #6:**0.79%
...
[Dwell time](https://ahrefs.com/seo/glossary/dwell-time) is the amount of time between a user clicking on a search result and returning to the [SERP](https://ahrefs.com/blog/serps/). Unlike bounce rate, it’s not a metric you’ll find in Google Analytics. The SEO community created it because it’s thought to be a possible [ranking factor](https://ahrefs.com/blog/google-ranking-factors/).

You can technically set up [custom dwell time tracking](https://www.simoahava.com/analytics/measure-serp-bounce-time-with-gtm/) in GA, but that’s way out of the scope of this article.
...
[Weighted Sort](https://support.google.com/analytics/answer/1042020?hl=en)instead of excluding low traffic pages when possible. It just doesn’t work for segmented reports like this one.
...
- Your
[title tag](https://ahrefs.com/blog/title-tag-seo/)and/or[meta description](https://ahrefs.com/blog/meta-description/)doesn’t align with your page’s content, so users leave. The same can apply to ad copy for your performance channels. - It’s a type of page where people bounce naturally.
...
Bounce rates significantly differ between landing pages and their traffic sources as there are many marketing channels and multiple phases of the [customer journey](https://ahrefs.com/blog/marketing-funnels/).
...
No, I’m not contradicting myself. It’s more like “wrong bounce rate” than “bad bounce rate” because data can sometimes be skewed and inaccurate. If you see bounce rates that seem way too high or low, this is probably the case, and you should investigate your analytics setup for [tracking mistakes](https://ahrefs.com/blog/google-analytics-tracking-mistakes/).

Here are just a few common problems:

**Duplicate tracking code.**Are all your bounce rates zero or close-to-zero? You almost certainly have an issue with duplicate tracking codes.[Here’s how to fix it](https://ahrefs.com/blog/google-analytics-tracking-mistakes/#missing-duplicate-ga-codes).**Incorrectly set up interaction events.**Events in Google Analytics are interactive by default. If you use them, make sure to switch this off for minor events (e.g., scroll depth tracking).[Learn how to handle events properly here](https://ahrefs.com/blog/google-analytics-tracking-mistakes/#incorrect-interaction-event-setup).**Not firing virtual pageviews on JavaScript-heavy websites.**You need to implement something called virtual pageviews if you don’t want your bounces to be skewed.[Learn more here](https://developers.google.com/analytics/devguides/collection/analyticsjs/single-page-applications#tracking_virtual_pageviews).
...
[Give people what they came for](#give-people-what-they-came-for)[Improve your copywriting](#improve-copywriting)[Be mobile-friendly](#be-mobile-friendly)[Moderate your ads, pop-ups and interstitials](#moderate-ads)[Improve your internal linking](#improve-internal-linking)[Improve your site speed](#improve-site-speed)[Focus on everything else related to user experience](#user-experience)
...
**Recommended reading:** [12 Easy SEO Copywriting Tips for Better Content and Higher Rankings](https://ahrefs.com/blog/seo-copywriting/)
...
Nobody will keep browsing your website unless you provide them with links to related useful resources. And that’s where [internal linking](https://ahrefs.com/blog/internal-links-for-seo/) comes in.

Internal links are clickable links from one page on a website to another. You’ll see them scattered throughout this post and most others on [our blog](https://ahrefs.com/blog/). They’re not only useful for enticing visitors to consume more content but are also helpful for SEO. Just make sure that you’re interlinking related pages using relevant words and phrases.

You can use the free **Internal link opportunities** report in [Ahrefs Webmaster Tools](https://ahrefs.com/webmaster-tools) to help with this. It scans your site for places where you might be missing relevant internal links.

For example, here, the report suggests that we might want to internally link from our post about [Ahrefs’ unique features](https://ahrefs.com/blog/unique-features-ahrefs/) to our post about [anchor text](https://ahrefs.com/blog/anchor-text/). It even suggests the words we might want to use for the link.
...
[Improving your site speed](https://ahrefs.com/blog/core-web-vitals/) is a big topic on its own. I’ll only list a few things that can eliminate your hidden bounces due to slow page loading times:
...
- Use
[HTTPS](https://ahrefs.com/blog/what-is-https/)in combination with HTTP/2, server push, optimized resources prioritization and TLS 1.3 (all should be available with good hosting providers and CDNs) - Use compression algorithms like gzip and Brotli (supported by most hosting providers and CDNs)
[Optimize your images](https://ahrefs.com/blog/image-seo/)and load them only when needed (lazy loading)- Load your scripts asynchronously with async or defer attributes

As I said, there’s much more to site speed than this. It’s a fairly advanced and technical topic. I’d encourage you to go through our articles ([site speed in general](https://ahrefs.com/blog/core-web-vitals/) /[ site speed for WordPress](https://ahrefs.com/blog/speed-up-wordpress/)), test your website, and consult with experts.
...
You can use the **Performance** report in free [Ahrefs Webmaster Tools](https://ahrefs.com/webmaster-tools) to get an overview of your website speed metrics:
