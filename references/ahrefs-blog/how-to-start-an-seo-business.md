---
title: "How to Start an SEO Business in 6 Steps"
source_url: https://ahrefs.com/blog/how-to-start-an-seo-business/
...
My business wasn’t huge. At its peak, I was turning over between $5k-$10k per month. So if you’re here expecting to learn from the founder of a Fortune 500 company, prepare to be disappointed.
...
Let’s start with the obvious place: the [Ahrefs Blog](https://ahrefs.com/blog/) and [YouTube channel](https://www.youtube.com/channel/UCWquNQV8Y0_defMKnGKrFOQ). We’ve published hundreds of [SEO tutorials](https://ahrefs.com/blog/seo-tutorial/) over the years, many of which are perfect for beginners. I’m clearly biased, but I don’t think there’s a better starting point for learning SEO these days.

If you’re unsure where to begin, check out [our beginner’s guide to SEO](https://ahrefs.com/seo) or [SEO video course for beginners](https://ahrefs.com/academy/seo-training-course).

If you’d prefer to start elsewhere, check out Aleyda Solis’ website: [learningseo.io](https://learningseo.io/).
...
How do you get experience? Create your own website and use it as a testing ground for your [SEO skills](https://ahrefs.com/blog/seo-skills/).
...
If you’re not sure where to start, read [our guide to keyword research](https://ahrefs.com/seo/keyword-research) or watch [this video](https://www.youtube.com/watch?v=OMJQPqG2Uas):

While practicing and honing your SEO skills on your own website, you’ll start to get an idea of what you enjoy the most.

This is different for everyone. For me, it was [link building](https://ahrefs.com/seo/link-building) and [content creation](https://ahrefs.com/blog/content-creation/). I found that I didn’t really enjoy the technical side of things, and things like [keyword research](https://ahrefs.com/seo/keyword-research) and [on-page SEO](https://ahrefs.com/seo/on-page-seo) were just things I had to do. I certainly didn’t love them.

But why is this important for starting an SEO business?

Simple. Because SEO agencies offering “all-in-one” [SEO services](https://ahrefs.com/blog/how-to-sell-seo-services/) to businesses are ten-a-penny. While I don’t want to discourage anyone from starting such a business, I had more success when I specialized and offered services in one area.
...
How do I know? I found my first ever SEO client on [People Per Hour](https://www.peopleperhour.com/).
...
Given that [most SEO professionals charge $500-$1,000 per month](https://ahrefs.com/blog/seo-pricing/), five conversions are worth between $2,500-$5,000 per month. If we assume that clients stick around for an average of 6 months, those five conversions are worth $15,000-$30,000.
...
If you’re interested in this route, check out [this post](https://ahrefs.com/blog/seo-leads/) where Daryl Rosser explains how to sell SEO services via emails, step-by-step.

### Inbound marketing

Because I’m introverted, [inbound marketing](https://ahrefs.com/blog/inbound-marketing/) was the primary method I decided to use to attract clients. So, in 2016, I started a website called The SEO Project to begin putting myself on the map.
...
- Created a piece of content about
[link building](https://ahrefs.com/seo/link-building)(the service I wanted to offer) - Offered the full list as a PDF in return for visitors’ email addresses
- Did
[outreach](https://ahrefs.com/blog/blogger-outreach/)to spread the word about my content - Planned to “sell” my services via the email list
...
[rank high in Google](https://ahrefs.com/blog/how-to-rank-higher-on-google/)for lucrative terms (e.g., “seo consultant london”) - Attract potential customers through a YouTube channel
[Run PPC ads on Google](https://ahrefs.com/blog/ppc-marketing/)- Write guest posts

Let’s talk a little more about that last one.

### Guest posting

[Guest posting](https://ahrefs.com/blog/guest-blogging/) is another tactic I successfully used to attract clients, as you can see from this email:
...
If you’re planning to give this tactic a shot, my best advice is this: only write guest posts for industry websites that get traffic. Remember, we’re not using guest posting as a [link building tactic](https://ahrefs.com/blog/link-building-strategies/); we’re using it as a [marketing tactic](https://ahrefs.com/blog/marketing-tactics/).

The easiest way to find such websites is with Ahrefs’ [Content Explorer](https://ahrefs.com/content-explorer), a searchable database of content from over seven billion websites.

Here’s how to use it to find guest posting opportunities:

- Open
[Content Explorer](https://ahrefs.com/content-explorer) - Search for something related to SEO
...
**If you’re looking for a free app**, try [Invoice Ninja](https://www.invoiceninja.com/). You can send as many invoices as you like, set recurring invoices to automate invoicing for SEO clients on retainers, and it integrates with most payment gateways. I used this for years in the early days of my business.

**If you’re looking for a paid app**, try [Xero](https://www.xero.com/uk/). This is an accounting app, but it handles invoicing too. It also integrates with most business accounts and payment gateways. Xero has been my app of choice for a few years.

### Get a multi-currency account

Nothing is more frustrating than having a client ready to pay but no easy way to receive funds in their native currency. This isn’t usually a problem if you’re doing [local SEO](https://ahrefs.com/seo/local-seo) and working with clients in one country, but it quickly becomes a problem if you’re working with SEO clients internationally.
...
Let me know [on Twitter](https://twitter.com/joshuachardwick?lang=en) if you have any questions.
