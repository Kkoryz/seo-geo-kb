---
title: "18 Common Types of Marketing (Examples Included)"
source_url: https://ahrefs.com/blog/types-of-marketing/
category: ahrefs-blog
section: "Ahrefs blog — SEO methodology"
date: 2021-11-17
---

# 18 Common Types of Marketing (Examples Included)

To simplify matters, here are 18 common types of marketing that have been developed, tried, and tested by generations of marketers from various industries.
...
Digital marketing is an overarching term for any kind of promotional activity that leverages the internet as the messaging channel. Accordingly, even two different marketing tactics, like [SEO](https://ahrefs.com/seo) and [PPC](https://ahrefs.com/blog/ppc-marketing/), are considered digital marketing.

This term is often used to differentiate a category of tactics from offline marketing.

### Example

At Ahrefs, we use various [digital marketing tactics](https://ahrefs.com/blog/digital-marketing-tactics/) and tools to share our expertise in SEO and marketing and promote our product.

Often, a particular topic, such as an [SEO checklist](https://ahrefs.com/blog/seo-checklist/), will be used in a blog post, then repurposed on other platforms and promoted through different channels; all of that is digital marketing.
...
Here’s one you can follow.[pic.twitter.com/65brjXPBcg][August 15, 2021]

We’ve also promoted the checklist through [online advertising](https://ahrefs.com/blog/online-advertising/). This example is from [Quora Ads](https://ahrefs.com/blog/quora-ads/):
...
The [“Whassup?” campaign](https://www.nytimes.com/2001/02/16/business/the-media-business-advertising-whassup-america-s-asking.html) won many advertising awards, including the Cannes Grand Prix, and helped the company increase sales from 2.4 million barrels to 99.2 million barrels in 2020.
...
Ahrefs’ free tools, such as the [free backlink checker](https://ahrefs.com/backlink-checker), are designed as a form of inbound marketing.
...
Content marketing is the process of creating and [distributing content](https://ahrefs.com/blog/content-distribution/) to attract and retain customers.
...
Content marketing is often used to [generate leads](https://ahrefs.com/blog/lead-generation/), where the most premium content is gated behind a form requesting personal information like name, phone number, or email. Later on, that information is used for other marketing tactics (including outbound).
...
The table below explains the differences between growth marketing, “traditional marketing,” and [growth hacking](https://ahrefs.com/blog/growth-hacking/).

### Example

There are many amazing and inspirational modern growth stories: Slack, Spotify, Uber, or Square.

But I want to point you in the direction of [Notion’s](https://www.notion.so/) growth marketing strategy because it seems to get nearly every aspect of growth marketing right. Plus, it’s been analyzed dozens of times, so it makes a great example for entrepreneurs and marketers to learn from.
...
Here’s a graphic from [Foundation](https://foundationinc.co/lab/notion-strategy) that perfectly explains how this tactic touches the entire marketing funnel and forms a growth loop.

**Learn more:** [What Is Growth Marketing? A Beginner’s Guide](https://ahrefs.com/blog/growth-marketing/)
...
This term is often used by marketers to name and differentiate types of marketing strategies and tactics that are especially effective in B2B relations (e.g., [account-based marketing](https://ahrefs.com/blog/account-based-marketing/)), as opposed to business-to-consumer (B2C) relations.
...
By far, LinkedIn [holds a third of all U.S. B2B digital display ad revenue](https://www.emarketer.com/content/linkedin-holds-third-of-all-us-b2b-digital-display-ad-revenue). As you can see below, even giants like IBM use LinkedIn ads to attract customers.
...
This term is often used by marketers to name and differentiate types of marketing strategies and tactics that are especially effective in B2C relations (e.g., [influencer marketing](https://ahrefs.com/blog/influencer-marketing/)), as opposed to B2B relations.
...
You can spot affiliate links mostly on blogs. Those are the links that contain [tracking parameters](https://ahrefs.com/blog/url-parameters/) like “tag,” “hop,” or “customid.”
...
[This cooking blog ](https://theconscientiouseater.com/how-we-5xd-our-blog-income-in-3-months/)explains how it increased its food blog income by fivefold in three months, one of the tactics being affiliate marketing.
...
— Carter Wilkerson (@carterjwm)[pic.twitter.com/4SrfHmEMo3][April 6, 2017]
...
There are more amazing Wendy’s social media case studies (see [GroupNug](https://marketing.twitter.com/en/success-stories/how-wendy-s-gave-america-a-big-groupnug) or [March Madness](https://marketing.twitter.com/en/success-stories/wendys-turned-to-twitter-to-launch-during-basketballs-busiest-month)). But while pushing the boundaries of corporate marketing, Wendy’s doesn’t forget social media is also about customer service or simply promoting its business from time to time.
...
**Recognize the product**(and distinguish it from the rest) – Otherwise, you’d be asking yourself the question, “Is that the delicious chocolate bar I had last time?”**Associate it with a positive experience**– You may not have tried the product. But if the fantasy of you consuming the product gives you a positive feeling, then that’s all it takes.**Rationalize the cost of the product**– BMWs are not the best-built cars in the world. And they are not the cheapest either. Yet, a BMW is still said to be the “ultimate driving machine.”
...
YouTuber [Meredith Foster](https://www.youtube.com/c/meredithfoster/featured) was one of the few carefully selected influencers to promote Motorola’s new smartphone product line.
...
**Generate traffic**– You can communicate with your audience through emails with the goal to take them from the email to a specific page, e.g., your latest content.**Lead nurturing**– This includes so-called drip campaigns used methodically email by email and touchpoint by touchpoint, leading email subscribers to a purchase opportunity. This process also “qualifies” leads to different types of subscribers, e.g., potential business opportunities or brand fans.**Onboarding**– This refers to a sequence of emails sent through the “[lifecycle](https://ahrefs.com/blog/lifecycle-marketing/)” of a customer to make them discover and experience the value of the product and eventually retain them. A common use of email onboarding is within a trial period of a SaaS product.**Generate revenue**– Like Vans did with me. Brands often offer customers an incentive to sign up for a newsletter, such as 20% off the next purchase. Then it’ll send special offers to newsletter subscribers.
...
**WOMM as a naturally occurring “side effect”**of a company’s operations, such as exceeding consumers’ expectations of a product or service. In such instances, the company may not intend to actively influence the spread of discussions. Yet, the way it’s doing business creates such a strong experience that clients want to share it with friends, family, social media followers, etc.**WOMM as tactics used to intentionally and actively influence**the spread of discussions about the company or its products or services. This kind of WOMM will be the focus of this short chapter.
...
A [Nielsen study](https://www.nielsen.com/eu/en/press-releases/2015/recommendations-from-friends-remain-most-credible-form-of-advertising/) from 2015 revealed that 83% of respondents from 60 countries trusted recommendations from friends and family. But when a recommendation came from an opinion posted online, the trust ratio was down to 66%.

According to another [study by Brightlocal](https://www.brightlocal.com/research/local-consumer-review-survey/), 91% of people regularly or occasionally read online reviews, and 84% trust online reviews as much as a personal recommendation.
...
Watch[#DF21]on Salesforce+:[https://t.co/pXrOL9oVnB][pic.twitter.com/qeZSQjQC8v][September 22, 2021]
...
The basis of marketing for any company is the so-called [marketing mix](https://ahrefs.com/blog/marketing-mix/). A marketing mix is a system of interconnected elements used to bring products or services to the market and effectively communicate them.

Traditionally, the marketing mix (and hence the basis of marketing) has been defined as the [4 Ps of marketing](https://ahrefs.com/blog/implementing-the-4-ps-of-marketing/):
...
You can create a marketing plan using our [simple one-page template](https://ahrefs.com/blog/marketing-plan).
...
What’s more, a combination of marketing types may bring better results than focusing on one type or channel. For example, [content marketing](https://ahrefs.com/blog/content-marketing/) works great with [search engine marketing](https://ahrefs.com/blog/search-engine-marketing/) (i.e. [SEO content](https://ahrefs.com/seo/seo-content)).
