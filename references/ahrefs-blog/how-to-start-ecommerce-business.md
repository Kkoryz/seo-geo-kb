---
title: "How to Start an E-commerce Business (9 Steps to Success)"
source_url: https://ahrefs.com/blog/how-to-start-ecommerce-business/
category: ahrefs-blog
section: "Ahrefs blog — SEO methodology"
date: 2023-01-18
---

# How to Start an E-commerce Business (9 Steps to Success)
...
You can get an idea of the level of interest using [Google Trends](https://trends.google.com/trends/) and a good keyword research tool.
...
A keyword research tool is also helpful in the research phase. Ahrefs’ [Keywords Explorer](https://ahrefs.com/keywords-explorer), for example, lets you see more details like related search queries and competitive metrics.
...
Compare this selling price to what competitors are charging and explore [historical price patterns](https://camelcamelcamel.com/). Or, to put it simply, get to know what your customer base is willing to spend.
...
Wix has [a good guide](https://www.wix.com/blog/ecommerce/2020/10/find-manufacturers) on how to find a manufacturer that includes a few U.S. directories and overseas directories.
...
Get started by browsing [online directories](https://www.shopify.com/blog/dropshipping-suppliers), asking for wholesale referrals from within your network, or partnering with well-known sites like [AliExpress](https://www.aliexpress.us/) or [Faire](https://www.faire.com/).
...
Trying to decipher all the legal stuff can feel daunting. Thankfully, there are multiple [online legal service providers](https://www.forbes.com/advisor/business/software/best-online-legal-services/) to help make the legal process as easy as possible.
...
To stay as neutral as possible, we’ve listed the [most popular e-commerce platforms, according to market share](https://www.statista.com/statistics/710207/worldwide-ecommerce-platforms-market-share/):
...
While Wix has been adding a ton of SEO functionality, some important cons remain, like weird link structure and code bloat. That’s not ideal because [speed matters in SEO](https://ahrefs.com/blog/core-web-vitals/) and conversion rate optimization. Unfortunately, Wix’s server response time could be better.
...
Below, we have listed the [most common payment processors by market share:](https://www.datanyze.com/market-share/payment-processing--26)
...
[Data suggests](https://www.paypalobjects.com/digitalassets/c/website/marketing/global/shared/global/media-resources/documents/comScore_Checkout_Conversion_4-23-8.pdf) that PayPal-enabled checkouts convert at 88.7%, and 52% of mobile customers will likely make additional online purchases if they see PayPal as a payment option.
...
Shopify Pay Installments is the third-largest payment processor. It is unique because it allows customers to pay for orders in four interest-free installments. It’s available in [22 countries](https://help.shopify.com/en/manual/payments/shopify-payments/supported-countries) at the time of publication.
...
And remember to consider free return shipping. Returns play a significant role in gaining new customers. Over 70% of surveyed consumers agree that [the returns experience plays an important role in customer loyalty](https://www.ups.com/media/en/gb/ups_global_paper.pdf).
...
Since [83% of online shoppers need assistance completing an order](https://www.invespcro.com/blog/great-customer-experience/), live chat (with real people, not bots) is a must-have.

### Social media

A study by Bain & Company found companies that responded to customer service requests on social media gained [20% to 40% more sales](https://www.bain.com/insights/putting-social-media-to-work) from those customers.

You can[ set up alerts](https://ahrefs.com/blog/digital-marketing-tools/#5-brand24) to let you know when your business is being discussed, answer user questions, give updates on new products, and resolve any issues they may have.

When an issue or question arises, the majority of people (62%) prefer to contact a company for customer service via email over any other channel, according to[ research](https://blog.hubspot.com/sales/live-chat-go-to-market-flaw).
...
We spoke to the consultant of an eight-figure e-commerce business (ButcherBox) who shared six proven [e-commerce marketing strategies](https://ahrefs.com/blog/ecommerce-marketing/) just for you.

Below is a quick summary of ways to market your online shop:

### Search engine optimization (SEO)

[SEO](https://ahrefs.com/seo) helps you rank higher in the search results for relevant search queries. It generally involves keyword research, content creation, [link building](https://ahrefs.com/blog/ecommerce-link-building/), and technical improvements.

E-commerce SEO ups the ante, though. There are a lot of specifics you’ll have to deal with, but we have your back with our [beginner’s guide to e-commerce SEO](https://ahrefs.com/blog/ecommerce-seo/).

### Online advertising

[Online advertising](https://ahrefs.com/blog/online-advertising/) is any time you place an ad on Google, Facebook, Instagram, etc., whether it’s pay-per-click, pay-per-impression, or something else.

Ads are effective because brands can target the ad’s message to specific users, including[ how close the person is to buying the product](https://ahrefs.com/blog/buyers-journey/).
...
Founder [Joe Kudla](https://www.emarketer.com/content/how-vuori-is-positioning-its-business-strategies-during-the-pandemic) credits online advertising as the reason the brand made it from its humble beginnings.

And quite honestly, if we hadn’t leaned into that (direct marketing) so heavily, we probably wouldn’t have made it.


Vuori used a combination of Google Merchant Center and Facebook dynamic ads, Facebook-sponsored posts, and lookalike audiences built off its mailing list. It paid close attention to [cost per acquisition](https://ahrefs.com/blog/customer-acquisition-cost/) to evaluate what was working.
...
While resource-intensive, video is not a channel to sleep on. A recent study found that[ 73%](https://www.wyzowl.com/video-marketing-statistics/#stat-4-2) of respondents preferred watching a short video to learn about a product or service.

And Google knows it.

During an episode of the “[Search Off the Record](https://search-off-the-record.libsyn.com/-cats-muffins-and-more-videos-in-search)” podcast, Google Product Manager Danielle Marshak said, “We think this kind of content (video) could be useful for a lot of different types of search queries, and we’ve been experimenting with how to show it to users more often.”

Videos are already rising in prominence on Google, appearing in the main search results page, video search results, Google Images, and [Discover](https://ahrefs.com/blog/google-discover/).
...
Considering [Ahrefs’ YouTube channel](https://www.youtube.com/@AhrefsCom) has over 360,000 subscribers and 14 million views, it’s safe to say we know a thing or two about video marketing. Read [our beginner’s guide to video marketing](https://ahrefs.com/blog/video-marketing/) to get started.
...
Get the inside scoop from a marketer that has grown multiple email lists in the tens of thousands in [this guide to growing an email list](https://ahrefs.com/blog/grow-email-list/).

As you receive orders, track which [marketing tactics](https://ahrefs.com/blog/marketing-tactics/) are working and which aren’t.

As time progresses, you’ll be able to adjust and change your [marketing strategy](https://ahrefs.com/blog/marketing-strategy/) to find what works best for your business.
...
Learn how to measure customer lifetime value and other essential marketing KPIs in [our list of marketing KPIs worth tracking](https://ahrefs.com/blog/marketing-kpis/).
...
Got any questions? Ping me [on Twitter](https://twitter.com/KayleLarkin).
