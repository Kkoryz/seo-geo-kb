...
source_url: https://ahrefs.com/blog/content-writing/
category: ahrefs-blog
section: "Ahrefs blog — SEO methodology"
date: 2023-06-23
---

# Content Writing Explained + 8 Tips to Become a Better Writer
...
Blog posts, videos, and social media posts are actually just a handful of the many types of content you can write. Here are a few others:
...
Not sure how to answer these questions? Read [our guide to creating a content marketing strategy](https://ahrefs.com/blog/content-marketing-strategy/).
...
- Enter a broad topic into Ahrefs’
[Keywords Explorer](https://ahrefs.com/keywords-explorer) - Go to the
**Matching terms**report

For example, if we enter “smoked,” then we see 319,019 terms sorted by their estimated U.S. monthly search volume:

But it’s not all about search volume. You also need to consider how easy it would be to write content about the topic that sells your product or service.

Learn how in [our guide to creating a content plan](https://ahrefs.com/blog/content-planning/).
...
Here’s our formula for a winning one:
...
For example, if we were writing about “affiliate marketing” and wanted to rank in Google, we’d look at the top-ranking posts. It only takes a moment to see that all top-ranking pages have a definition of the term…

… as well as information on how to get started:

These are all things we should probably cover in our content.

If you want to speed up this process, you can use Ahrefs’ [Content Gap tool](https://ahrefs.com/content-gap) to find common keyword rankings among top-ranking pages and eyeball the list for subtopics.

Here’s how:

- Enter your target keyword into Ahrefs’
[Keywords Explorer](https://ahrefs.com/keywords-explorer) - Scroll down to the SERP overview
- Select the top-ranking pages you want to analyze
- Click “Open in” then choose “Content gap”

For example, if we do this for “affiliate marketing,” we see that the top-ranking pages also rank in the top 10 for:
...
Given how impatient people seem to be these days, my advice for structure is to use the “inverted pyramid” method and put the “need to know” before the “nice to know.”

For example, if we are writing about affiliate marketing, readers are probably going to want to know what it is before learning how to do it.
...
- Draw on your
**experience and expertise** - Make it
**entertaining**
...
Look at these two posts from our SEO glossary:

Both of them use exactly the same template:
...
- Enter a broad topic into Ahrefs’
[Keywords Explorer](https://ahrefs.com/keywords-explorer) - Go to the
**Matching terms**report - Add a modifier like “best” or “how to” to the “Include” filter

For example, the keywords above are how to cook various foods sous vide, so you could easily use the same template for all of them.
...
Here’s a great intro formula you can use to combat against this:
...
Just like that, we’ve shown that we understand the problem, know why it’s so frustrating, and can provide a solution.

### Cut fluff and jargon to make your content more accessible and shareable

Did you know that [54% of Americans read below the equivalent of a sixth-grade level](https://nces.ed.gov/surveys/piaac/measure.asp?section=1&sub_section=3)?
...
[Hemingway](https://hemingwayapp.com/) is a good starting point. Paste your content in the tool, and it’ll give you a readability score and suggestions to make it clearer.

[Grammarly](https://www.grammarly.com/) can help with clarity too.

Just make sure not to obsess too much over the scores. Nothing will ever be absolutely perfect.
...
According to Ahrefs’ [Site Audit](https://ahrefs.com/site-audit), there are ~520 mentions of “for example” across our blog posts:

For example (sorry, I had to do it!):

This comes from our post about the differences between SEO and SEM.
...
For example, according to Ahrefs’ [Site Explorer](https://ahrefs.com/site-explorer), our guest blogging guide earned 23 backlinks because of a stat we quoted in the post:

### Boost credibility by showcasing your expertise and experience
...
I love how the Wirecutter does this. Its posts include a short “why you should trust me” section with details about the author’s experience and expertise.

Maybe I’m just a shill, but this actually made me trust this guide’s recommendations.
...
They’re a smart way to answer questions that people want to know but don’t really make sense to answer earlier in the content.

Here’s one way to find them:

- Enter your topic in Ahrefs’
[Keywords Explorer](https://ahrefs.com/keywords-explorer) - Go to the
**Matching terms**report - Toggle the “Questions” tab

It’s then just a case of skimming the questions for things that may be worth adding to an FAQ section on your page.
...
For example, people in SEO are divided when it comes to whether authority or relevance matters more when building links. To showcase this in my guide to off-page SEO, I reached out to a few experts and asked for their opinion…

… then I included them in the post:

Here’s a simple way to find experts if you’re not sure who to reach out to:

- Go to Ahrefs’
[Content Explorer](https://ahrefs.com/content-explorer) - Enter the topic of your content
- Go to the “Authors” tab

This will show you a list of authors who’ve published content about the topic.

It’s then just a case of finding their contact details and reaching out to them.
...
If it’s something you’re keen to do, read [our guide to outsourcing to freelance writers](https://ahrefs.com/blog/outsourcing-writers/).

## What next?

Getting more eyeballs on your content is the next task. Learn how in [our guide to content distribution](https://ahrefs.com/blog/content-distribution/).
