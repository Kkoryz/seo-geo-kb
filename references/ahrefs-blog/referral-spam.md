...
source_url: https://ahrefs.com/blog/referral-spam/
...
Tell me about it! It makes data a mess—for both my personal sites and client’s sites that I work with at [The Magistrate](http://magistrateinc.com/).
...
They can still really skew your analytics numbers, including key stats like [bounce rate](https://ahrefs.com/blog/bounce-rate/) and other engagement metrics.
...
- Using the referral exclusion/blocking list
*(*- Good setup but no updates.[read more](http://www.clairwyant.com/google-analytics-domain-filtering-spam-bots-ghost-visitors-bad-data/)) - Sourcing exclusion lists into exclusion filters - Only excludes and blocks future spam & does nothing about the referrers from yesteryear.
...
**Very**regularly updated- Retroactive to past data
...
- Filters allow you to include or block data from your reporting data set. Keep in mind that filters are
**destructive**. Anything you filter and block, accidentally or otherwise is gone forever. They also cannot edit past data.
...
Plus, thanks to some friends on inbound, we got some great pointers about solid techniques that also help suppress unwanted spam. The [comments and exchange](http://inbound.org/articles/view/referral-spam-solved-give-your-analytics-an-enema) that we had here are well worth a look at for additional context into solving Analytics Spam.

The rest of the steps are relatively easy.

- Be sure to turn on the option within Google Analytics to exclude known bots and spiders.
- Consider adding an
[inclusive hostname filter](https://moz.com/blog/stop-ghost-spam-in-google-analytics-with-one-filter) - You could even
[add a cookie to your site](http://www.lunametrics.com/blog/2015/03/19/eliminating-dumb-ghost-referral-traffic/)to cover your bases even more
...
- Setup this option incorrectly, and you’re potentially filtering out real data
*(see filters vs. segments)*
...
Here is our [referral spam cleanup tool](https://loganix.net/rst-lander/), and let me quickly walk you through it.
...
If you have any tips and tricks we’ve missed, I hope you’ll let us know. In the meantime, [enjoy our tool](https://loganix.net/rst-lander) and cheers!
