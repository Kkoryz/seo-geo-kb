...
source_url: https://ahrefs.com/blog/expert-roundups/
category: ahrefs-blog
section: "Ahrefs blog — SEO methodology"
date: 2022-04-04
---

# Expert Roundups: Stick a Fork in Them; They're Done

[his now-infamous post](https://www.mattcutts.com/blog/guest-blogging/)proclaiming that guest blogging for SEO was “done” because it had “just gotten too spammy.”
...
[What are expert roundups?](#1-expert-roundups)[Why people create expert roundups](#2-why-create-roundups)[Why “experts” contribute to expert roundups](#3-why-experts-contribute)[What’s the issue with expert roundups?](#4-issues)[Three better alternatives to expert roundups](#5-three-alternatives)
...
The idea here is simple: If an “expert” is willing to contribute to your roundup, perhaps they’ll also be willing to link to it. This is good for SEO because [backlinks](https://ahrefs.com/blog/what-are-backlinks/) are one of [Google’s top-ranking factors](https://ahrefs.com/blog/google-ranking-factors/).
...
This makes sense, as building relationships with influential and well-connected industry experts can open all kinds of doors. It’s how I managed to get a backlink from [Glen Allsopp](https://twitter.com/viperchill?lang=en) (Detailed) back in the day, and it’s kind of how I landed my job at Ahrefs.
...
I also got a reply to my tweet from [Jeremy Rivera](https://twitter.com/JeremyRiveraSEO), who gave a fourth reason for creating expert roundups: crafting expert-supported content:

You forgot a fourth objective; crafting quality expert supported content.

— Jeremy Rivera (@JeremyRiveraSEO)

A well executed roundup can and should actually achieve ALL of these objectives![March 9, 2022]
...
You may think that an expert roundup matches [search intent](https://ahrefs.com/blog/search-intent/) when the searcher is looking to learn, but let me ask you this: How often do you really want a list of hundreds of random and potentially opposing opinions when you’re just trying to find the answer to something?
...
For example, if we want to write a piece about Google’s Knowledge Graph, we can search [Content Explorer](https://ahrefs.com/content-explorer) for the pages with “knowledge graph” in their titles.
...
People often cite statistics and link to the source. If you don’t believe us, just look at the anchors and surrounding texts of backlinks to [our search traffic study](https://ahrefs.com/blog/search-traffic-study/):
...
This is precisely what Paddy Moogan did for [Aira’s annual “state of link building” report](https://aira.net/state-of-link-building/).
...
If you’re wondering who to poll for this kind of content, use [Content Explorer](https://ahrefs.com/content-explorer) to find experts who’ve already written about your topic.

For example, here are a few top authors who’ve written about link building (you may notice a familiar name there!):

Maximize the link-earning potential of existing posts by adding insights from your poll. For example, we mentioned a statistic from our search traffic study in [our keyword research guide](https://ahrefs.com/seo/keyword-research), and it earned a few extra backlinks as a result:
...
You can find general comparison keywords for affiliate sites easily in Ahrefs’ [Keywords Explorer](https://ahrefs.com/keywords-explorer). Just enter a few seed keywords (e.g., product types or brands) and then add the word “best” to the “Include” filter.

**Recommended reading:** [How to Do Keyword Research for Affiliate Sites](https://ahrefs.com/blog/affiliate-keyword-research/)

You can use this approach for non-affiliate keywords too.

For example, we polled the 10,000+ SEO professionals in [our private Facebook group](https://www.facebook.com/groups/ahrefsinsider/) to compile recommendations for [our list of the best free SEO tools](https://ahrefs.com/blog/free-seo-tools/).
...
Got questions? Disagree? Let me know [on Twitter](https://twitter.com/joshuachardwick?lang=en).
