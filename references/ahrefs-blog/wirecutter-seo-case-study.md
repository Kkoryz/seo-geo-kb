...
source_url: https://ahrefs.com/blog/wirecutter-seo-case-study/
...
[affiliate marketers](https://ahrefs.com/blog/become-affiliate-marketer/)look up to and try to draw inspiration from. Its impact on product choices from its in-depth reviews is so high that there’s even a term called “

[Wirecutter effect](https://www.awin.com/us/how-to-use-awin/wirecutter-affiliate-partner-success),” describing recommended products selling out quickly once the review goes live.

As of May 2022, the website drives almost 12 million organic search clicks in a month (spread across roughly 3,000 pages):

The website is now part of The New York Times, which acquired Wirecutter in 2016 for about $30 million. The investment most likely paid for itself within three years, as the Times made [more than $20 million from Wirecutter](https://www.niemanlab.org/2021/08/wirecutter-which-makes-money-when-you-shop-is-going-behind-the-new-york-times-paywall/) in 2018 alone.
...
[Send great E-A-T signals throughout website](#1-send-great-eat-signals-throughout-website)[Provide great user experience](#2-provide-great-user-experience)[Leverage your category pages](#3-leverage-category-pages)[Keep your content up to date](#4-keep-content-up-to-date)[Have a solid content distribution plan](#5-have-a-solid-content-distribution-plan)

Let’s dive in.

Head over to our list of [SEO case studies](https://ahrefs.com/blog/seo-case-studies/).

[E-A-T](/blog/eeat-seo/) stands for expertise, authoritativeness, and trustworthiness. It comes from [Google’s Search Quality Rater Guidelines](https://static.googleusercontent.com/media/guidelines.raterhub.com/en//searchqualityevaluatorguidelines.pdf), a 172-page document used by human quality raters to assess the quality of Google’s search results.
...
Let’s take a look at its [review of the best electric toothbrushes](https://www.nytimes.com/wirecutter/reviews/best-electric-toothbrush/). An input from dentists and relevant researchers is certainly useful here. That’s why even though the article was written by Wirecutter staff members, they made sure to get that input anyway:
...
He recommended reading the sections in the QRG on E-A-T as it outlines things well.[@methode][#Pubcon][February 21, 2018]
...
Speaking of links, I also found that [Wirecutter’s About page](https://www.nytimes.com/wirecutter/about/) has one of the most prominent link placements across all of its pages:

That’s right. Wirecutter creatively used the necessary monetization disclaimer on every page to link to its About page. This disclaimer, in addition to labeling sponsored links with the [“sponsored” or “nofollow” attributes](https://ahrefs.com/blog/nofollow-ugc-sponsored/), is an obvious trustworthiness factor that every affiliate website needs to adhere to.
...
**Learn more:** [What Is E-A-T? Why It’s Important for SEO](/blog/eeat-seo/)
...
Google already uses [mobile-friendliness](https://ahrefs.com/blog/mobile-first-indexing/) and [Core Web Vitals](https://ahrefs.com/blog/core-web-vitals/) in its ranking algorithm. It would make perfect sense if it evaluated many other UX factors as well.

Let’s check the statistics of [another review page](https://www.nytimes.com/wirecutter/reviews/best-noise-cancelling-headphones/):
...
This is one of the best things you can do for [proper internal linking](https://ahrefs.com/blog/internal-links-for-seo/), as each page has its place within a given hierarchy. Then there’s the nice bonus of the traffic potential. Similarly, you can also [create content hubs](https://ahrefs.com/blog/content-hub/) (also known as [topic clusters](https://ahrefs.com/blog/topic-clusters/)) to cover high-level topics that can drive tons of traffic.
...
This didn’t surprise me. The more you cover a certain niche, the more often you’ll come back to [republish older content](https://ahrefs.com/blog/republishing-content/).
...
**Learn more:** [Republishing Content: How to Update Old Blog Posts for SEO](https://ahrefs.com/blog/republishing-content/)

[Publishing great content](https://ahrefs.com/blog/how-to-write-great-content/) can only get you so far. Even if your main traffic source is organic search, you need a [solid content distribution plan](https://ahrefs.com/blog/content-distribution/) to get every piece of new content in front of as many people as you can.
...
What you can do on top of building and leveraging your newsletter is [repurposing your content](https://ahrefs.com/blog/repurposing-content/) into formats that do better on a given platform.

Examples of such content formats are threads on Twitter or short videos that are pretty much everywhere. Here’s how Wirecutter repurposed its article about replacing household essentials into a [TikTok video](https://www.tiktok.com/@wirecutter/video/7028322526220537135) (that can be reshared on other platforms as well).
...
What does this have to do with SEO, you ask? The more eyes land on your content, the higher the chances you’ll naturally [earn a backlink](https://ahrefs.com/blog/how-to-get-backlinks/)—or get any other [earned media](https://ahrefs.com/blog/earned-media/) that may have an indirect impact on your SEO performance.
...
I can imagine that Wirecutter gets a ton of traffic from Discover and has the best resources to try and [optimize for that](https://ahrefs.com/blog/google-discover/), given that it’s under the Times.
...
If you want to [learn more about affiliate marketing](https://ahrefs.com/blog/category/affiliate-marketing/), we have a whole category of articles dedicated to this topic.
