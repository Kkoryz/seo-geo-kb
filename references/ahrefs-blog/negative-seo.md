...
source_url: https://ahrefs.com/blog/negative-seo/
...
[What is negative SEO?](#what-is-negative-seo)[Types of negative SEO attacks](#types-of-attacks)[Does negative SEO work?](#does-negative-seo-work)[How to detect, avoid and fix the most common types of negative SEO attacks](#how-to-detect-avoid-fix)
...
Building low-quality links at scale is perhaps the most common and unsophisticated type of negative SEO because it’s so easy and cheap to do. There are plenty of websites selling thousands of spammy [backlinks](https://ahrefs.com/blog/what-are-backlinks/) for next to nothing.
...
Gary Illyes, another Google’s representative, has [made similar statements](https://www.searchenginejournal.com/gary-illyes-google-penguin-negative-seo-disavows/296609/):
...
Here’s how [Gary Illyes explained the difference between devaluing and demoting](https://www.seroundtable.com/disavow-file-google-penguin-22771.html):
...
That’s why our [free backlink checker](https://ahrefs.com/backlink-checker) gets an estimated 133,000 organic visits per month…
...
Here’s what Google said in [their official announcement](https://developers.google.com/search/blog/2016/09/penguin-is-now-part-of-our-core):

Penguin is now more granular. Penguin now devalues spam by adjusting ranking based on spam signals, rather than affecting ranking of the whole site.


Confused? [Here’s](https://searchengineland.com/google-updates-penguin-says-now-real-time-part-core-algorithm-259302) Google’s “clarification” of what this means:
...
**The volume approach**: Blasting thousands upon thousands of low-quality links at your site.**The over-optimized anchor text approach**: Pointing lots of links with exact-match[anchor text](https://ahrefs.com/blog/anchor-text/)at a ranking page to give it an unnatural anchor text ratio.
...
[our guide to bad links](https://ahrefs.com/blog/bad-links/).
...
You can do that by setting up a Backlinks alert in [Ahrefs’ Alerts](https://ahrefs.com/alerts).
...
Use the referring domains and pages graphs in Ahrefs’ [Site Explorer](https://ahrefs.com/site-explorer) to quickly identify spikes in your backlink profile.

*Site Explorer > Enter domain > Overview*

Now, it’s important to note that a sudden increase in referring domains could be a good thing. For example, one of your posts may have gone viral, or you could have had success with an [outreach campaign](https://ahrefs.com/blog/outreach/).

But it could also be a sign of a negative SEO attack.

Here’s how to investigate further using Ahrefs [Site Explorer](https://ahrefs.com/site-explorer):

- Click the
**Backlinks**report - Change the mode to “One link per domain”
...
But it’s also easy to spot an attempt to manipulate your [anchor text](https://ahrefs.com/blog/anchor-text/) ratio.

Here’s how to do it in [Site Explorer](https://ahrefs.com/site-explorer):

- Click the
**Anchors**report - Select Dofollow links
...
Getting spammy links removed is virtually impossible, so the only thing you can proactively do is [disavow](https://ahrefs.com/blog/google-disavow-links/) them.
...
Keep in mind that you should only disavow whole domains if you’re certain that none of the backlinks from them are legit. If you’re unsure about this whole process, consult an expert like [Marie](https://www.mariehaynes.com/services/link-audits/).
...
For this, you can use [Ahrefs Alerts](https://ahrefs.com/alerts).
...
Most of the time, it isn’t done with malice. People who scrape your content are usually just trying to get free content. They’re not trying to hurt your site, but [it can still happen](https://www.diyphotography.net/this-photography-website-steals-content-and-outranks-everyone-else/).
...
I should point out here that there’s nothing wrong with [syndicating your content](https://ahrefs.com/blog/content-syndication/) on high-authority sites with a link back to your original post.
...
If you suspect that some of your URLs may have been harmed by content scraping, you can always verify their status in [Google Search Console](https://ahrefs.com/blog/google-search-console/). What you’re looking for is something called a “Google-selected canonical.”

You’ll find it after pasting the URL into the GSC address bar under the Coverage section:

You want to see the Inspected URL there. It means that Google considers the inspected URL as the most authoritative version of the content. If you see another internal URL there, you have a [duplicate content](https://ahrefs.com/blog/duplicate-content/) issue. If you see an external URL there, you’re facing negative SEO.

For multiple pages, that’s going to be a time-consuming task. So instead, you can use tools made explicitly for finding scraped content at scale, such as [Copyscape](https://www.copyscape.com/).

If you have a list of duplicate external URLs, you can then use the [Batch Analysis](https://ahrefs.com/batch-analysis) tool and check if any of those URLs receive organic traffic. Sort the URLs by traffic:
...
This rarely happens, but if the site that has scraped your content is high-quality, and you feel that a link from them may help your rankings, then reach out and ask them to add an [attribution link](https://ahrefs.com/blog/unlinked-mentions/) to the scraped post.

##### 2) File a DMCA complaint

You’ll need to escalate things if the scraped content steals your organic traffic. Just make sure that there is malicious intent behind it with no chance of getting a [canonical](https://ahrefs.com/blog/canonical-tags/) attribution link before doing this.
...
You can do that using Google’s [DMCA dashboard](https://www.google.com/webmasters/tools/dmca-dashboard).

Unfortunately, it’s not a quick process.

If you want to go through it, head to [Google’s legal help resource](https://support.google.com/legal/troubleshooter/1114905?hl=en#ts=1115655%2C1282900%2C1115846%2C1117010%2C1697925) and click through the options describing your problem. Once you get to the “Create request” step, it’s important to provide as much detail as possible to ensure each takedown request is successful.

For more information on the DMCA takedown process, see [this guide from The Copyright Alliance](https://copyrightalliance.org/education/copyright-law-explained/).
...
On the other hand, if they deleted all the links, it should still be easy for search engines to figure out the original because it usually has much better internal and external link profiles. A [proper internal linking](https://ahrefs.com/blog/internal-links-for-seo/) structure is one of the most important on-page SEO tactics.

### 4. False URL parameters

[URL parameters](https://ahrefs.com/blog/url-parameters/) are values set in a page’s URL string. In the example below, the parameter ‘size’ is ‘small’:
...
We have the self-referencing [canonical tag](https://ahrefs.com/blog/canonical-tags/) in place that lets Google know what the de-facto version of this page is.
...
You probably check online reviews when you’re about to visit a restaurant or buy stuff online. [Google’s rich snippets](https://ahrefs.com/blog/rich-snippets/) can directly show ratings and review metrics in the SERP, which help catch attention and make an impression on people—positive or negative.
...
Anyone can publish a bad review of your product or service, and it may rank well in SERP. It can also be seen as a rich result if the [schema markup](https://ahrefs.com/blog/structured-data/) is set up correctly.

#### How to detect fake reviews

Keep an eye on what appears in the SERPs for your brand reviews. Any monitoring would be overkill here; just run the search once a month and see for yourself. If you want to make sure you’re also covering local SERPs, [search from more locations](https://www.searchenginejournal.com/see-google-search-results-different-location/294829/).

#### How to fight back against fake reviews

If you’re dealing with fake reviews on review platforms, [report them](https://support.google.com/contributionpolicy/answer/7445749?hl=en&ref_topic=7422769). Don’t expect the platforms to take them down right away. It can be a rather slow process. If the problem is urgent, trying to get in touch with someone from the review platform will be your best bet.
...
If they don’t bowl it straight out of the SERPs, they will add a ‘[this site may be hacked](https://support.google.com/websearch/answer/190597?hl=en)’ flag to any results for the site, as Google shows here:
...
**Install a security plugin.**Check this[plugin selection for WordPress](https://kinsta.com/blog/wordpress-security-plugins/).**Use strong passwords.**Sorry, but “password1” isn’t going to cut it for your WordPress login. Using a strong password will help prevent brute-force attacks.**Keep your CMS (and plugins) up to date.**Enabling automatic updates is your best bet.

That’s a very basic overview, mind. So here are some of the best website security tutorials on the web:

If you have the budget, I would also recommend securing your site with services such as [Sucuri](https://sucuri.net/).
...
Having your website or a few pages unavailable due to server maintenance is fine. Google considers the 503 Service Unavailable error as a temporary thing. However, if this lasts for a more extended period, it may [cause deindexation](https://www.seroundtable.com/google-503-status-code-hours-23968.html).

A sneakier form of a DDoS attack might be one that doesn’t shut your site down entirely but instead slows it down. Not only would it make the user experience worse, but there is a chance that it would harm your ranking as well since [page speed](https://ahrefs.com/blog/core-web-vitals/) and related [Core Web Vitals](https://ahrefs.com/blog/core-web-vitals/) are ranking factors.

#### How to detect a DDoS attack

Make sure you or your engineering team [monitor incoming traffic and requests](https://www.loggly.com/blog/ddos-monitoring-how-to-know-youre-under-attack/). It helps detect the sneakier DDoS attacks, but the huge ones can shut down your website within a few seconds.

[The largest recorded attack reached 2.54 Tbps](https://www.cloudflare.com/en-gb/learning/ddos/famous-ddos-attacks/). That’s a bandwidth ballpark comparable to some video and streaming platforms.
...
Your best bet is to use CDNs, dedicated servers, and other services with huge network infrastructures that often have their own [DDoS protection solutions](https://geekflare.com/ddos-protection-service/). These services also usually offer [load balancing](https://en.wikipedia.org/wiki/Load_balancing_(computing)) and [origin shielding](https://www.cdnplanet.com/guides/origin-shield/) for the best possible protection against traffic and request spikes on your web hosting server.
...
If you have any experience with negative SEO, questions, or comments, [ping me on Twitter](https://twitter.com/michalpecanek).
