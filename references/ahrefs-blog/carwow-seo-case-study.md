...
source_url: https://ahrefs.com/blog/carwow-seo-case-study/
...
If you haven’t heard of [carwow](https://www.carwow.co.uk/), it’s a car-buying comparison platform where you specify the kind of car you want to buy, and dealers prepare offers to compete over you.

It works the same way if you want to sell a car. Basically, carwow will connect you with the best offers from car dealers. You can also view the existing stock of new and used cars.

But most people probably know carwow through its original video car reviews. It’s actually one of the biggest car YouTube [channels](https://www.youtube.com/@carwow) in the world (7.73M subscribers, which may make it the biggest car channel).
...
The integrator side of carwow is the part where it makes original content: car reviews, news, guides, free tools, etc.

What also makes carwow special is that it was one of the first companies to introduce this kind of car-buying experience to the U.K. market ([The Guardian](https://www.theguardian.com/small-business-network/2016/apr/13/car-wow-startup-giving-power-buyers)).

The service is free for consumers, but car dealers do pay for leads they get through carwow. If I’m reading [this](https://www.carwow.co.uk/blog/carwow-acquires-used-car-platform-wizzle) right, a new car inquiry that leads to a confirmation costs a dealer £38 (~USD $46), and a dealer will pay at least £99 (~USD 120.6) for buying a used car from the platform.
...
It captures an impressive 2.6M monthly organic traffic from the U.K. alone ($3.5M worth of ads), making it #2 in its niche. If we divided the traffic by pages created to generate it, carwow would be the most “efficient” site.

Interestingly enough, the number of referring domains paints a radically different picture than organic traffic. Only one site has fewer referring domains than carwow.

The company became an integrator (i.e., content creator) to become a successful aggregator. SEO is likely one of the key reasons.

To understand why this company bothers to create original content on a regular basis, let’s look at the volume of some keywords it successfully targets (data via Ahrefs’ [Keywords Explorer)](https://ahrefs.com/keywords-explorer).

| Keyword category | Example | Volume (UK) | carwow’s rank (UK) |
|---|---|---|---|
| New cars sold on the market | Kia ev 6 | 115K | 4 |
| Used cars | Used car deals | 5.9K | 2 |
| Car brands | Skoda | 98K | 7 |
| Car types | Hybrid cars | 38K | 1 |
...
The company didn’t leave that opportunity on the table. If you look at the structure breakdown of its site, you can clearly see it’s the information carwow provides that drives the most organic traffic, not the business side per se. Or, in SEO terms, it’s the informational keywords, not the commercial ones.

Let’s start with the strategy and dive deeper into the types of content it makes.

### Strategy

In essence, carwow is made for:

**People likely to buy a car in the near future**– Naturally, the brand wants to be top of mind when the time comes.**People in the market for a used or new car****Car owners**– They will want to change their cars one day.**Car enthusiasts**– I mean, who else would watch whether an old Lexus or BMW will run longer without engine oil ([1.8M views](https://www.youtube.com/watch?v=kUGB23KeVIg), by the way)? That group of people is important for anyone who wants to build a top brand in the automotive industry. Cars are a special kind of product. Lots of car owners are car enthusiasts too.
...
The thing is that the same content can be served for different segments of users who look for different things. It’s all about how you serve it.

So not only do the assets get organic traffic, but the categories of those assets also get organic traffic too.

By the way, this is exactly why SEOs should have their say in how websites look and work.

The same idea of “repackaging” content can be observed in various roundup articles, such as “[Safest Cars of 2023](https://www.carwow.co.uk/best/safest-cars-on-sale)” (2.4K organic views monthly) or “[10 most fun cars to drive](https://www.carwow.co.uk/best/fun-cars-to-drive)” (3.9K views), which features car deals and reviews.
...
They’re more like small [content hubs](https://ahrefs.com/blog/content-hub/) that are only *based* on reviews. In practice, they are as much about learning about cars as buying them.

Of course, this particular mix is obvious for this kind of business. But what’s interesting is that it’s also a specific kind of search intent recognized by Google. More often than not, it’s this kind of page that has the most chance to rank in the top 10 for car models (except those from car manufacturers and Wikipedia).

You can see the difference when comparing a traditional review, such as this one from [Wired](https://www.wired.com/review/kia-ev6/), and [carwow](https://www.carwow.co.uk/kia/ev6).

Just like any content hub, carwow’s reviews aren’t just a single page. They feature subpages about certain characteristics of the cars, such as the interior, specs, or colors.

I think this tactic helps carwow to nail the [search intent](https://ahrefs.com/blog/search-intent/). For example, since the keyword “volvo xc40” can mean different things related to the car, this makes every sense to serve content in the form of a hub. And when you look at carwow’s competitors, they’re doing the same thing.
...
No doubt, original car reviews make it more trustworthy as a business that acts as an intermediary between the buyer and seller. But at the same time, it sends a powerful [E-E-A-T](https://developers.google.com/search/blog/2022/12/google-raters-guidelines-e-e-a-t) signal to Google, as the search giant prefers original content created by people with first-hand experience in the topic who have actually used the product they review.

At the same time, the content is approachable, easy to digest, and even entertaining—very much like its video reviews. It’s written in a language everybody can understand, and it covers all the main aspects of buying and owning a car. Sounds exactly like the [type of content Google wants](https://developers.google.com/search/docs/fundamentals/creating-helpful-content).
...
At the same time, these two tools pose an excellent business opportunity. The tools work by showing data based on registration plates, and entering a registration plate is a few steps away from getting a deal on your car.
...
It seems like a lot. But let’s keep in mind that prices and deals are what users are eventually after, even though they came for the reviews. So in such a case, a brand can probably push things a bit further and do things like highlighting offers on a page about reviews.

Except for content, carwow shows SEO expertise in a couple of other areas.
...
I think it’s because of [topical authority](https://ahrefs.com/blog/topical-authority/).
...
It’s quite a well-known SEO practice to keep your important pages linked to your homepage. This is usually done by [interlinking](https://ahrefs.com/blog/internal-links-for-seo/) those pages in the menu.
...
And this is the case with carwow. The upper menu holds only the most important pages navigation-wise. All of the other important pages SEO-wise are linked in the lower part of the site. A simple solution that’s worth keeping in mind when dealing with big websites.

### SEO of acquiring Wizzle
...
One look at [Ahrefs](https://ahrefs.com/)’ **Linked Domains** report, and it’s all clear:

First, the homepage. We can see that Wizzle’s homepage has been [permanently redirected](https://ahrefs.com/blog/301-redirects/)—but not to carwow’s homepage. The company made the right move to make the link equity flow. The redirect has been made to the section of carwow.co.uk that serves the same purpose as the redirected page (selling used cars).

We can also see the same logic has been applied to certain pages from Wizzle. Pages on petrol prices, congestion charges, and ULEZ have been redirected to corresponding pages on carwow.

### Car news gets redirected to car reviews

Remember how carwow manages to capture the search intent of car models at all times? Quick reminder:

First, it writes about a car in the news section. And when the car becomes available on the market, it does a review.

What caught my attention here is that it doesn’t keep the news when that becomes outdated. A fair portion of news articles gets redirected to reviews.

I can see two main benefits of such a move.
...
Got questions or comments? Ping me [on Twitter](https://twitter.com/m_makosiewicz) or [Mastodon](http://@mako@seocommunity.social).
