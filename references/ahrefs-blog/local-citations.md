---
title: "How to Build Local Citations (Complete Guide)"
source_url: https://ahrefs.com/blog/local-citations/
...
[local SEO](https://ahrefs.com/seo/local-seo).
...
[Why local citations are important](#why-citations-are-important)[What types of citations there are](#types-of-citations)[How to get citations](#how-to-get-citations)[Why consistency and accuracy matter](#why-citation-accuracy-matters)
...
According to a survey by Moz, citations are the [fifth most important ranking signal](https://moz.com/local-search-ranking-factors) for local queries.

That said, it’s worth pointing out a couple of things about this survey:

**It’s a few years old**. The survey was conducted in 2018. Given that citations have almost certainly been decreasing in importance over time, it’s quite likely that they are less important today.**Not all SEOs believe that citations are still important**. Even in 2018, there were quite a few SEOs who responded to Moz’s survey saying that citations were no longer of huge importance, and didn’t move the needle all that much.
...
[Get listed with the ‘big three’ data aggregators](#get-listed-with-aggregators)[Submit to other core sites](#submit-to-core-sites)[Submit to popular industry and local sites](#submit-to-industry-sites)[Pursue unstructured citations](#pursue-unstructured-citations)
...
With Factual, you can no longer update or edit listings directly. You have to work with one of their [Trusted Data Contributors (TDC)](https://developer.factual.com/docs/tdc-program#:~:text=Factual's%20Trusted%20Data%20Contributor%20(TDC,of%20a%20data%20management%20partner.), and that usually costs a small fee. My advice is to search [their directory](https://places.factual.com/data/t/places) for your business and check the information they have. If it’s accurate, no worries. If it’s inaccurate, then you can always work with a TDC like Yext or WhiteSpark to correct it. However, my personal opinion is that it probably isn’t worth it for most businesses, so don’t worry about Factual too much.
...
You can find a full list of the most important citation sources in the US [here](https://whitespark.ca/top-local-citation-sources-by-country/united-states/), and for other countries [here](https://whitespark.ca/top-local-citation-sources-by-country/). Just know that this is only one company’s interpretation of the “most important” citation sources. There are plenty of these lists around, and while there is undoubtedly a lot of overlap, they’re rarely identical.
...
Given that this process is pretty tedious and time-consuming, one tool that can help is [Yext’s Business Scan](https://www.yext.com/resources/business-scan/). It effectively automates the process of checking whether you have existing listings on the “most important” sites. All you have to do is enter your business information, and you’ll see a report like this:
...
There are quite a few of these online, although [this one](https://www.brightlocal.com/resources/top-local-citations-by-business-category/) from BrightLocal is one of the best. It lists popular citation opportunities for over 40 business categories.
...
Although these backlinks are usually [nofollowed](https://ahrefs.com/blog/nofollow-links/), you can use their existence to discover citation opportunities. Just search Google for competing businesses, then paste three or more of their homepage URLs into Ahrefs’ [Link Intersect tool](https://ahrefs.com/link-intersect). In the bottom field, add your homepage URL and set all the modes to “URL.”
...
For example, Milk Beach, a London coffee shop, gets cited in [this article](https://www.gq-magazine.co.uk/gallery/londons-best-coffee-shops-cafes?image=5d139bf17fcc8e7f37820204) from GQ about the best coffee shops in London:
...
[HARO (Help A Reporter Out)](https://www.helpareporter.com/) connects journalists with sources for upcoming stories. It’s free to use, and works like this:
...
Let’s say you run a coffee shop in London. Just enter a competing business’s domain into Ahrefs’ [Site Explorer](https://ahrefs.com/site-explorer), set it to URL mode, head to the **Backlinks** report, then filter for “Dofollow” links.
...
For example, the lady behind this blog cites her five favorite brunch locations in [this article](https://chickaboutworld.com/home/brunch-like-a-londoner):
...
Here’s [just one page I found](https://www.roadaffair.com/gluten-free-london/) with a quick Google search for gluten-free bloggers in London. It cites tons of businesses:
...
This is not only thought to be bad for local SEO, but it also erodes the trust of consumers. In fact, [one study](https://www.brightlocal.com/research/local-citations-trust-report/) found that a staggering 80% of consumers lose trust in local businesses if they see incorrect or inconsistent contact details or business names online.
...
Citations are important for local SEO, but they’re far from the be-all and end-all of it. You also need to optimize your Google My Business profile, do proper [keyword research](https://ahrefs.com/seo/keyword-research), crack your [on-page SEO](https://ahrefs.com/seo/on-page-seo), and more.

[Our comprehensive guide to local SEO](https://ahrefs.com/seo/local-seo) can help with that.

Got questions about citations? Ping me [on Twitter](https://twitter.com/joshuachardwick?lang=en).
