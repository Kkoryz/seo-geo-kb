---
title: "How to Write a Great Listicle Post in 10 Steps"
source_url: https://ahrefs.com/blog/listicle/
...
[What is a listicle?](#what-is-a-listicle)[Why do people like listicles?](#why-do-people-like-listicles)[How to write a good listicle](#how-to-write-a-listicle)[Examples of listicles done well](#examples-of-listicles)
...
**Easy to skim**because each subheading usually corresponds to a list item.**Easy to digest**because they’re broken into bitesize chunks by definition.**Easy to gauge**because you always know how much is left from the number in the title.

Is that an exhaustive list of reasons? No, but *we can’t list them all*. Check out [this post by Smithsonian Magazine](https://www.smithsonianmag.com/smart-news/why-the-internet-loves-lists-1115/) if you’re curious about other reasons for their popularity.
...
[Choose a topic](#choose-a-topic)[Ensure it makes sense](#ensure-it-makes-sense)[Decide on length](#decide-on-length)[Choose a format](#choose-a-format)[Choose a winning angle](#choose-an-angle)[Brainstorm list points](#brainstorm-list-points)[Expand on your ideas](#expand-on-ideas)[Flesh out each point](#flesh-out-each-point)[Illustrate your points](#illustrate-your-points)[Wrap things up](#wrap-things-up)

### 1. Choose a topic

If you want your listicle to [drive traffic from search engines](https://ahrefs.com/blog/how-to-drive-traffic-to-your-website/), you need to choose a topic that people are searching for.

Because keywords typically represent topics, you can do this with a good keyword research tool like Ahrefs’ [Keywords Explorer](https://ahrefs.com/keywords-explorer). Just search for a broad topic, then go to the **Phrase Match** report where you’ll see keyword ideas sorted by their monthly search volumes.
...
If you’re struggling to find a suitable topic for a listicle, try adding these words to the Include filter in [Keywords Explorer](https://ahrefs.com/keywords-explorer): *ideas*, *tips*, *best*, *tools*, *things*, *strategies*, *tactics*, *list*. This will narrow the results down to keywords that include at least one of those words, which will often be great candidates for listicles.
...
**Your list will be long.**People probably don’t want to read an essay about each of the 50+ items on your list.**Your topic is simple.**Let’s say you’re putting together a list of date ideas. Most of these are probably simple things like ‘go roller-skating’ or ‘go hiking.’ You don’t need to write 500 words about each of those things.
...
**Your list will be short.**If your list will only have a few items, your post will probably attract more traffic if you provide more substance and details about each one.**Your topic is complicated.**Let’s say you’re putting together a list of[SEO tips](https://ahrefs.com/blog/seo-tips/). SEO is a complicated topic, so readers will probably need practical advice or step-by-step instructions on how to execute each tip.

### 5. Choose a winning angle

Here are a few popular angles for listicles:

**Personal experience →**[21 Best Online Marketing Tools](https://ahrefs.com/blog/marketing-tools/)**That We Use At Ahrefs****Best →**[6](https://ahrefs.com/blog/best-marketing-podcasts/)**Best**Marketing Podcasts**Expert commentary**→[33](https://bestlifeonline.com/declutter/)**Expert-Backed**Decluttering Tips**For beginners**→[23 Blogging Tips](https://ahrefs.com/blog/blogging-tips/)**For Beginners****Specific outcome**→[12 Quick SEO Tips](https://ahrefs.com/blog/seo-tips/)**to Increase Organic Traffic****Tried and tested**→[26 Best Free Chrome Extensions for SEOs (](https://ahrefs.com/blog/seo-chrome-extensions/))**Tried & Tested**
...
Even worse, it probably won’t attract [backlinks](https://ahrefs.com/blog/what-are-backlinks/), so it’ll be harder to rank in Google and get search traffic.
...
Plug your target keyword into Ahrefs’ [Keywords Explorer](https://ahrefs.com/keywords-explorer) and go to the **Also talk about** report. This shows words and phrases frequently-mentioned by the top-ranking pages for your keyword.
...
Most listicles use subheadings for each point. So a good way to extract inspiration from top-ranking pages is to extract the subheadings. You can do this for free with [Ahrefs SEO Toolbar](https://ahrefs.com/seo-toolbar). Just install it, open one of the top-ranking pages, then hit the little page icon in the top left for the on-page report.
...
**For simple lists**. Add a couple of sentences to each point.**For detailed lists**. Write as much as it takes to explain each point in detail.
...
Listicles are easy to skim and digest. But they’re arguably even easier to digest when you break things up with images and illustrations. This becomes even more important when you want readers to actually remember the points in your listicle thanks to the [picture superiority effect](https://en.wikipedia.org/wiki/Picture_superiority_effect).
...
[7 Alternative Search Engines to Google](https://ahrefs.com/blog/alternative-search-engines/)**:**11K+ monthly search visits[7 Ways To Find Anyone’s Email Address](https://ahrefs.com/blog/find-email-address/)**:**8K+ monthly search visits: 3.5K+ monthly search visits[7 Successful Amazon Affiliate Websites](https://ahrefs.com/blog/amazon-affiliate-websites/): 3K+ monthly search visits.[12 Quick SEO Tips](https://ahrefs.com/blog/seo-tips/): 2.5K+ monthly search visits[10 Ways to Get Google to Index Your Site](https://ahrefs.com/blog/google-index/): 1.3K+ monthly search visits[9 Easy Link Building Strategies](https://ahrefs.com/blog/link-building-strategies/)[4 Simple Blog Post Templates](https://ahrefs.com/blog/blog-post-templates/)**:**1.2K+ monthly search visits.
