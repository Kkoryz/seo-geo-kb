...
source_url: https://ahrefs.com/blog/ecommerce-blogging/
...
- It can help you move visitors along your
[marketing funnel](https://ahrefs.com/blog/marketing-funnels/)so they eventually buy. - You’re able to rank highly for keywords on Google that your product pages could never rank for but that are still important for
[building brand awareness](https://ahrefs.com/blog/increase-brand-awareness/)and finding customers. - It can help you
[grow your email list](https://ahrefs.com/blog/grow-email-list/). - You’re able to continue to get traffic without constantly spending money on ads.
- It provides many
[opportunities to link](https://ahrefs.com/blog/internal-links-for-seo/)to your product and category pages to help them rank better on the SERPs.
...
Solo Stove comes in at the top of my list due to its excellent use of videos, photos, and helpful information on the blog. It also does [search engine optimization (SEO)](https://ahrefs.com/seo) really well, bringing in an estimated 329,000 monthly visits from Google (data from Ahrefs’ [Site Explorer](https://ahrefs.com/site-explorer)).
...
My favorite post it’s done is its guide to making wet dog food at home, which ranks for the [featured snippet](https://ahrefs.com/blog/featured-snippets/) for “how to make wet dog food”:
...
While we wrote a [complete guide to keyword research](https://ahrefs.com/seo/keyword-research), here’s a quick and dirty strategy for finding keywords fast:
...
Next, plug the competitor’s URL into Ahrefs’ [Site Explorer](https://ahrefs.com/site-explorer)** **and click on the **Organic keywords** report to see the keywords its website ranks for on Google:
...
In addition to picking interesting keywords, you can also get an idea of how to become a [topical authority](https://ahrefs.com/blog/topical-authority/) on the topic of dog food by searching “dog food” in Ahrefs’ [Keywords Explorer](https://ahrefs.com/keywords-explorer).
...
It has [breadcrumb navigation](https://ahrefs.com/seo/glossary/breadcrumb-navigation) to help with SEO and navigation, the article title and the date it was last updated, then a short intro with an image on the right to make the lines shorter (and easier to skim). Finally, I include a clickable table of contents to help with navigation, then get into the article.
...
While you’re at it, you should also [create a standard operating procedure (SOP)](https://ahrefs.com/blog/seo-sops/) that you go through for every article. This could include writing guidelines, what to do with images, formatting, tone, etc.
...
I wrote a [guide to outlining content, which you can follow here](https://ahrefs.com/blog/content-outline/) for the full step-by-step process.
...
Here are a few [writing tips to help you become a better writer](https://ahrefs.com/blog/writing-tips/):

**Ditch the fluff**– If a word isn’t needed to bring a point across, cut it.**Keep your paragraphs short**– Two to three lines per paragraph is plenty, especially for mobile readers where the screen width is shorter.**Use active voice over passive voice**–[Here is a guide for that](https://www.grammarly.com/blog/active-vs-passive-voice/).**Make your content easy to skim**– Include photos and videos and make use of headers and bulleted lists to share key points.

Once you’ve written your article, do some basic [on-page SEO](https://ahrefs.com/seo/on-page-seo) to help it rank higher in search results:

**Ensure your article has one H1 tag**– The title of the article.**Have an SEO-friendly URL**– Include the keyword you’re targeting, but keep it short and easy to read.**Link to other pages on your site using proper anchor text**–[Here’s a guide for that](https://ahrefs.com/blog/anchor-text/).**Ensure your images have alt text**– This is the text Google uses to read what the image is about, as well as what is shown to readers if the image can’t render.
...
Just make sure your discount code only works once per unique IP address. You can learn more about how to do that [here](https://help.shopify.com/en/manual/discounts/discount-types) if you use Shopify.
...
Refer to [our guide to internal linking](https://ahrefs.com/blog/internal-links-for-seo/) to learn more about this step.
...
We have an [entire guide to content promotion](https://ahrefs.com/blog/content-promotion/) you should read, but here are some highlights:
...
There’s a lot more you can do to promote a piece, including [reaching out to other blog owners](https://ahrefs.com/blog/blogger-outreach/). But I won’t cover all of that here.

The other important piece of promoting your content is getting other website owners to link to your new articles. This is called [link building](https://ahrefs.com/seo/link-building), and it’s a crucial part of SEO.
...
You can [hire freelance writers](https://ahrefs.com/blog/hiring-freelance-writers/), outreach specialists, editors, and more. You can put together a full [SEO team](https://ahrefs.com/blog/seo-team/) for your business.
...
This guide will hopefully help you start your e-commerce blog and publish your first post. But remember that success with blogging doesn’t happen overnight. In fact, it takes [three to six months on average](https://ahrefs.com/blog/how-long-does-seo-take/) to see any results from your SEO efforts. Keep learning and be patient.
