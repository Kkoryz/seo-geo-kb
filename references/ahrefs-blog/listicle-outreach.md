...
source_url: https://ahrefs.com/blog/listicle-outreach/
category: ahrefs-blog
section: "Ahrefs blog — SEO methodology"
date: 2022-09-26
---

# Listicle Outreach: How Hunter Built 96 Links in 3 Months (Case Study)
...
When I worked for [Hunter](https://hunter.io/), listicle outreach was the link building tactic that brought us the best results. For example, in our last campaign, we achieved these results in less than three months with only one person involved in the process:
...
**Best options**–Lists of products, services, or businesses united by a single topic. It can be[a list of best SEO tools](https://ahrefs.com/blog/free-seo-tools/), top software for recruiters, etc.**Alternative options**– Lists of comparisons focused on a specific industry, topic, or problem. Aura’s[listicle on top LifeLock competitors](https://www.aura.com/learn/lifelock-competitors-alternatives)is a great example.**Guides that include lists**–People often include lists in guides. For example,[Ahrefs’ guide to finding email addresses](https://ahrefs.com/blog/find-email-address/)includes tips on email lookup. One of the tips is to use email lookup services and the author, Nick Churick, shares a list of the best tools he tested.
...
**Best options listicles:**best email finder, best seo tools, top restaurants in new york, etc.**Alternative options listicles:**best hunter alternatives, best ahrefs alternatives, etc.

Next, search for these terms in Google and use Ahrefs’ [SEO Toolbar](https://ahrefs.com/ru/seo-toolbar) to export the results. Repeat the process for the other keywords from your list and then merge all CSVs into one.

If you like, you can speed this process up using Ahrefs’ [Keywords Explorer](https://ahrefs.com/keywords-explorer). Just enter your keywords, hit “Export,” and choose the option to “Include SERPs.”
...
If you want to speed up and automate this process, consider segmenting during the prospecting stage with [Google search operators](https://ahrefs.com/blog/google-advanced-search-operators/).
...
After this, if you use Google Sheets, you can use [Hunter for Google Sheets](https://hunter.io/sheets) to automate the email lookup process. All you have to do is feed it the columns with the first and last names, domains, and company names of your prospects, and it’ll do the rest.

If you don’t use Google Sheets, you can use [Bulk Email Finder](https://hunter.io/email-finder) for email lookup. You’ll need to upload a CSV into the app, and then you’ll be able to export the result.

[Author Finder](https://hunter.io/author-finder)in the same add-on or in the app. All you need to find the email address of the listicle author is the URL of the listicle.
...
- If the editor accepted my offer, they would automatically become part of our
[affiliate program](https://ahrefs.com/blog/affiliate-marketing-programs/)and get recurring revenue from this mention. - I offered bloggers a generous pack of Hunter’s free requests that they could use for their cold outreach campaigns.
...
**Fully manual and personalized**– Sometimes, it took up to 30 minutes to write an email. Yes, it’s time consuming, but I found the response rate to be incredibly high (more than 50%).**Automated with a personal touch**–We automated some of the email batches with[Hunter Campaigns](https://hunter.io/cold-email-campaigns), a free tool for cold outreach automation. When segmenting prospects, you’ll notice many similarities between listicles. You can personalize copy at scale with custom attributes and icebreakers for such campaigns.
...
- If your product is already listed and you want to add a backlink, it may be risky. Google explicitly
[warns](https://developers.google.com/search/docs/advanced/guidelines/link-schemes)that it considers buying links a link scheme. If you’re going to stick to Google’s guidelines 100%, you shouldn’t buy links. - Often, websites ask for the payment repeatedly. This means that they can feature your product or service in a listicle for a limited time. If you want to extend the placement, you need to continue paying.
...
If your campaign goes well, you can make it evergreen by monitoring for new listicles with [Ahrefs Alerts](https://ahrefs.com/alerts). Here’s an example alert that monitors for new listicles with “best email finder” in their titles on DR 30+ websites with 1,000+ monthly search visits:

Got questions? Ping me [on LinkedIn](https://www.linkedin.com/in/irinamaltseva/).
