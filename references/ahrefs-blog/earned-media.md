...
source_url: https://ahrefs.com/blog/earned-media/
...
[Earned vs. paid vs. owned media](#earned-paid-owned)[Why earned media is important](#why-is-earned-media-important)[Examples of earned media](#earned-media-examples)[How to get earned media](#how-to-get-earned-media)
...
To [rank on Google](https://ahrefs.com/blog/how-to-get-on-top-of-google-search/), you need to [create content](https://ahrefs.com/blog/content-writing/), which is owned media. But you can only influence where Google ranks that content and for what [keywords](https://ahrefs.com/blog/what-are-keywords/) it ranks for. You don’t have full control over it.
...
In 2019, when Parachute launched its new wool mattress, the company opted for earned media over paid media. It seeded the product with editors and [influencers](https://ahrefs.com/blog/influencer-marketing), which resulted in tons of articles and Instagram Stories from people who tested the mattress.

In total, they spent around $20,000 on [PR](https://ahrefs.com/blog/pr-tactics-examples/) and product gifting. [According to Ariel Kaye](https://www.modernretail.co/startups/as-paid-marketing-costs-rise-dtc-brands-are-shifting-attention-to-pr/), Parachute’s founder, they would have had to spend at least $2 million on Facebook Ads to get the same number of impressions as they did from this earned media campaign.
...
Press articles often link back to the product or company, which [improves their SEO](https://ahrefs.com/blog/how-to-improve-seo/). And these articles may also rank in search and send referral traffic over time.
...
As finance writer Morgan Housel [puts it](https://www.collaborativefund.com/blog/theres-nowhere-left-to-hide/):
...
[TV segment](#tv-segment)[Newspaper/magazine feature](#newspaper-magazine-feature)[Niche/trade publications](#niche-publications)[Twitter mentions](#tweet-mentions)[Reddit discussions](#reddit-discussions)[Review sites](#review-sites)[Influencers](#influencers)[Search engines](#search-engines)
...
Ahrefs has yet to appear in a TV show, but authors like Eckhart Tolle have [sold millions of books](https://en.wikipedia.org/wiki/Eckhart_Tolle) thanks to Oprah’s recommendation.

### Newspaper/magazine feature

Last year, Bloomberg featured [our data on the most popular Google searches](https://ahrefs.com/blog/top-google-searches/) in a Businessweek article. We didn’t pay for this. Our ongoing promotional efforts led the author to find our content, and he decided to include it in an article.
...
Making a habit of regularly visiting the

[@ahrefs]blog again. Learned the basics from them back in 2015 and still consider them a go-to primer when approaching a new problem (e.g. manual content audit - which I haven’t done in years).Still super-fanning these guys — Kari Beaulieu (@SERP_queen)
...
Superb post on podcast advertising - the ups and downs of *real life* process from

[@itsrbek]:[https://t.co/6DHzboqU6X]— Rand Fishkin (@randfish)[November 21, 2018]

### Search engines

According to Ahrefs’ [Site Explorer](https://ahrefs.com/site-explorer), [our blog](https://ahrefs.com/blog) receives an estimated ~558,000 monthly visits. Take note: these are all organic visits. They’re not from ads.

Google ranks our content high on their search engine, thus sending traffic our way.

[Google Search Console](https://search.google.com/search-console/about), we see that Ahrefs slightly underestimates our organic traffic. Our actual Google traffic is closer to 750,000 monthly visits. The reason for this is simple: although we have a vast database of keywords at Ahrefs, no tool knows about every search query. For that reason, websites and webpages will almost always get more traffic than Ahrefs estimates.
...
[Use HARO](#haro)[Pitch to appear on podcasts](#appear-on-podcasts)[Rank for “source keywords”](#rank-for-source-keywords)[Do something newsworthy](#do-something-newsworthy)[Attend trade shows](#attend-trade-shows)[Send your product for reviews](#send-products-for-reviews)[SEO](#seo)

### 1. Use HARO

[Help a Reporter Out (HARO)](https://www.helpareporter.com/) is a free service that connects journalists to sources. After you sign up, you’ll receive daily emails from the service with requests from journalists.
...
**Provide actual expert insight.**Huffington Post journalist[Casey Bond says](https://www.weearnmedia.com/episodes/casey-bond), “Whenever you call in an expert it’s because they are supposed to be providing something to you that you can’t figure out yourself or find easily.” Don’t try to give a summarized answer from an article you Googled. Provide real insight that can only come from expertise or experience.**Share your credentials.**Unfortunately, HARO has been abused by unscrupulous SEO professionals looking for quick links. Journalists have[called them out at times](https://www.huffpost.com/entry/patricia-russell-cfp-fake-finance-blogger_l_5d38f4f4e4b020cd994e447d)and have become wary. HARO remains a great place for them to source expert quotes, but you need to prove that you’re a real expert on the topic. That means sharing your credentials, social media handles, and more.

You can learn more about using HARO effectively also [here](https://ahrefs.com/blog/seo-tips/) (tip #6) or in [this video](https://www.youtube.com/watch?v=73lj6m6Xulc):
...
In 2019, our Chief Marketing Officer, Tim Soulo, [set a goal](https://medium.com/swlh/12-lessons-i-learned-from-doing-20-podcast-interviews-in-4-months-537a3d621e4f) to appear on more than 20 podcasts. He accomplished that in only four months.
...
First, we’d paste his website (ahrefs.com) into Ahrefs’ [Site Explorer](https://ahrefs.com/site-explorer), go to the **Backlinks** report, and type his name in the “Include” box.

Second, we’d eyeball the list to see the podcasts he has been on.

Third, we’d [find the podcast hosts’ email](https://ahrefs.com/blog/find-email-address/) and [reach out](https://ahrefs.com/blog/outreach/) to see if they’re willing to interview us.

**Recommended reading:** [12 lessons I learned from doing 20+ podcast interviews in 4 months](https://medium.com/swlh/12-lessons-i-learned-from-doing-20-podcast-interviews-in-4-months-537a3d621e4f)

### 3. Rank for “source” keywords

In her presentation for the 2019 Chiang Mai SEO conference, SEO consultant [Stacey MacNaught](https://twitter.com/staceycav) said this:
...
**Interesting data.**When we say interesting, we mean interesting to relevant journalists.**Delivery mechanism.**Having interesting data is a start, but unless you have a way to get it in front of the relevant journalists, you’ll struggle to earn coverage.

There are tons of ways to do the two things above. For example, you could create or curate data about a trending topic, then use a tool like [Content Explorer](https://ahrefs.com/content-explorer) to find relevant journalists and pitch your resource.
...
To find these keywords, enter a few relevant keywords into Ahrefs’ [Keywords Explorer](https://ahrefs.com/keywords-explorer), go to the **Phrase match** report, and use the “Include” filter to find keywords containing words like *statistics*, *stats*, *facts*, and *figures*.
...
From there, create a post by curating a list of up-to-date statistics (owned media). Then, reach out to any sites linking to competing but outdated statistics pages on the same topic to [build links](https://ahrefs.com/seo/link-building) to your page (earned media).

We did this in 2020 for the term “[SEO statistics](https://ahrefs.com/blog/seo-statistics/).” As a result, our page has earned links from over 350 websites and ranks #2 for its main keyword.

Learn how we did this step-by-step in [this post](https://ahrefs.com/blog/link-building-case-study/) or [this video](https://www.youtube.com/watch?v=gMcA-8nalL8):
...
[@KFC]follows 11 people.Those 11 people? 5 Spice Girls and 6 guys named Herb.
...
However, [this question from Tim Ferriss](https://tim.blog/2016/12/07/testing-the-impossible-17-questions-that-changed-my-life/) might get you started on the right foot: *“What if I couldn’t pitch my product directly? What if I had to sell around the product?”*
...
That trip resulted in a ton of mentions on top publications like [Tech in Asia](https://www.techinasia.com/airawear-tware-massage-jacket), [Digital Trends](https://www.digitaltrends.com/cool-tech/airawear/), and [Business Insider](https://www.businessinsider.com/tware-massage-sweatshirt-gives-backrubs-2016-1).

The Tech in Asia article even got [syndicated](https://ahrefs.com/blog/content-syndication/) to another massive (at the time) publication: [Mashable](https://mashable.com/2016/01/08/massage-jacket/).
...
**Recommended reading:** [How to Dominate Any Tradeshow, and Why Even Solo Entrepreneurs Should Try](https://tim.blog/2013/11/08/how-to-dominate-any-tradeshow-and-why-even-solo-entrepreneurs-should-try/)
...
This was how we managed to secure further press mentions on publications like [Engadget](https://www.engadget.com/2016-05-09-airaware-massage-hoodie.html) and [Refinery29](https://www.refinery29.com/en-us/2016/09/123644/airawear-massage-hoodie-review).

This strategy works even if you’re an established name. For example, Tim Ferriss [sent out](https://tim.blog/2011/03/10/12-lessons-learned-while-marketing-the-4-hour-body/) more than 1,000 advanced copies of the 4-Hour Body, which resulted in a ton of Amazon reviews and turned the book into a bestseller.

Most recently, we gave a preview of [Ahrefs Webmaster Tools](https://ahrefs.com/webmaster-tools) to journalists, which resulted in mentions on [Search Engine Journal](https://www.searchenginejournal.com/ahrefs-webmaster-tools/381755/) and [Tech Radar](https://www.techradar.com/sg/news/heres-an-impressive-free-seo-tool-that-you-have-to-test-right-now):
...
Go to Ahrefs’ [Content Explorer](https://ahrefs.com/content-explorer/) and enter a query like `mailchimp AND aweber`
...
While you cannot dictate your organic ranking position, you can influence where it ranks. This is known as [Search Engine Optimization (SEO)](https://ahrefs.com/blog/what-is-seo) and broadly speaking, it involves:

**Knowing what your customers are searching for.**Do[keyword research](https://ahrefs.com/seo/keyword-research)to help you figure out which topics you want to appear for in Google.**Creating optimized content.**Pouring your heart and soul into a piece of content doesn’t guarantee that it’ll rank. You need to bake SEO into your content right in the beginning by[following a proven SEO framework](https://ahrefs.com/seo/seo-content).**Building links.**Links are an important[Google ranking factor](https://ahrefs.com/blog/google-ranking-factors/). If you’re following the strategies above, you’re likely already[getting links](https://ahrefs.com/blog/how-to-get-backlinks)back to your site.

[technical SEO](https://ahrefs.com/seo/technical-seo)), well-optimized pages (

[on-page SEO](https://ahrefs.com/seo/on-page-seo), and much more). We’re focusing on the three aspects above here because they’re your bread and butter. You’ll get nowhere unless you create content about things people are searching for and build links to that content.

Looking to learn more about SEO and how to do it? Follow [this free training course](https://ahrefs.com/academy/seo-training-course).
...
Did I miss any useful tips for getting earned media? [Ping me on Twitter](https://twitter.com/siquanong).
