---
title: "Flesch Reading Ease: Does It Matter for SEO? (Data Study)"
source_url: https://ahrefs.com/blog/flesch-reading-ease/
...
[What is Flesch Reading Ease?](#what-is-flesch-reading-ease)[Does Flesch Reading Ease score affect Google rankings?](#does-flesch-affect-google-rankings)[Should you optimize your content based on the Flesch Reading Ease score?](#optimize-content)[Notes about methodology](#notes-about-methodology)
...
In 2018, John Mueller from Google [said](https://www.seroundtable.com/google-reading-levels-algorithm-search-25157.html) he’s not aware of any algorithms that use basic readability scores. And since FRE is pretty basic with just two variables at play, it wouldn’t really make much sense to use it. So no, readability scores like FRE don’t directly affect rankings.
...
If searchers find your content hard to read and understand, they’ll probably leave. This leads to negative user experience signals like a low [dwell time](https://ahrefs.com/seo/glossary/dwell-time), time on page, and a high [bounce rate](https://ahrefs.com/blog/bounce-rate/), which may signal to Google that your page isn’t a great result.

Even worse, because fewer visitors actually end up consuming the content, fewer people will link to it—and we know that [backlinks](https://ahrefs.com/blog/what-are-backlinks/) are one of the [most important ranking factors](https://ahrefs.com/blog/google-ranking-factors/).
...
All this being said, here are six [content writing tips](https://ahrefs.com/blog/content-writing/) related to readability scores:
...
As long as you stick to solid writing practices, readability scores don’t matter for SEO. [Great valuable content does](https://ahrefs.com/blog/seo-writing/).
...
I selected a sample of a few big websites focused on engineering, marketing and food topics. Using the **Organic Keywords** report in [Ahrefs’ Site Explorer](https://ahrefs.com/site-explorer), I then exported a sample of keywords with varying monthly search volume ranges where each domain ranked in the top 10. This was done for English keywords in the US only:

I used different search volume ranges to make sure the samples included both fat-head and [long-tail keywords](https://ahrefs.com/blog/long-tail-keywords/) in each category. The keywords were unique and any obvious brand keywords were removed.
