---
title: "Keyword Search Volume: 5 Things You Need to Know to Avoid SEO Mistakes"
source_url: https://ahrefs.com/blog/keyword-search-volume/
...
Keyword search volume is an SEO metric that tells you how many times per month, on average, a certain keyword is searched for in a specific location. More often than not, search volume refers to the number of searches in Google, but this metric can also refer to [other search engines](https://ahrefs.com/blog/alternative-search-engines/) too.
...
In fact, Google’s goal is to satisfy its users right there and then without having them “waste time” clicking on any of the search results. According to [a recent study](https://sparktoro.com/blog/in-2020-two-thirds-of-google-searches-ended-without-a-click/), two-thirds of Google searches in 2020 ended without a click.
...
As of today, Google displays up to four paid search listings above the organic search results. And if you trace [the visual history of these paid placements](https://searchengineland.com/search-ad-labeling-history-google-bing-254332), it becomes painfully obvious Google is trying to make those ads nearly indistinguishable from the organic search results.
...
Ranking Top3 in Google in 2021:

— Tim Soulo 🇺🇦 (@timsoulo)[#AD1]
...
🖼️🖼️🖼️[pic.twitter.com/BbAfwwwjVk][June 29, 2021]
...
[Google Keyword Planner](https://ads.google.com/intl/en_us/home/tools/keyword-planner/) is widely regarded as the best source of keyword search volume data, as it comes directly from Google itself. And it’s not a secret the vast majority of SEO tools pull their keyword search volumes from GKP.

But how accurate are the search volume numbers in GKP?

Well, there’s one source of data that is universally deemed the “single source of truth” when it comes to search volumes: [Google Search Console](https://search.google.com/search-console/about).
...
And that is exactly what we did in [our recent experiment](https://ahrefs.com/blog/gsc-gkp-search-volume-study/).
...
[GKP](http://www.thesempost.com/googles-keyword-planner-now-combines-keywords-for-search-volume/) [tends to blend search queries with similar meaning together in one group](http://www.thesempost.com/googles-keyword-planner-now-combines-keywords-for-search-volume/) without an option to see a distinct search volume for each of those queries. This is quite handy for advertisers but can be a real headache for SEOs.
...
Let’s check that in Ahrefs’ [Site Explorer](https://ahrefs.com/site-explorer):
...
[We studied this “phenomenon” back in the day](https://ahrefs.com/blog/also-rank-for-study/), and it turned out the average top-ranking page would also rank for about a thousand similar keywords.
...
For any keyword that you see in [Keywords Explorer](https://ahrefs.com/keywords-explorer), we pull the top-ranking page and look up how much total search traffic it gets from all the keyword variations that it ranks for in Google. That value becomes the **Traffic Potential** of that keyword.

Here in Ahrefs’ content marketing team, we’ve been doing that manually for quite a few years, and it has helped us a lot in choosing the right topics to target. But now this metric is finally added to [Keywords Explorer](https://ahrefs.com/keywords-explorer) for everyone to use.
...
There’s so much more to [keyword research](https://ahrefs.com/seo/keyword-research) than simply looking for keywords with the biggest search volume.
