---
title: "What are YouTube Tags and Which Ones Should You Add?"
source_url: https://ahrefs.com/blog/youtube-tags/
...
- Add tags that you think make sense and hope for the best;
- Use a logical process to add tags that make sense.
...
Here’s [what YouTube says](https://support.google.com/youtube/answer/146402?hl=en-GB):

Your video’s title, thumbnail and description are more important pieces of metadata for your video’s discovery. These ‚main pieces of information help viewers decide which videos to watch.
...
This is *probably* why most studies, like [this one from Briggsby](https://www.briggsby.com/reverse-engineering-youtube-search), show only a small positive relationship between the usage of keywords in tags and a video’s ranking position.
...
Before we get down to the nitty-gritty, it’s important to note that our “process” for adding YouTube tags is quite simple and by no means definitive. It’s what we do, but we have no hard evidence that it played a significant role in the [growth of our channel](https://ahrefs.com/blog/youtube-seo/) of the past couple of years.
...
[This study](https://backlinko.com/youtube-ranking-factors) of 1.3 million YouTube videos found a small relationship between rankings and the presence of the keyword in the video’s tags.
...
Whether this is true is anyone’s guess. But given that [YouTube’s official guidance](https://youtu.be/fWdkrIAzqOA?t=106) for tags is to “use the words and phrases that make the most sense for your video,” your target keyword is a good starting point.

So we almost always use our primary keyword as our first tag.

For example, look at the tags for [our keyword research video](https://www.youtube.com/watch?v=OMJQPqG2Uas):

The first tag is “keyword research” because that’s what we want to rank for.

It’s the same story for [our SEO checklist video](https://www.youtube.com/watch?v=taU9P98zfjk). We want to rank for “[SEO checklist](https://ahrefs.com/blog/seo-checklist/),” so that’s our first tag.

### 2. Add common, relevant keywords from top-ranking videos

Install the [free vidIQ browser extension](https://vidiq.com/extension/) (or [TubeBuddy](https://chrome.google.com/webstore/detail/tubebuddy/mhkhmbddkmdggbhaaaodilponhnccicb)), then search for your target keyword on youtube.
...
Go to [Ahrefs’ Keywords Explorer](https://ahrefs.com/keywords-explorer) and set the search engine to YouTube.
...
Using tags to “trick users into believing the content is something it is not” is against [YouTube’s spam policy](https://support.google.com/youtube/answer/2801973?hl=en&visit_id=637058906222563338-1980003221&rd=1) and could result in your video being taken down
...
YouTube’s [lists](https://support.google.com/youtube/answer/2801973?hl=en-GB) “placing **excessive** tags in the video description (“tag stuffing”) rather than placing them as tags upon upload” as another example of misleading users.
...
Looking to learn more about YouTube SEO? [Read this](https://ahrefs.com/blog/youtube-seo/), or watch this video:
