---
title: "What Do SEO Agencies Do? (And Tips for Choosing One)"
source_url: https://ahrefs.com/blog/what-does-an-seo-agency-do/
...
[Keyword research](https://ahrefs.com/seo/keyword-research) is a common starting point for most SEO campaigns.
...
– This refers to the average number of times a user searches for a query in Google each month. Often abbreviated to “SV” or “MSV” (monthly search volume).**Search Volume**– How difficult it is to appear in Google for the keyword.**Keyword Difficulty**– The position within Google of a particular keyword.**Keyword Ranking**

If you were thinking, “I could do this keyword research myself,” then you would be right.

You can.

Simply type a domain into Ahrefs’ [Site Explorer](https://ahrefs.com/site-explorer) and check the **Organic keywords** report.

Let’s try this with [ahrefs.com](https://ahrefs.com/).
...
Acquiring links is one of the most important activities in SEO. You need to have links to rank in Google. And yes, it’s still one of the most important confirmed [Google ranking factors](https://ahrefs.com/blog/google-ranking-factors/).

Agencies use different tools to identify link prospects, assess their authority, and contact other websites on your behalf.

For example, they may use a tool like Ahrefs’ [Site Explorer](https://ahrefs.com/site-explorer) to understand the authority of any link.

Their exact methods for acquiring links will depend on your website and its assets, but some agencies will propose to make a [piece of content that they think will attract links naturally](https://ahrefs.com/blog/link-bait).
...
When it comes to [link building](https://ahrefs.com/seo/link-building), there is a lot of associated jargon. You may hear your agency use the following terms:

– These links can influence page rankings with the search engine results.**Follow/Dofollow Links**– These links do not influence the search engine rankings of the destination URL.**Nofollow Links**– An SEO metric developed by Ahrefs that looks at the quality and quantity of the backlinks to a website and scores them on a scale from 0 to 100.**Domain Rating (DR)**– Assessment of all of the links that a website has.**Link Profile**

The jargon around links doesn’t stop there, unfortunately. But if you want to get more translations, you can check out our [SEO glossary](https://ahrefs.com/seo/glossary).
...
As well as supplying the core services, an SEO agency will provide you with a [detailed roadmap](https://ahrefs.com/blog/seo-roadmap/) when you start working together.
...
Good [technical SEO](https://ahrefs.com/seo/technical-seo) skills are arguably the most lucrative skill set you can have in SEO.

When you approach an SEO agency, it will showcase its technical SEO credentials and try to diagnose many of your website’s issues by conducting a [technical SEO audit](https://ahrefs.com/blog/technical-seo-audit/).
...
- Reviewing your
[site’s structure](https://ahrefs.com/blog/website-structure/); check that it is logical and optimized for search engines. - Reviewing your website’s performance such as site speed and
[Core Web Vitals](https://ahrefs.com/blog/core-web-vitals/). - Reviewing the
[internal](https://ahrefs.com/blog/internal-links-for-seo/)and external links of your website and share opportunities for improvement. - Reviewing your
[canonicals](https://ahrefs.com/blog/canonical-tags/)and[redirects](https://ahrefs.com/blog/redirects-for-seo/)to ensure they are implemented properly. - Reviewing your
[sitemap](https://ahrefs.com/blog/how-to-create-a-sitemap/)and[robots.txt](https://ahrefs.com/blog/robots-txt/)files to ensure that they are implemented correctly. - Reviewing your Google Search Console and Google Analytics accounts.
- Ensuring your images are optimized for search.

This is not an exhaustive list, but it gives you an idea of what technical elements the agency will consider. It will pick up this information from running a website crawl on a tool like Ahrefs’ [Site Audit](https://ahrefs.com/site-audit).
...
[Technical SEO](https://ahrefs.com/seo/technical-seo) is still required to maintain the site and ensure there are no significant problems with the website from a technical standpoint.
...
**Fully managed SEO**– Allows you to focus on your business.**Access to experienced SEO specialists**– You can leverage them for your business.**Access to**– Gives you better insights into your website’s SEO.**enterprise SEO tools****Achieve your business objectives**– Helps your business realize its goals by creating a personalized strategy.**Collaboration with your internal teams**– SEOs are used to working with other channels, such as PR, PPC, and affiliates, so they can work with your internal teams if required.**Learn from them**– The SEO agency will be more than willing to share its knowledge with you. You can use this as a stepping stone to build your own SEO team further down the line.
...
In a similar way that the award-winning agency has become a bit of a cliche, there are also some unscrupulous agencies that will add [Google Partner](https://www.google.com/partners/become-a-partner/) images and badges to their websites.

They do this to look more impressive. Here’s an example of someone complaining about this issue on a support thread.

[Google Partner](https://www.google.com/partners/become-a-partner/)is an approved advertising agency or third party that manages Google Ads accounts on behalf of other brands or businesses. Google Partner status is concerned more with PPC and is not an endorsement of an agency’s SEO services.

If you are unsure of an agency’s status, always check beforehand to confirm if it is legitimate using [this directory](https://partnersdirectory.withgoogle.com/).
...
For example, if it is using an [enterprise SEO tool](https://ahrefs.com/enterprise), then it’s probably clear from this that it is serious about SEO, and cash flow isn’t an issue for it.
