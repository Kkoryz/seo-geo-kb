---
title: "SEO Silo Structure: Why It Makes No Sense (And What to Do Instead)"
source_url: https://ahrefs.com/blog/seo-silo-structure/
...
[What is silo structure in SEO?](#what-is-silo-structure)[Why is siloing so popular?](#why-is-siloing-popular)[What’s the problem with silo structure?](#silo-structure-problems)[Best practices for site structure](#best-practices-for-site-structure)
...
If we run a quick search in [Content Explorer](https://ahrefs.com/content-explorer), we see over 11K published pages containing the phrase “silo structure” and the word “SEO.”
...
[Internal links](https://ahrefs.com/blog/internal-links-for-seo/) are one of the ways Google finds new pages, so it’s best practice to ensure that all of your pages are interlinked in some way or another.
...
[PageRank (PR)](https://ahrefs.com/blog/google-pagerank/) is Google’s formula for scoring the value of a page based on the quantity and quality of pages linking to it. Backlinks are how PR flows into your site, and internal links are how PR flows around it.
...
Both of these things help Google to understand the context of a page, as John Mueller explained in [this Webmaster Hangout](https://youtu.be/rO6wTSL6joE?t=442):
...
It’s worth pointing out at this stage that some SEOs disagree with the idea of restricting internal links to silos, including [Gael Breton](https://twitter.com/gaelbreton) from Authority Hacker:
...
However, the reality is that **once you do that, you’re no longer siloing**. You’re effectively just using a traditional pyramid site architecture, which is recommended by pretty much everyone, [including John](https://www.google.com/url?q=https://youtu.be/wsrL6l2Fxvo?t%3D3522&sa=D&source=docs&ust=1644946028977116&usg=AOvVaw14zbfEFf0C0OifLVqX6rDS).
...
**Easy to navigate**– Visitors start on the homepage, choose a category, then dig deeper.**Good PageRank flow**– Site homepages tend to get the most backlinks, so having important content close by makes sense.**Internal links are contextual**– Categories link to their respective subcategories and vice versa.
...
If you want to find relevant internal linking opportunities, there are a couple of ways you can do that using Ahrefs’ [Site Audit](https://ahrefs.com/site-audit) (get access for free with [Ahrefs Webmaster Tools](https://ahrefs.com/webmaster-tools) account).

The first is using the **Link Opportunities** tool, which suggests where you should add internal links.

For example, here the report is suggesting we link from [our SEO glossary](https://ahrefs.com/seo/glossary) to [our meta robots guide](https://ahrefs.com/blog/meta-robots/):
...
For example, if we search for mentions of “search quality rater guidelines” on the Ahrefs blog, which is a keyword we’re targeting in [our QRGs guide](https://ahrefs.com/blog/google-quality-raters-guidelines/), we see a mention in [our list of Google ranking factors](https://ahrefs.com/blog/google-ranking-factors/).
...
**Recommended reading:** [Content Hubs for SEO: How to Get More Traffic and Links With Topic Clusters](https://ahrefs.com/blog/content-hub/)
...
You can see how deep your content is at a glance using Ahrefs’ [Site Audit](https://ahrefs.com/site-audit). Just go to the **Structure Explorer** and toggle the “Depth” tab.
...
Got questions? Disagree? Ping me [on Twitter](https://twitter.com/joshuachardwick?lang=en).
