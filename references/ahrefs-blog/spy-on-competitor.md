---
title: "How to Spy on Your Competitors"
source_url: https://ahrefs.com/blog/spy-on-competitor/
...
*exactly*can you view and track their activities?

It’s simple—you can use a tool like Ahrefs to find out.

Not sure who your competitors are? Plug a domain into Ahrefs’ [Site Explorer](https://ahrefs.com/site-explorer) and go to the **Organic competitors** report.
...
[Archive.org](https://archive.org/). - Overview of its marketing performance in
...
If we enter Grammarly’s website into [Site Explorer](https://ahrefs.com/site-explorer) and head over to the **Organic keywords** report, we can see the keywords its website ranks for.

Here’s what I look at when spying on a competitor while using this report:

**I check the KD column**– How hard are these keywords to rank for? How much effort will I need to put in to surpass my competitor?**I check the “traffic” column**– How much organic traffic are these keywords driving on your competitor’s site? What’s the prize?
...
**Using Ahrefs’**– Best for quick checks.**Site Explorer****Using Ahrefs’**– Best for long-term monitoring of activity.**Rank Tracker**

Tracking a competitor’s organic traffic in [Site Explorer](https://ahrefs.com/site-explorer) is as simple as entering the domain name and clicking search. We can then see the “Organic search” keywords and traffic in the **Overview **report.
...
To find this out, plug a competitor’s domain into Ahrefs’ [Site Explorer](https://ahrefs.com/site-explorer), and you’ll see the value in the “Organic search” summary.

In this example, the estimated value of Grammarly’s organic search traffic is $5.1M.

To find the value of a specific page on a competitor’s website, you can use Ahrefs’ [Site Explorer](https://ahrefs.com/site-explorer). Let’s plug grammarly.com into the search bar and head over to the **Top pages** report.

Then add a **URL filter** containing `/blog/`

. This will enable us to find the most valuable blog pages on Grammarly’s website. You can use any **URL filter** you like. But as most websites have a blog, this is often a good place to start.

When it comes to paid advertising, you can use Ahrefs to monitor your competitor’s Pay Per Click (PPC) activity on Google.

Here’s how.

Enter your competitor’s domain into Ahrefs’ [Site Explorer ](https://ahrefs.com/site-explorer)and hit search.
...
Let’s head to Ahrefs’ [Content Explorer](https://ahrefs.com/academy/how-to-use-ahrefs/content-explorer/), plug in `site:grammarly.com`

, and click on the “Authors” tab.
...
Another way to use this feature is to search for mentions of your competitor using [Content Explorer](https://ahrefs.com/content-explorer) but exclude your competitor’s website.

To do this with Grammarly, we would enter the following into the search box:

`"grammarly.com" -coupons -promo -codes -site:grammarly.com`
...
To find what links your competitor (or any website) has, simply plug the domain name into Ahrefs’ [Site Explorer](https://ahrefs.com/site-explorer) and head over to the **Referring domains** report.
...
I’ve noticed that the Guardian’s website is linking to Grammarly. Using [Site Explorer](https://ahrefs.com/site-explorer), we can click on “Links to target” and see the exact links from the Guardian.

We can see in this example that the Guardian has referred to the Oxford comma article on Grammarly’s website.

If we right-click, copy this URL, and paste it into [Content Explorer’s](https://ahrefs.com/content-explorer) search bar, we can find the author and other helpful information on this page.
...
[SEO strategy](https://ahrefs.com/blog/orchard-seo-strategy/), you can check out Joshua Hardwick’s article on

[Grammarly’s SEO](https://ahrefs.com/blog/grammarly-seo/).
...
To do this, you can use the [Link Intersect tool](https://ahrefs.com/link-intersect). It allows you to compare your website against the competition.
