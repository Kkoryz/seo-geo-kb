---
title: "What Is the Buyer's Journey? How to Create Content for Every Stage"
source_url: https://ahrefs.com/blog/buyers-journey/
...
In fact, [71% of them](https://www.thinkwithgoogle.com/consumer-insights/consumer-trends/the-changing-face-b2b-marketing/) start their research with a generic search. They’re reading blog posts, watching videos, consuming reviews, asking their friends, participating in communities—before they even begin to consider your product.

So unless you’re [creating content](https://ahrefs.com/blog/content-creation/) that buyers are searching for early on, it’s likely that you’re not **even** going to be in the consideration set. But if you can appear in the early stages of the buyer’s journey, you get the opportunity to educate them and influence their decision-making.

In this post, you’ll learn the following:

[What is the buyer’s journey?](#1-what-is-buyer%E2%80%99s-journey)[What are the stages of the buyer’s journey?](#2-buyer%E2%80%99s-journey-stages)[How to create content for the buyer’s journey](#3-how-to-create-content-for-buyer%E2%80%99s-journey)

The buyer’s journey is the process a person goes through before making a purchase.

There are three stages:

**Awareness**– The buyer realizes they have a problem. They want to understand more about it.**Consideration**– The buyer is looking for and comparing potential solutions to their problem.**Decision**– The buyer purchases a solution.
...
Here’s the three-step process content marketer [Adrienne Barnes](https://twitter.com/AdrienneNakohl) recommends:
...
**Recommended reading:** [How to Create a Buyer Persona for Your Business](https://ahrefs.com/blog/how-to-create-a-buyer-persona/)
...
- Go to Ahrefs’
[Keywords Explorer](https://ahrefs.com/keywords-explorer) - Enter those terms
- Go to the
...
For example, the topic “how to drive traffic to your website” is likely a topic Billy is searching for at this stage. And we’ve targeted that topic with [a blog post](https://ahrefs.com/blog/how-to-drive-traffic-to-your-website/).
...
- Go to Ahrefs’
[Keywords Explorer](https://ahrefs.com/keywords-explorer) - Enter terms like “seo tools,” “ahrefs,” or “moz”
- Go to the
**Matching terms**report - In the
**Include**box, add comparison modifiers (e.g., vs, versus, best, top, review, reviews)

We’ll look through the list and pick out the topics that are relevant. For example, we can see from the list that potential customers are comparing our toolset with our competitors’ (e.g., ahrefs vs semrush). Thus, we decided to create a [comparison page](https://ahrefs.com/vs) that addresses all of these topics.
...
To do this, simply enter the brand name into [Keywords Explorer](https://ahrefs.com/keywords-explorer) and eyeball the list.
...
So, for example, rather than promote our pricing page to someone who’s just learning SEO, we can introduce [our suite of free tools](https://ahrefs.com/free-seo-tools) instead. That way, potential customers can get acquainted with what we do and how our tools work. Alternatively, we can encourage them to sign up for our newsletter to learn more about SEO.
