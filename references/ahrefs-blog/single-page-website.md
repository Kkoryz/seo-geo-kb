...
source_url: https://ahrefs.com/blog/single-page-website/
...
A single-page website contains all of the site’s content on only one landing page. Unlike multi-page websites, the user is unable to navigate to content on separate URLs via [internal linking](https://ahrefs.com/blog/prioritize-internal-linking/).
...
This process is often referred to as “[keyword mapping](https://ahrefs.com/blog/keyword-mapping/),” where keywords are mapped to dedicated landing pages based on Google’s perceived search intent behind the keyword.
...
Of course, there’s much more at play here. But generally, as a potential customer, you’ll be more likely to trust Store B. Similarly, in the eyes of Google, a wider breadth of trustworthy content is a signal of [expertise](/blog/eeat-seo/) and builds topical relevance and association to your niche.
...
In my first Ahrefs blog post titled “[Here’s Why You Should Prioritize Internal Linking](https://ahrefs.com/blog/prioritize-internal-linking/),” I mentioned how webmasters typically link to content of an informational nature as opposed to a transactional one.

So by going for a single-page website, you are likely to be compromising your ability to build quality backlinks.

[Link building ](https://ahrefs.com/seo/link-building)is one of the three key pillars of SEO. By rolling out a website structure that is far from optimal for building links, you’ll be limiting your ranking potential.
...
I mentioned earlier that it’s generally more difficult to build backlinks toward a single-page website. This is certainly the case. However, one advantage to having a single-page website is that you are less likely to suffer from [PageRank](https://ahrefs.com/blog/google-pagerank/) dilution.
...
Ensuring your users have good experience via mobile devices is more important than ever. According to [Statista](https://www.statista.com/statistics/277125/share-of-website-traffic-coming-from-mobile-devices/), a majority of all worldwide website visits come from users on mobile devices.

Google will also predominantly crawl the mobile version of your site and evaluate mobile-friendliness as part of its ranking signals. It’s never been more important to [optimize for mobile](https://ahrefs.com/blog/mobile-seo/).
...
Image optimization is often overlooked in SEO. Given how single-page websites often pack in lots of imagery, [image SEO](https://ahrefs.com/blog/image-seo/) should not be skipped.
...
Discussing [Core Web Vitals](https://ahrefs.com/blog/core-web-vitals/) on [Reddit](https://www.reddit.com/r/SEO/comments/oyp74h/comment/h7wltwg/?utm_source=share&utm_medium=web3x), John Mueller described Core Web Vitals as being “more than a tie breaker” signal.

[Think with Google](https://www.thinkwithgoogle.com/consumer-insights/consumer-trends/mobile-site-load-time-statistics/) states that 53% of visits are abandoned if a mobile site takes longer than three seconds to load.
...
This is because you are unable to roll out pages dedicated to attracting links, for example, using strategies such as [link baiting](https://ahrefs.com/blog/link-bait/).
...
There are also plenty of third-party platforms that journalists will use to submit such requests, such as [HARO](https://ahrefs.com/blog/haro-link-building/).
...
- Discover brand mentions via Ahrefs’
[Content Explorer](https://ahrefs.com/content-explorer) - Crawl the mentions with a custom search to filter out pages that already provide a link
- Perform outreach to the publishers that do not link, requesting that they add a link

Ahrefs’ Joshua Hardwick has provided a detailed guide on converting [unlinked brand mentions](https://ahrefs.com/blog/unlinked-mentions/) into backlinks. It’s well worth a read for more details on the above steps.

These are just two examples of link building strategies that don’t require content. Check out “[9 Easy Link Building Strategies (That Anyone Can Use)](https://ahrefs.com/blog/link-building-strategies/)”* *for eight more valid strategies that I haven’t mentioned here.

### Follow on-page best practices

My last tip is a pretty simple one, but it is probably one of the most crucial tips. Following [on-page SEO best practices](https://ahrefs.com/seo/on-page-seo) is a must.
