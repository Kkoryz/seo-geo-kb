...
source_url: https://ahrefs.com/blog/quora-marketing/
...
Since July 2018, I’ve been [active on Quora](https://www.quora.com/profile/Si-Quan-Ong-2), answering at least five questions a week on topics related to [Ahrefs](https://ahrefs.com/), SEO, and digital marketing. In that time, I’ve accumulated hundreds of thousands of views.
...
In this post, I will share everything I’ve learned so far with you. I’ve also invited my friend Jason Thibault, Founder of [MassiveKontent](https://massivekontent.com/), to share some tips. Jason started posting on Quora in November 2018 and has since experimented a lot with the platform.
...
As the Ahrefs brand grows and our reach broadens, more people start to recognize our name but don’t know exactly what we do. Or they might be in the “consideration” phase of the [buyer’s journey](https://ahrefs.com/blog/buyers-journey/) and are trying to compare different solutions on the market.
...
Fun fact: Quora has an [audience of 300 million monthly unique users](https://marketingland.com/quora-introduces-broad-targeting-says-audience-hits-300-million-monthly-users-248261).
...
Jimmy Daly, Director of Marketing at Animalz, [wrote that personal brands](https://www.animalz.co/blog/2019-content-trends/) are one of the most important [content promotion channels](https://ahrefs.com/blog/how-to-promote-your-blog/).

Influential team members have the potential and power to amplify the reach of your content. This is true for us at Ahrefs. When [Tim](https://ahrefs.com/tim), our CMO shares our articles on Twitter:

👊SEO vs. PPC 👊

[https://t.co/jQg3CGFIzG]^^ A very good overview of the ancient dilemma by our very own

[@siquanong]Please let us know if we forgot to cover some important argument.— Tim Soulo (@timsoulo)

[August 30, 2019]

He typically gets more reach than [our brand account](https://twitter.com/ahrefs):

✍️SEO vs. PPC: Which Should You Use? by

[@siquanong]Struggling to decide if you should invest in SEO or PPC? 📈

🔽 You’re in the right place!

[https://t.co/eSontQhbnM]— Ahrefs (@ahrefs)[September 4, 2019]
...
[Pareto’s Principle](https://en.wikipedia.org/wiki/Pareto_principle) suggests that only ~20% of the questions you could answer on Quora will actually send you traffic.
...
Enter *quora.com* into [Ahrefs’ Site Explorer](https://ahrefs.com/site-explorer), and go to the “Top pages” report. This shows the pages on Quora that receive the most organic search traffic.
...
We can use this to our advantage. Go to your [Quora Ads manager](https://www.quora.com/ads/). Click “Create Campaign.”
...
For example, I repurposed [our article on how long it takes to rank on Google](/blog/how-long-does-it-take-to-rank-in-google-and-how-old-are-top-ranking-pages/):

#### B. Select questions based on data

After using any of the above methods to find potential questions, you should have a set of URLs. Paste these URLs into [Ahrefs’ Batch Analysis](https://ahrefs.com/batch-analysis) to grab the important [SEO metrics](/blog/ahrefs-seo-metrics/).

Then, put these Quora URLs into [Screaming Frog](https://www.screamingfrog.co.uk/seo-spider/) and use custom extraction to grab relevant data such as the number of people who have answered the questions, links to competitors, etc.
...
**A**ttention: Capture their attention with something catchy or relevant.**I**nterest: Tell them interesting facts, uses, examples, or stories.**D**esire: Make them desire the product/service/etc.**A**ction: Get them to take action.

For example:

[This guide explains](https://kopywritingkourse.com/aida-formula/) more about the AIDA formula. If you’re interested in other copywriting formulas, here’s an [exceptional list](https://copyhackers.com/2015/10/copywriting-formula/).
...
When [Jason Lemkin first started](https://quora.simplecast.com/episodes/write-what-you-know-going-from-2-to-45), he answered 2-3 questions a day, 5-7 days a week. 53 million views later, he’s still going!

My friend Dean Yeong, Head of Content at [Sumo](https://sumo.com/), answered 1-3 questions a day in the first six months to gain traction.
...
Spaces are Quora’s answer to subreddits and Facebook Groups. You can search for relevant spaces [here](https://www.quora.com/spaces).

[JD Prater](https://twitter.com/jdprater), Quora’s Evangelist, shared one of my answers in his [Digital Marketing News and Trends space](https://www.quora.com/q/digital-marketing-news-and-trends-1). As a result, I got hundreds of upvotes and thousands of views:
...
If your answers are doing well organically on Quora, you can consider [using Quora Ads](https://ahrefs.com/blog/quora-ads/) to boost their performance.

Here are some ideas.

### 1. Quora Promoted Answers

This [answer from Gabriel Weinberg](https://www.quora.com/Why-should-I-use-DuckDuckGo-instead-of-Google/answer/Gabriel-Weinberg), Founder of [DuckDuckGo](https://duckduckgo.com/) has received ~180m views:
...
[According to Quora](https://quoraadsupport.zendesk.com/hc/en-us/articles/360020281151-Tracking-Promoted-Answers-Metrics), the “Clicks” metric measures how often someone clicks “More” for your answer:
...
My colleague, [Michal](https://twitter.com/michalpecanek/), got pretty good results with Promoted Answers when he was at CDN77. So I would encourage you to test and make your own conclusions.
...
Is there anything that I’ve missed? Let me know in the comments or [on Twitter](https://twitter.com/siquanong).
