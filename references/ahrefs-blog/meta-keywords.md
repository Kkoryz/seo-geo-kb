---
title: "Meta Keywords: What Are They and Should You Use Them?"
source_url: https://ahrefs.com/blog/meta-keywords/
...
[meta tags](https://ahrefs.com/blog/seo-meta-tags/)that you can use to give search engines more information about a page’s content. They’re found in a webpage’s HTML source code, and are not visible to visitors.
...
Do you still use meta keywords tags on pages you optimize?— Bill Slawski ⚓ (@bill_slawski)
...
“Officially” they say they still do, but I think this is a very low weight factor, even for яндекс. This is the consensus among most of us who have done SEO in Russian 🙂

[https://t.co/RrNAmzR0Vb]— orun bhuiyan (@orvn)[May 29, 2020]
...
The meta keyword tag is dead in terms of SEO value for

[@BingWMC]. We exclude it and ignore it.[@CoperniX][@facan]— Christi Olson (@ChristiJOlson)[May 29, 2020]
...
keywordsare important for Baidu to evaluate page’s value.
...
**Help prevent keyword cannibalization.**[Keyword cannibalization](https://ahrefs.com/blog/keyword-cannibalization/)is where a website targets the same keyword across multiple pages. It can cause all kinds of issues, like undesirable pages outranking desirable pages.**Avoid overlapping work.**If you work in[enterprise SEO](https://ahrefs.com/blog/enterprise-seo/), there are probably many people and teams working on similar things. Having an internal keyword tagging system helps prevent multiple teams from targeting the same keyword.**Find collaboration opportunities.**If you see that you’re not ranking well for one of your keywords, you might want to collaborate with another team to improve and update your content.
...
Bill Slawski’s [recent Twitter poll](https://twitter.com/bill_slawski/status/1266409136125734913) shows that roughly 33% of people still use the keywords meta tag. As some of those people will undoubtedly be your competitors, this can come in quite handy for finding ‘seed keywords’ during [keyword research](https://ahrefs.com/seo/keyword-research). Just look for the keywords meta tag on your competitor’s homepage.

For example, here’s the keywords meta tag for the homepage of a popular toy store:

It lists a bunch of toy-related keywords like *toys*, *climbing accessories*, *climbing frames*, *games*, *inflatables*, *pre school*, *sandboxes*, *slides*, etc.

Paste any relevant ones into a [keyword research tool](https://ahrefs.com/blog/free-keyword-research-tools/) like Ahrefs’ [Keywords Explorer](https://ahrefs.com/keywords-explorer) and choose a keyword ideas report. You’ll find thousands or even millions keyword ideas—complete with estimated monthly [search volumes](https://ahrefs.com/blog/keyword-search-volume/) and [SEO metrics](/blog/ahrefs-seo-metrics/).
