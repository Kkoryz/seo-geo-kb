---
title: "6 Things I Love About Zapier's SEO Strategy: A Case Study"
source_url: https://ahrefs.com/blog/zapier-seo-case-study/
...
The whole concept reminds me of using a back door. Here’s an example. [This article ](https://zapier.com/blog/best-todo-list-apps/)about “to-do list” apps can’t possibly talk about Zapier directly because Zapier is not that kind of app.

So instead, the article introduces the app through a series of “back doors.” Here’s back door #1:

And back door #2:

There are even more back doors here leading to [product marketing](https://ahrefs.com/blog/product-marketing/) articles:

- Link to another blog post with more automation ideas
- Links to product landing pages explaining the entire integration with a given app (
[example](https://zapier.com/apps/ticktick/integrations)) - Link inside the “related reading” section
...
There may be another approach to creating the back door. You can start from [keyword research](https://ahrefs.com/seo/keyword-research):
...
The way you create tens of thousands of landing pages within one lifetime appears to be programmatic SEO and [Zapier Partner Program](https://zapier.com/platform/partner-program).
...
[this study by Ryan Berg](https://ryanberg.co/how-zapier-reached-35m-arr-with-this-saas-seo-strategy/), Zapier has recently transitioned to a pure programmatic approach. I’m not entirely sure this is the case, but it seems that the amount of original content on the “integrations” pages has, in fact, diminished.

Before:

After:

Check out Ryan’s case study to learn more about the effects of the programmatic approach over time. (Ryan started analyzing Zapier in 2018.) And while we’re at other Zapier case studies, this is also an interesting one by Jessica Greene: [Does Updating Website Content Work? [Zapier Case Study]](https://jessicagreene.marketing/blog/updating-website-content/).

Zapier uses this kind of landing pages to leverage [branded search](https://ahrefs.com/blog/branded-search/) too.
...
There are probably multiple takeaways here. But the main one is [search intent](https://ahrefs.com/blog/search-intent/), if you ask me.
...
What I call a self-building [content hub (aka topic cluster)](https://ahrefs.com/blog/content-hub/) is a situation where you organize your existing content into a content hub structure and link new related content (subpages) as you create it.
...
To illustrate, we’ve got [this](https://zapier.com/learn/remote-work/) guide (a topic cluster, technically speaking) on remote work. In 2017, it was a set of 14 links. It contained only content developed specially for that hub.
...
Let’s not forget those links are, in fact, [internal links](https://ahrefs.com/blog/internal-links-for-seo/) that distribute link equity *from *the pillar page *to *the linked pages.
...
Original research makes great [link bait](https://ahrefs.com/blog/link-bait/).

But what makes original research good enough to make people link?

This [Zapier research](https://zapier.com/blog/side-hustle-report/) shows that it’s not necessarily about the length of the study.
...
Use pages with a lot of backlinks to boost other pages. You can boost your “boring” money pages with link equity from pages with a lot of backlinks. This is called [the middleman method](https://ahrefs.com/blog/orchard-seo-strategy/).
...
My point is that while Zapier is great in SEO, it doesn’t make its [content marketing](https://ahrefs.com/blog/content-marketing/) only about ranking for keywords with traffic potential.
...
So if you have an opportunity to publish an interesting article that won’t necessarily bring you organic traffic, it still may be worth it if you can promote it via your direct [marketing channels](https://ahrefs.com/blog/marketing-channels/).
