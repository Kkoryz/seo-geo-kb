---
title: "How many keywords can you rank for with one page? (Ahrefs’ study of 3M searches)"
source_url: https://ahrefs.com/blog/also-rank-for-study/
...
And if you adopt [this new strategy](https://ahrefs.com/seo/keyword-research), you’ll be getting around a hundred highly targeted visitors per month from ranking anywhere in the top5 for this keyword.
...
There were quite a few studies ([ours included](https://ahrefs.com/seo/on-page-seo)) that showed a rather high correlation between the backlink factors of a page and its Google rankings.

But I don’t think I’ve seen a study of how backlink factors correlate with the number of keywords that a page ranks for.

So we created 5 buckets by [URL Rating](/blog/ahrefs-seo-metrics/#section1) (which shows how strong the backlink profile of a given URL is) and looked at the average number of “also rank for in top10” keywords for each of them:
...
[correlation does not imply causation](https://en.wikipedia.org/wiki/Correlation_does_not_imply_causation). So the above research doesn’t allow us to say that backlinks help you rank for more keywords. All we can say is that pages with more backlinks tend to rank for a larger number of keywords.
