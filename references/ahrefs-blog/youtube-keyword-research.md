...
source_url: https://ahrefs.com/blog/youtube-keyword-research/
...
For example, [Google Trends](https://trends.google.com/trends/?geo=US) tells us that searches for “pizza dough recipe” are slowly declining in recent years on Google…
...
Head over to [Ahrefs Keywords Explorer](https://ahrefs.com/keywords-explorer), select [YouTube as the search engine](https://ahrefs.com/youtube-keyword-tool), and enter a seed keyword. Let’s go for “unboxing.”
...
Fail to match [search intent](https://ahrefs.com/blog/search-intent/), and you’re dead in the water before you even start.
...
To see how much traffic the current video results are getting from Google, copy and paste the URLs into [Ahrefs Site Explorer](https://ahrefs.com/site-explorer) one by one.

Alternatively, use this [Scraper Chrome extension](https://chrome.google.com/webstore/detail/scraper/mbigbapnjcgaffohmbkdlecaccepngjd?hl=en) to scrape all video URLs in bulk, then paste them into [Ahrefs Batch Analysis tool](https://ahrefs.com/batch-analysis).
...
Click “Scrape,” then “Copy to clipboard,” then paste all URLs into the [Batch Analysis tool](https://ahrefs.com/batch-analysis) and set the mode to URL.

Sort the report by the “Traffic” column from high to low.

Dig into the “Organic keywords” report in [Site Explorer](https://ahrefs.com/site-explorer) to see which keywords they rank for, and where they’re getting most of their traffic from.
...
[Content Explorer](https://ahrefs.com/content-explorer) is a searchable database of over a billion web pages, complete with SEO and social metrics.
...
Copy and paste the video URLs into [Ahrefs Site Explorer](https://ahrefs.com/site-explorer) one by one.
...
Paste the results into the [Ahrefs Batch Analysis tool](https://ahrefs.com/batch-analysis), select the URL mode, run the search, then sort by the “Traffic” column from high to low.
...
If your goal is to build your channel and [get more views](https://ahrefs.com/blog/how-to-get-more-views-on-youtube/), then you need to make keyword research a priority.


Learn more about YouTube SEO [here](https://ahrefs.com/blog/youtube-seo/).

Got questions? Ping me in the comments or [on Twitter](https://twitter.com/joshuachardwick?lang=en).
