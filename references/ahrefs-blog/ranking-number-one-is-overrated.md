---
title: "Ranking #1 on Google Is Overrated (Ahrefs’ Study of 100k Keywords)"
source_url: https://ahrefs.com/blog/ranking-number-one-is-overrated/
...
I use [Ahrefs Keywords Explorer](https://ahrefs.com/keywords-explorer)—our [keyword research](https://ahrefs.com/seo/keyword-research) tool—almost daily.
...
Still, these days, I rarely pay much attention to the search volume of individual keywords (I explained why [here](https://ahrefs.com/blog/keyword-search-volume/) and [here](https://ahrefs.com/blog/keyword-search-volume/)). Rather, I look at the amount of search traffic to the top-ranking pages.
...
Why does this happen? Because those pages [also rank for](https://ahrefs.com/blog/also-rank-for-study/)—and get traffic from—hundreds of long-tail keywords.
...
## The study: how often does the top-ranking page __not__ get the most search traffic?
...
**Tip #1: **Check the** Phrase match** report in [Ahrefs’ Keywords Explorer.](https://ahrefs.com/keywords-explorer) Look for [long-tails](https://ahrefs.com/blog/long-tail-keywords/) you can simultaneously cover alongside your main topic.

**Tip #2: **Paste the URLs of the top 3 ranking pages into our [Content gap tool](https://ahrefs.com/content-gap). Filter only for keywords that include your main topic.
...
*“Why chocolate labs have shorter lifespans […]”*is most likely ranking so high thanks to the click-bait nature of its[headline](https://ahrefs.com/blog/how-to-write-a-headline/). There’s no way you could ignore that headline if you were researching chocolate labradors.*“Chocolate Lab - Your Guide To The Chocolate Labrador Retriever”*is a clear attempt to create the best possible resource about chocolate labradors. It’s hardly surprising that it gets more relevant search traffic than the other pages. Google has even rewarded it with three site links.
...
[Try our free tool](https://ahrefs.com/website-authority-checker).
...
Last year, we wanted to rank for the keyword “backlink checker.” So we made a landing page and described the backlink checking functionality in [Ahrefs’ Site Explorer](https://ahrefs.com/site-explorer).
...
- We added a lot of
[internal links](https://ahrefs.com/blog/internal-links-for-seo/); - We did some
[outreach](https://ahrefs.com/blog/outreach/)to earn quality external links.
...
So we built our own [free backlink checker tool](https://ahrefs.com/backlink-checker) and added it to the page.
...
Heck, the page even survived a [negative SEO](https://ahrefs.com/blog/negative-seo/) attack where someone was kind enough to point ~30k low-quality backlinks from ~600 domains our way shortly after our rankings shot up.

We didn’t even bother to [disavow](https://ahrefs.com/blog/google-disavow-links/) them and the page is still going strong!
...
If you’re lucky enough to “own” the snippet, it results in a lot of extra visibility and more clicks. You also effectively [steal clicks away from the other top-ranking pages](https://ahrefs.com/blog/featured-snippets-study/).
...
How do we know? Because if we check the **Organic keywords** report for that page in [Site Explorer](https://ahrefs.com/site-explorer), we see this:
...
Looking to learn more about featured snippets? Check out [our study of 2 million snippets](https://ahrefs.com/blog/featured-snippets-study/), and [our guide to finding and ‘stealing’ them](https://ahrefs.com/blog/featured-snippets/).
