...
source_url: https://ahrefs.com/blog/blog-title-formulas/
...
Unfortunately, coming up with a great blog title can be harder than it sounds. You have to get into the minds of your target audience *and* [be good at copywriting](https://ahrefs.com/blog/seo-copywriting/).

Luckily, I’ve written a blog title or two (thousand) in my day.

In today’s guide, you will learn:

[What makes a great blog title?](#blog-title-anatomy)[Seven proven blog title formulas (with examples)](#blog-title-formulas)[How to choose a blog post formula](#choosing-a-blog-post-formula)[How to make your blog titles SEO friendly](#how-to-make-blog-post-title-seo-friendly)

Every blog title, regardless of your industry or what you’re writing about, has to satisfy three main requirements:

- It contains the keyword you’re targeting for SEO.
...
You just have to [know what keyword you’re trying to rank for](https://ahrefs.com/blog/what-are-keywords/) and include that keyword in your title somewhere.
...
If you’re not sure what your reader wants, that’s a sign you need to dig deeper before you finalize your title. Again, search on Google to check competitors’ titles, and don’t be afraid to look on forums like [Reddit](https://www.reddit.com/) to learn more about your target reader.

### Having a unique angle

Does your title stand out from the crowd on the [SERPs](https://ahrefs.com/blog/serps/)? Or is it just a rehashing of the same title everyone else uses? Why should someone click on your article over another one?
...
These list posts, or “listicles,” can help you get more clicks. [A study by Moz](https://moz.com/blog/5-data-insights-into-the-headlines-readers-click) found that using numbers in your headline can drive up to 15% more clicks.
...
[How to Execute the Skyscraper Technique (And Get Results)](https://ahrefs.com/blog/skyscraper-technique/)- How to Keep Mice Out of Your Camper (The Easy Way)
...
[Ahrefs vs. SEMrush vs. Moz: What the Industry Thinks](https://ahrefs.com/vs)- Paddleboard vs. Kayak: Is One Better Than the Other?
...
-
[SaaS SEO: The Ultimate Tried & Tested Guide](https://ahrefs.com/blog/saas-seo/) - The Ultimate Guide to Living in a Van in 2022
...
[It Takes 2-6 Months to Rank on Google (But There’s More to the Story)](/blog/how-long-does-it-take-to-rank-in-google-and-how-old-are-top-ranking-pages/)- The Golden Gate Bridge Is 1.7 Miles Long - But How Was It Made?
...
This tells me I probably need to write a list post if I want to stand the best chance of [ranking on the first page in Google’s search results](https://ahrefs.com/blog/how-to-get-on-top-of-google-search/).
...
[Search intent](https://ahrefs.com/blog/search-intent/) is the reason behind the search. In other words, what are people searching for?
...
**Learn more:** [What Is Search Intent? A Complete Guide for Beginners](https://ahrefs.com/blog/search-intent/)

### 2. Optimize for long-tail keywords

[Long-tail keywords](https://ahrefs.com/blog/long-tail-keywords/) are less popular ways of searching for the same or similar things.
...
- Go to
[Keywords Explorer](https://ahrefs.com/keywords-explorer) - Enter your main target keyword
- Scroll to the
**SERP overview** - Find the top-ranking page most similar to yours
- Click to view the keywords it ranks for
- Filter for top 10 rankings

For example, say this is our target keyword: “is SEO worth it?”
...
The first tells me that many searchers are likely small-business owners. The second tells me that searchers care not only about the [cost of SEO but also its value](https://ahrefs.com/blog/is-seo-worth-it/).
...
Check out [this post by OptinMonster](https://optinmonster.com/700-power-words-that-will-boost-your-conversions/#:~:text=What%20are%20Power%20Words%3F,resist%20being%20influenced%20by%20them!) for a list of over 700 power words to try in your titles.
...
For this reason, we recommend using a free title checker like [this one](https://www.highervisibility.com/seo/tools/serp-snippet-optimizer/) before publishing. If it turns red, your title will likely get cut off in the search results.

If you want to check the title lengths for posts you’ve already published in bulk, you can use Ahrefs’ free [website checker](https://ahrefs.com/website-checker). Just enter your website, sign up for a free account, verify ownership, then go to [Site Audit](https://ahrefs.com/site-audit).
