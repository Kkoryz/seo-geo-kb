---
title: "9 Ways to Get More YouTube Subscribers"
source_url: https://ahrefs.com/blog/how-to-get-youtube-subscribers/
...
We did this by following a list of proven strategies that helped us get more subscribers to our [YouTube channel](https://www.youtube.com/channel/UCWquNQV8Y0_defMKnGKrFOQ).

In this post, I’ll share those strategies with you.

[Target topics that people are searching for](#target-topics-people-are-searching-for)[Keep your channel’s theme tight](#keep-channel-theme-tight)[Give people what they’re looking for](#give-people-what-they-are-looking-for)[Double down on formats that work](#double-down-on-formats-that-work)[Publish on a consistent schedule](#publish-on-consistent-schedule)[Add your videos to a playlist](#add-videos-to-playlist)[Link to your YouTube channel from external sources](#link-to-channel-from-external-sources)[Use YouTube’s interactive features](#use-youtube-interactive-features)[Ask your viewers to subscribe](#ask-viewers-to-subscribe)
...
Use our [free YouTube Keyword tool](https://ahrefs.com/youtube-keyword-tool). Just enter any topic, and it’ll show you up to 150 keywords and their estimated monthly search volumes.

Looking for a larger pool of ideas?

Use Ahrefs’ [Keywords Explorer](https://ahrefs.com/keywords-explorer) to pull all ideas from our database of over [800 million YouTube keywords](https://ahrefs.com/big-data).

Once that’s done, you need to create an optimized video that’ll rank in YouTube search results. [Follow this tutorial](https://ahrefs.com/blog/youtube-seo/) to learn how to create it, or watch [this video](https://www.youtube.com/watch?v=NY3y0V9UDwM):
...
For example, in 2018, [Sam Oh](https://twitter.com/samsgoh), our YouTube guy, got the opportunity to travel to Ahrefs’ headquarters in Singapore. At the time, we had around 30,000 YouTube subscribers.
...
The reality is that our subscribers only care about [SEO](https://ahrefs.com/blog/what-is-seo/) and digital marketing tutorials that help them get results for their websites, YouTube channels, and businesses. And you’ll see that’s all we publish now.
...
And many of our [blog posts](https://ahrefs.com/blog/why-content-marketing-is-important/):

But we don’t just limit it to the assets we can control. For example, when someone from the marketing team is interviewed on a podcast (or gives a talk), and the host asks where their audience can learn more about us, we often tell them to search for [Ahrefs on YouTube](https://www.youtube.com/channel/UCWquNQV8Y0_defMKnGKrFOQ).
...
Need more tactics on how to get more views on YouTube? [Read this post](https://ahrefs.com/blog/how-to-get-more-views-on-youtube).

Want to learn how to rank your videos in Google search? [Check this post out](https://ahrefs.com/blog/video-seo).

Did I miss out on any cool tactics to get more subscribers on YouTube? [Let me know on Twitter](https://twitter.com/siquanong).
