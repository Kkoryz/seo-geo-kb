---
title: "Blogger Outreach: How to Do It At Scale (Without Feeling Like a Jerk)"
source_url: https://ahrefs.com/blog/blogger-outreach/
...
*hate*blogger outreach. It makes them feel like a jerk. But it doesn’t have to be that way. It’s possible to do outreach, at scale, without feeling like a spammer.
...
- It
*feels*like you’re making tracks… even if you aren’t.
...
**Link prospects aren’t infinite**. No matter what niche you’re in, there are only a finite number of websites from which a backlink is likely to move the needle. If you burn through and alienate 99% of these prospects, the ceiling for your link building efforts is going to be pretty low.**Deliverability issues.**Have you ever seen[that button in Gmail](https://support.google.com/mail/answer/1366858?co=GENIE.Platform%3DiOS&hl=en)that marks emails as spam? The more people that click this, the less Google is going to trust your emails. And if that happens, your emails may end up in your recipients’ spam folders.**Lower quality links.**Because bad outreach is so prevalent, anyone with a half-decent website has likely received shotgun-style emails before. So, it’s probable that this approach is more likely to work on those with newer or weaker sites who don’t get so many bad pitches.
...
= Websites that link to inferior articles.[Skyscraper technique](https://ahrefs.com/blog/skyscraper-technique/)= Websites with relevant resource pages.[Resource page link building](https://ahrefs.com/blog/resource-page-link-building/)= Websites linking to relevant dead pages.[Broken link building](https://ahrefs.com/blog/broken-link-building/)= Websites that mention but don’t link to you.[Unlinked mentions](https://ahrefs.com/blog/unlinked-mentions/)
...
Even better, the CSV includes all [Ahrefs SEO metrics](/blog/ahrefs-seo-metrics/) like Domain Rating, estimated organic traffic, and so on. (These will come in handy later).
...
There’s no totally foolproof way of doing this, but I’ve found that filtering by [Domain Rating (DR)](/blog/ahrefs-seo-metrics/#section10) is the best way to do it at scale.
...
To reiterate, the reason for doing this is because *Big Fish* are more valuable than *Small fis*h, so it pays to spend more time and effort reaching out to those people.
...
For example, Tim’s email address is listed on [our team page](https://ahrefs.com/team) for everyone to see: ** [email protected]**.

But as Tim explains in [his outreach guide](https://ahrefs.com/blog/outreach/), some people prefer to send emails to a non‐existent ** [email protected]**, which are picked up by our catchall:
...
For example, if you install [their Chrome extension](https://chrome.google.com/webstore/detail/hunter-find-email-address/hgmhmanijnjhaffoampdlllchpolkdnj?hl=en) and hit it while browsing *ahrefs.com*, it’ll kick back the email addresses of a few people you might recognize.
...
[Site Explorer](https://ahrefs.com/site-explorer)or Google, then you can do something similar by running the pages through

[URL Profiler](https://urlprofiler.com/).
...
%First_Name%,I just came across your article:

%URL_of_their_article%Great stuff!

I noticed that you linked to this post:

%URL_where_they_link_to%It’s a great post, but I wrote an even better article on that same topic.

Check it out here:

%URL_of_my_article%I hope you can add a link to my post in your article or at least tweet it.
...
XXX. I’m totally going to implement it this month.

Your story of

XXXis totally inspiring. I’ve just shared it with a couple of my friends.
...
tweetedthis post, andI wrote a similar one…

You

publishedthis post, andI wrote a similar one…

You

linkedto this post, andI wrote a similar one…
...
XXXthe other day, so I thought you might appreciate reading a different opinion on that topic…

… I saw that you wrote this post but didn’t mention anything about

XXX, which is an important topic I talk about in my post…

… I noticed you linked to this article when talking about

XXX, but that’s actually no longer true. My post has more up-to-date…
...
%first_name%,Just been reading your post on blogger outreach: LOVE that tip about

%nugget_of_wisdom%.I’m emailing you because I actually just published my own guide to blogger outreach, and it mentions a couple of things I didn’t see you mention (e.g.,

%something_they_didn’t_mention%).Here’s the link: https://ahrefs.com/blog/blogger-outreach/
...
To add a mentions alert, go to [Alerts](https://ahrefs.com/alerts) > Mentions > + New alert
