---
title: "The Simple (But Complete) Guide to Video Marketing"
source_url: https://ahrefs.com/blog/video-marketing/
...
[What is video marketing?](#1-video-marketing)[Why is video marketing so powerful?](#2-why-video-marketing-is-powerful)[Types of marketing videos](#3-marketing-video-types)[How to get started with video marketing](#4-start-with-video-marketing)[Overcoming roadblocks and struggles](#5-overcome-roadblocks-struggles)[How to promote your videos](#6-promote-videos)[Video marketing examples](#7-video-marketing-examples)
...
In fact, in a 2018 study, [85% of U.S. internet users](https://www.statista.com/statistics/272835/share-of-internet-users-who-watch-online-videos/) watched online video content every month. (And that’s not even the highest penetration for video content.)
...
For example, one of my hobbies is breakdancing. So let’s say I wanted to learn the [windmill](https://en.wikipedia.org/wiki/Windmill_(b-boy_move)) and had to learn how to do it from this text-based description:
...
I would have given up on my dreams of becoming a [Red Bull BC One](https://en.wikipedia.org/wiki/Red_Bull_BC_One) champion within seconds of starting. But everything will be clear if I watch this video:
...
[Sam Oh](https://twitter.com/samsgoh), who runs [our YouTube channel](https://www.youtube.com/c/AhrefsCom), is beloved by our subscribers. In fact, because he appears on screen so often, he is regarded as a mentor by many of them:
...
Sometimes, people even get our authors confused. They may think that an article written by our [Michal Pecánek](https://twitter.com/michalpecanek) was written by me instead. This never happens with video, as it is impossible to watch one and confuse Sam with our head of content, [Joshua Hardwick](https://twitter.com/joshuachardwick), for example.

### 4. Video allows you to reach audiences on major platforms like YouTube

[YouTube has](https://blog.youtube/press/) over 2 billion monthly active users. The only way to reach them is to produce videos.

[TikTok has](https://www.statista.com/statistics/1267892/tiktok-global-mau/) over 1 billion monthly active users. The only way to reach them is to produce short videos.
...
If you don’t have an existing list of customers, then start by [thinking of who your product or service serves](https://ahrefs.com/blog/buyers-journey/#3-how-to-create-content-for-buyer%E2%80%99s-journey). Feel free to keep it broader for now.
...
This is basically what we do with our channel: We create tutorials on SEO and [marketing strategies](https://ahrefs.com/blog/digital-marketing-strategies/), then show our viewers how our tools make the processes easier and more effective.

#### C. Entertainment

This is pretty self-explanatory. If you are subscribed to Netflix or Disney+, you already know what this looks like.

For example, the [Red Bull YouTube channel](https://www.youtube.com/user/redbull/videos) does a great job of creating series and videos around extreme sports, effectively drawing in its target customers.
...
If you’re creating educational content—like what we do—then you can do [keyword research](https://ahrefs.com/seo/keyword-research) to see what kind of topics or questions people are searching for on YouTube.
...
**Recommended reading:** [How to Do YouTube Keyword Research in 3 Easy Steps](https://ahrefs.com/blog/youtube-keyword-research/)
...
**Problem**– Lead with the problem your video is solving**Teaser**– Show that there’s a solution to the problem without giving it away**Solution**– Teach how to solve the problem
...
According to [Wikipedia](https://en.wikipedia.org/wiki/Teleprompter), a teleprompter is a display device that prompts the person who is speaking with an electronic visual text of a speech or script.
...
**Shotgun mic**– Good if the subject is in one place (i.e., a “talking head” video)**Lavalier mic**– Works well if you have multiple subjects or you’re moving around a lot

**Lighting**

Some people prefer natural lighting, but Sam finds it hard to control. He recommends a [key light](https://en.wikipedia.org/wiki/Key_light) and a [fill light](https://en.wikipedia.org/wiki/Fill_light).
...
In fact, there have been [tons of movies](https://www.indiewire.com/2018/03/movies-shot-on-iphones-unsane-tangerine-shorts-1201941565/) made just from phone filmography. You’re overthinking it if you think your smartphone isn’t good enough.
...
- Go to Ahrefs’
[Content Explorer](https://ahrefs.com/content-explorer) - Run this search
...
- Go to Ahrefs’
[Site Explorer](https://ahrefs.com/site-explorer) - Enter your domain
- Go to the
**Top pages**report
...
https://twitter.com/ahrefs/status/1501744900748025856
...
For example, you can turn your video script into a blog post. We do this often at Ahrefs. In fact, this blog post you’re reading was originally a script (with some additions) from [one of our videos](https://www.youtube.com/watch?v=QCgDIhvFkCM). We’ve also done this for other videos too—[this post](https://ahrefs.com/blog/affiliate-marketing/) was originally [a video](https://www.youtube.com/watch?v=W-nbsnXtSZI).
...
If you’ve created a bunch of videos, you can consider repackaging them into a course. This is exactly what we’ve done with [our “Best of AhrefsTV” course](https://ahrefs.com/academy/ahrefs-youtube):

Finally, if your video is an expert interview or a presentation, you can extract the audio and turn it into a podcast. Many popular podcasters have done this, including Tim Ferriss ([YouTube channel](https://www.youtube.com/c/timferriss/videos)/[podcast](https://open.spotify.com/show/5qSUyCrk9KR69lEiXbjwXM?si=61112ff3dbfe43ef)), Peter Attia ([YouTub channel](https://www.youtube.com/c/PeterAttiaMD)/[podcast](https://open.spotify.com/show/63AWQmsSnFNFHUqnRAOFtD?si=1283ab2e3f234046)), and more.

**Recommended reading:** [The Complete Guide to Content Repurposing](https://ahrefs.com/blog/repurposing-content/)
...
The strategies and tactics that I’ve talked about in this post are from our experience. If you want to hear from the horse’s mouth, aka Sam, then [listen to this podcast](https://growthtoday.fm/sam-oh-ahrefs/) that he did on the Growth Marketing Today show.

### 2. Slidebean

Slidebean is a pitch deck design platform for startups and small businesses. Its [YouTube channel](https://www.youtube.com/c/Slidebean/videos) covers topics related to startups.
...
- A recurring video series about startups that targeted startup-related keywords.
- A series called “Company Forensics” focused on targeting topics higher up the
[marketing funnel](https://ahrefs.com/blog/marketing-funnels/)and, therefore, generating brand awareness.
...
Its space is extremely competitive, with entrenched brands like Monday.com, Asana, Trello, and so on. So this strategy works in the sense that it puts ClickUp’s brand in the minds of its target customers.
...
Did I miss out on anything important about video marketing? Let me know [on Twitter](https://twitter.com/siquanong).
