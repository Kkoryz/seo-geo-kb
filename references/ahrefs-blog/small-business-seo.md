---
title: "7 Easy SEO Tips for Small Businesses"
source_url: https://ahrefs.com/blog/small-business-seo/
...
A [Google Business Profile](https://www.google.com/intl/en_uk/business/) helps users find and learn about your business in Google search and maps. It’s free to set up and lets you share important details about your business with customers, like its phone number, opening times, and offerings.
...
Learn more in [our 30-minute Business Profile optimization guide](https://ahrefs.com/blog/google-my-business/).
...
The easiest way to do this is with an SEO audit tool like Ahrefs’ [Site Audit](https://ahrefs.com/site-audit). You can use this free of charge with an [Ahrefs Webmaster Tools (AWT)](https://ahrefs.com/webmaster-tools) account. Just sign up, follow the steps to crawl your site, then filter the All issues report for Errors:
...
To fix this issue, we can either reinstate, redirect, or remove [internal links](https://ahrefs.com/blog/internal-links-for-seo/) to the pages.
...
- Paste them into Ahrefs’
[Keywords Explorer](https://ahrefs.com/keywords-explorer)(make sure to select the country you’re in)
...
- Go to
[Keywords Explorer](https://ahrefs.com/keywords-explorer) - Search for your product or service (e.g., “boiler repair”)
...
**Give suppliers testimonials**. These often get featured on their sites along with a link.**Publish client spotlights.**For example, if you’re a plumber who recently helped renovate your local church, write it up and ping them about it. They might feature it on their website.**Pitch stockist pages.**For example, if your store stocks a local craft beer, see if the brewery lists its stockists on its website. If its does, you can usually get featured just by asking.

I would also recommend trying to replicate your competitors’ best backlinks. To find these, plug their site into Ahrefs’ [Site Explorer](https://ahrefs.com/site-explorer) and check the **Backlinks** report.
...
Google itself [advises](https://support.google.com/business/answer/3474122?hl=en-GB) small business owners to remind customers to leave reviews and reply to them to build trust:
...
This is also likely to help with your “map pack” rankings, at least according to [BrightLocal’s survey](https://www.brightlocal.com/learn/local-seo/introduction-to-local-seo/ranking-factors/). It states that 17% of SEOs deem reviews to be the most important ranking factor.
...
**More brand awareness.**Showing up in more places online means more people will become familiar with your business.**More traffic.**Ranking higher in Google and other search engines leads to more traffic.**More customers.**As long as your traffic is targeted, it’ll bring in more customers or clients.
...
**If your small business sells products nationally or internationally,** check out [our guide to ecommerce SEO](https://ahrefs.com/blog/ecommerce-seo/) or [our guide to international SEO](https://ahrefs.com/blog/international-seo/).

**If your small business sells services in multiple locations **(e.g., car hire), read [our guide to local keyword research](https://ahrefs.com/blog/local-keyword-research/) to learn how to optimize for that.
