...
source_url: https://www.semrush.com/blog/how-to-find-youtube-influencers/
...
There are more than [two billion active users](https://backlinko.com/youtube-users) on YouTube – that’s a huge pool of people to potentially build brand relationships with. And, because of its scope and popularity, YouTube is the [second most preferred platform](https://www.demandsage.com/youtube-stats/) for influencer marketing.

But it’s not just the size of YouTube that makes it such a powerful tool for influencer marketing. Google research shows that influencers on the platform have the [same power to guide people’s purchase decisions](https://www.thinkwithgoogle.com/marketing-strategies/video/youtube-influencer-marketing-rulebook/) as celebrities.
...
[YouTube influencer videos](https://www.semrush.com/blog/youtube-influencer-marketing/) can take many formats but a few popular examples are:
...
With 250 million subscribers, [MrBeast](https://www.youtube.com/channel/UCX6OQ3DkcsbYNE6H8uQQuVA) might be the most popular influencer in the world, but does his core audience align with your brand objectives? And will your budget stretch far enough to work with him?
...
First, you need to ensure that your influencer has the audience size and reach that you’re looking for. They also need to have a voice that aligns with your brand and messaging, as well as a price that matches your [budget](https://www.semrush.com/blog/influencer-marketing-campaign-cost/).

Once you’ve checked those basic characteristics, delve deeper into their previous content and online presence.

Pay attention to the number of views they get per post, the average number of likes, and links to any other social profiles they may have. You can do this manually or by leveraging influencer marketing tools like [Influencer Analytics](https://www.semrush.com/apps/influencer-marketing-platform/).
...
A savvy alternative is to use influencer-finding tools like [Influencer Analytics](https://www.semrush.com/apps/influencer-marketing-platform/) from Semrush.
...
### Using Audience Intelligence to Find YouTube Influencers

The [Audience Intelligence](https://www.semrush.com/apps/audience-intelligence/) app can show YouTube influencers whose audiences align with your target market.

Note: *Apart from showing you influencers, this tool also gives you* *demographic and interest data. That allows you to drill down into specific audience segments based on lifestyle preferences, online behavior, and content interaction patterns.*

To find YouTube influencers start by going to your report and clicking the “**Top Influencers**” section.

Here, you’ll see a list of accounts that your followers also follow. You can filter by country, audience interest group, and platform of interest.

To continue, click on the filters button in the top left corner of the table.

Then, click the dropdown menu under the “**Content Creators**” section and select the checkmark beside “**YouTube.**”

Click “**Apply**.”

Review the list of influencers the tool suggests based on your filters to find YouTube influencers.

For example, the generated list shows that the top YouTube micro-influencers for the Marriott brand focus on travel and storytelling content.

Use the Audience Intelligence app to find influencers with whom you can forge successful partnerships and reach the right audience.
