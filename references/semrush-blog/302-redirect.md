...
source_url: https://www.semrush.com/blog/302-redirect/
...
First, make sure that [mod_rewrite](https://httpd.apache.org/docs/2.4/mod/mod_rewrite.html) is enabled. Then use the RewriteEngine to configure your redirects.
...
It’s worth noting that you could also use [mod_alias](https://httpd.apache.org/docs/2.4/mod/mod_alias.html) for simplified redirects:
...
The browser won’t know which page to show. You’ll receive an ERR_TOO_MANY_REDIRECTS or “too many redirects” error and see a page that looks like this in Google Chrome:
