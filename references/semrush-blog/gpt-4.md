---
title: "What Is GPT-4? Key Facts and Features"
source_url: https://www.semrush.com/blog/gpt-4/
...
**Writing captions**: Upload your social media image and ask GPT-4 to write a caption according to your tone of voice (for example, witty, professional, or friendly).**Drafting alt text**: Upload an image you are using in a blog post and ask GPT-4 to provide you with appropriately descriptive[alt text](https://www.semrush.com/blog/alt-text/).**Generating code**: Upload a diagram or wireframe of a webpage, and ask GPT-4 to give you the relevant HTML and CSS.

One famous example of GPT-4’s multimodal feature comes from Greg Brockman, president and co-founder of OpenAI.

In his [livestream demo](https://www.youtube.com/watch?v=outcGtbnMuQ&t=994s), Brockman gives GPT-4 a photo of a rough sketch for a website. In response, GPT-4 produces the code necessary to build that website from scratch.

**Note**: GPT-4 does not generate images itself, though this capability is offered by another of OpenAI’s products, [DALL·E 2](https://openai.com/dall-e-2).
...
It also made significant improvements in standardized tests for advanced high school subjects in the U.S. like Physics and Chemistry, as [this chart from Open AI shows](https://openai.com/research/gpt-4).

What does this mean for marketers and SEOs? Some common use cases for GPT-4’s ability to perform complex tasks include:

**Drafting blog posts**: Provide a brief, and ask GPT-4 to write a first draft of a blog post. The more detailed and specific your brief, the more effective GPT-4 will be.**Writing website copy**: Describe your product or service, and ask GPT-4 to draft copy for your website or landing pages.**Analyzing the competition**: Give GPT-4 information about your market, and ask the AI to generate a list of the strengths and weaknesses of your main competitors.
...
The following [chart from OpenAI](https://openai.com/research/gpt-4) shows the accuracy of GPT-4 across many different languages. While the AI model appears most effective with English uses, it is also a powerful tool for speakers of less commonly spoken languages, such as Welsh.

### How Many Parameters Does GPT-4 Have?

GPT-4 has over 1 trillion parameters, according to reporting from U.S. news outlet [Semafor](https://www.semafor.com/article/03/24/2023/the-secret-history-of-elon-musk-sam-altman-and-openai). While OpenAI has not officially confirmed the number of parameters, early rumors that GPT-4 would have over 100 trillion parameters have been [strongly denied by OpenAI CEO Sam Altman](https://www.theverge.com/23560328/openai-gpt-4-rumor-release-date-sam-altman-interview).
...
GPT-4 is embedded in an [increasing number of applications](https://openai.com/customer-stories), from payments company Stripe to language learning app Duolingo. It is also included in a range of [AI copywriting](https://www.semrush.com/blog/ai-copywriting/) tools.
...
Extra reading: If you're looking for tips on the free version, read our other guide on [how to use ChatGPT](https://www.semrush.com/goodcontent/content-marketing-blog/how-to-use-chatgpt/).

### Bing Chat

GPT-4 is also available using Microsoft’s Bing search engine—though only if you’re using Microsoft’s Edge web browser. If you wish to use Bing Chat, [you can download Edge here](https://www.microsoft.com/en-us/edge/download?form=MA13FJ).
...
There are a range of other [AI tools](https://www.semrush.com/blog/top-ai-tools-2023/) to use for generative AI. Let’s take a look at several key tools.
...
The tool can help you produce [AI generated articles](https://www.semrush.com/blog/ai-generated-content-guide/) and optimize existing content for SEO.
...
[According to OpenAI](https://www.youtube.com/live/outcGtbnMuQ?feature=share&t=994), GPT-4 is 40% more likely to produce a factual result than GPT-3.5. That said, GPT-4 still regularly invents facts.
...
One example of this comes from [Patrick Hymel, MD](https://www.linkedin.com/pulse/kubrikian-hallucinations-my-deep-dive-using-chat-gpt-4-hymel-md/), who asked GPT-4 to summarize medical research. Even to an expert like Dr. Hymel, many of the claims made by GPT-4 appeared accurate. With further research, however, Dr. Hymel discovered that they were false.
...
This means that content generated by GPT-4—or any AI model—cannot demonstrate the “experience” part of [Experience, Expertise, Authoritativeness, and Trustworthiness (E-E-A-T)](https://www.semrush.com/blog/eeat/). E-E-A-T is a core part of [Google’s search quality rater guidelines](https://developers.google.com/search/blog/2022/12/google-raters-guidelines-e-e-a-t) and an important part of any SEO strategy.
...
GPT-4 cannot create images. While GPT-4 can interpret images as prompts, it can only provide responses in text. But one of OpenAI’s other products, [AI image generator](https://www.semrush.com/goodcontent/content-marketing-blog/best-ai-image-generator/) DALL·E 2, can be used to create images from text prompts.
