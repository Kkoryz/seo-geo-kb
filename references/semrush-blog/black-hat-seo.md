---
title: "What Is Black Hat SEO? 9 Risky Techniques To Avoid"
source_url: https://www.semrush.com/blog/black-hat-seo/
...
Search engines, such as Google to Bing, make it very clear which types of practices go against their terms. They're also quite clear on the potential outcomes if you violate their guidelines. Using black hat SEO tactics can lead to your website being [penalized](https://www.semrush.com/blog/google-penalties-expert-tips/) (either algorithmically or with a [manual action](https://support.google.com/webmasters/answer/9044175?hl=en)), which means lower-ranking positions and, most likely, a decline in organic traffic.
...
When looking at [Google's Webmaster Guidelines](https://support.google.com/webmasters/answer/35769?hl=en), we can clearly see that their guidance on the basic principles of SEO:
...
While [SEO](https://www.semrush.com/blog/what-is-seo/) is all about increasing a website's organic visibility and traffic, black hat tactics can actually result in the *opposite* of this happening. To help you understand why to avoid such approaches, we've broken this down into three key points...
...
This, in itself, can mean a reduction in a business' income and lead to job losses or even business closures. At best, a severe decline in organic traffic will mean that this has to be supplemented with a higher investment into [PPC](https://www.semrush.com/blog/what-is-ppc/) or other paid media.
...
While it might take some time for Google to determine that a site participates in unethical approaches (this could be that [a manual review was conducted](https://www.searchenginejournal.com/how-google-manual-reviews/356464/) or that a core algorithm was updated), once it happens, a loss of traffic is inevitable.
...
On our [Technical vs. UI/UX webinar](https://www.semrush.com/academy/webinars/), Bastian Grimm shared a comment about the change in the importance of UX for SEO over time, stating that:
...
If you're just getting started in SEO, it's often hard to know which tactics you should and shouldn't use. While many of the [SEO basics](https://www.semrush.com/blog/seo-basics/) are clear-cut white hat strategies, many of the more [advanced tactics](https://www.semrush.com/blog/advanced-seo/) require more attention to detail.
...
Creating great content isn't easy, yet there's no hiding from the fact that it remains one of [Google's top three ranking factors](https://searchengineland.com/now-know-googles-top-three-search-ranking-factors-245882).
...
Be sure to take the time to [create SEO-friendly content](https://www.semrush.com/blog/seo-writing/) to avoid issues caused by low quality or duplicate pages.
...
[Link schemes](https://support.google.com/webmasters/answer/66356?hl=en) are one of the most common types of black hat SEO, and this is the area where a lot of confusion often originates.

It's common sense to many marketers that you should be writing content that works for your users and that you shouldn't be hiding text, but [link building](https://www.semrush.com/blog/link-building/) gets a little more complex.
...
While [structured data](https://www.semrush.com/blog/schema-markup/) can help define entities, actions, and relationships online, a common black hat tactic is to abuse or misuse this type of markup.
...
While not very common, especially given that Google is getting better at ignoring the links that originate from such attacks, it's important to be aware of this and regularly analyze your link profile (something that can be done using the SEMrush [Backlink Audit Tool](https://www.semrush.com/backlink_audit/)).
...
You can [file a spam report with Google](https://support.google.com/webmasters/answer/93713) when you believe that a website is ranking due to paid links, spam, or other violations. While reporting a site won't result in direct action being taken, you're improving algorithmic spam detection.
...
All in all, we recommend avoiding black hat tactics on your own site. If you want some help to get your site more visible online, be sure to [learn how to rank your website](https://www.semrush.com/blog/seo-checklist/) using techniques that don't violate Google's Webmaster Guidelines.
