...
source_url: https://www.semrush.com/blog/how-to-write-brief/
category: semrush-blog
section: "Semrush blog — SEO/GEO methodology"
date: 2023-03-03
---

# How to Write a Brief: Complete Guide + Free Template
...
- Project goals
- Target audience
[Brand positioning](https://www.semrush.com/blog/brand-positioning-a-value-based-approach/)- Creative requirements
...
Download our [free template here](https://docs.google.com/document/d/111fXmywMx_BguEgnWP3MFzHLuvZpre25wBDofVpp4v8/template/preview) to create an easy-to-read brief based on the essential elements we discuss below. Fill it out as you read.
...
A creative brief provides direction on the creative aspects of the project. An [advertising campaign](https://www.semrush.com/kb/801-advertising-toolkit) to promote the app, for instance, will need a creative brief to help teams create ads that grab attention.
...
This [brief from Pantone](https://www.dandad.org/en/d-ad-creative-inspiration-brief-templates/), for example, named its project after the creative challenge they were running:
...
For example, here’s how [AmazonFresh](https://www.dandad.org/download/463692/) describes its service in a brief outlining how they’d create a new brand identity:

This introductory paragraph avoids a general history and instead focuses on what sets their brand apart.
...
Take this [sample PayPal brief](https://www.slideshare.net/aaga8/paypal-creative-brief), created and shared by Maggie Wang and Alan Arguelles. It sums up the goal of the company. But then adds a specific project goal in a single line:

“Clarify the misconceptions surrounding the brand and reiterate what PayPal is all about: A virtual wallet where the user’s in control.”

The task is clear and helps content creators know exactly what they have to do (clarify misconceptions and reiterate the core purpose of the product). It also includes the central message content needs to get across with a clear callout (“Receive money whenever, wherever).
...
The following [Netflix brief](https://www.behance.net/gallery/97530673/Creative-Brief-Netflix), shared by designer Laura Ferrari, does this by linking the purpose of its project to key challenges:

The company could have used this brief to plan a pandemic-era media strategy. The strategy would be targeted at gaining more subscribers, keeping existing customers, and increasing brand awareness.
...
In a brief, a [target audience](https://www.semrush.com/blog/target-audience/) section lets teams know who they need to appeal to. Information is based on your [buyer personas](https://www.semrush.com/persona/) or key audience demographics (i.e., the group of people your product or services are aimed at).
...
And this [brief from Burger King](https://www.dandad.org/download/463691/) includes behavioral traits to give creatives a picture of who they need to win over:
...
Take this mock-up [brief for Gray’s Cookies](https://beloved-brands-mini-mba.b-cdn.net/wp-content/uploads/2020/04/Creative-Brief-Template.png) prepared by Graham Robertson, which centers its message on the brand’s “guilt-free” positioning:
...
Information about desired messaging and tone is crucial if you’re planning to give your brief to an external team. According to one [study about outsourced content writing](https://www.semrush.com/blog/research-outsourcing-content-writing-challenges-and-benefits/), companies that outsource their content creation cite lack of understanding of brand voice or business values as the biggest bottleneck to a successful deliverable.

If you have [brand guidelines](https://www.semrush.com/blog/build-brand-identity/) or successful examples of your message and tone from previous campaigns, link to them in your brief.

The more reference material a creative team has, the easier it is for them to replicate your message.

For written content, your brief should also include [keywords](https://www.semrush.com/blog/what-are-keywords/#how-to-find-keywords-for-seo) or phrases you want in the final copy.

If you’re unsure what words people are using to find your brand, Semrush’s keyword tools can help.

Learn how in our guide to using [Semrush for keyword research](https://www.semrush.com/blog/how-to-use-semrush-keyword-research/).

### 6. Competitor Analysis

Include information about your closest competitors in your brief.

In her [brief template](https://www.carolinegibson.co.uk/client-brief/), copywriter Caroline Gibson asks clients two important questions:
...
Your [competitor analysis](https://www.semrush.com/blog/competitive-analysis/) doesn’t need to be too in-depth. Stick to the following:
...
**Pro Tip: **Semrush can make your [competitor analysis](https://www.semrush.com/blog/competitive-analysis/#step-3:-build-competitor-profiles) easier with [Market Explorer](https://www.semrush.com/market-explorer/).
...
This [brief for a Holiday Inn campaign](https://www.dandad.org/download/463684/), for instance, includes details on accepted image formats:
...
**Project Manager:**Kate**Design team:**Paul (web design), Jen (development)**Copywriter:**Stephen**Marketing team:**Ed (marketing manager), Joe (SEO), Steph (email marketing campaign)
...
This design [brief example from Slider Revolution](https://www.sliderrevolution.com/design/website-brief-template/) features a timeline for each part of the project:
...
While it’s important to have a [distribution strategy](https://www.semrush.com/blog/content-distribution-guide/) that outlines how and when you share assets, the brief only needs to outline what channels you’ll use. This information will influence the design and style of content.
...
Here’s how to write a brief, step by step:
...
This might contribute to a bigger business objective of increasing sales or lowering the average age of its customer base. Burger King will have other campaigns (e.g., [content marketing](https://www.semrush.com/goodcontent/content-marketing-blog/content-marketing/) or social media marketing) that also contribute to its broader goal.
...
Use the [SMART framework](https://www.semrush.com/blog/digital-pr-goals/#smart-goals-for-digital-pr) to make goals:
...
### 2. Identify the Problem or Opportunity You’re Addressing

The “why” of your project provides the background context and reason for the brief. Teams need to know the problem, challenge, or opportunity they’re addressing.
...
Take this snippet on the “why” of a [creative brief from WWF](https://www.dandad.org/download/463696/):
...
The team working on your brief should be able to visualize your audience so they can appeal to their wants and needs.
...
Here’s how the sample PayPal brief describes the customer it wants to target:

Reading this helps paint a picture. This campaign is aimed at teenagers who are becoming more independent and want more control over their money.

If you use [Google Analytics](https://analytics.google.com/analytics/web/) for your website, you’ll find audience demographics under “User” in “Reports.”

Supplement this information with Semrush’s “Audience” report from its [Market Explorer](https://www.semrush.com/market-explorer/) to get a breakdown of demographics for your industry.
...
### 4. Research Your Key Competitors

Your main competitors should feature at the top of the list in your brief’s competitor analysis.
...
### 5. Fully Describe Your Creative Vision
...
[Charity & Biscuits’](https://www.charityandbiscuits.com/blog/brief-copywriter-six-simple-steps-free-template/) client copywriting brief does this well.
...
### 6. Set a Deadline for Every Milestone
...
**Project duration:**July 1st to Aug. 31st**July 1:**Kickoff meeting**July 20:**Ad copy draft is delivered**July 25:**Ad copy approved**Aug. 4:**Initial ad designs are delivered**Aug. 13:**Ad designs approved**Aug. 20:**Ads sent to the publisher**Aug. 25:**Ads uploaded to Google Adwords and Facebook Ads**Aug. 31:**Ads go live
...
### 7. Review Your Brief and Gather Feedback
