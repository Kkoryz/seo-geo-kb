---
title: "Influencer Marketing: What Is It and How to Build a Solid Strategy"
source_url: https://www.semrush.com/blog/influencer-marketing-guide/
...
Traditional advertising is becoming less effective, and even many online channels are starting to stagnate due to [a rise in ad blocking](https://www.socialmediatoday.com/news/global-ad-blocking-behavior-2019-infographic/551716/) and changes in consumer behavior.
...
And [Psychologist World](https://www.psychologistworld.com/influence/social-influence) does a great job of explaining this as social influence, saying:
...
There is ultimately an overlap between influencer and [word of mouth](https://www.semrush.com/blog/word-of-mouth-stats/) marketing, simply because both tactics are based around getting other people talking about your business.
...
Affiliates get paid only when a sale is made; influencers are paid regardless of the outcome of a campaign. Semrush even offers its own affiliate marketing program: the [Semrush Affiliate Program](https://www.semrush.com/lp/affiliate-program/). Our program allows affiliates from all different sectors, from content creators to agencies, to earn a commission.

Plus, we support you from day 1 with dedicated account management, training materials and resources to promote Semrush and generate revenue.
...
- Businesses are making $5.20 for every $1 they spend on influencer marketing. (
[Influencer Marketing Hub](https://influencermarketinghub.com/influencer-marketing-statistics/)) - 80% of marketers find influencer marketing effective. (
[MediaKix](https://mediakix.com/influencer-marketing-resources/influencer-marketing-industry-statistics-survey-benchmarks/)) - 70% of teens trust influencers more than traditional celebrities. (
[Digital Marketing Institute](https://digitalmarketinginstitute.com/en-gb/blog/20-influencer-marketing-statistics-that-will-surprise-you)) - 60% of influencer marketing budgets are set to increase in 2020. (
[BigCommerce](https://www.bigcommerce.co.uk/blog/influencer-marketing-statistics/#10-most-important-influencer-marketing-statistics-for-2020)) - The influencer marketing industry is on track to be worth up to $15 billion by 2022. (
[Business Insider](https://www.businessinsider.com/influencer-marketing-report?r=US&IR=T)) - 49.6% of influencers state their followers care most about authentic content. (
[Zine.co](https://blog.zine.co/influencer-marketing-statistics-2020))
...
You often hear platform-specific influencers talked about, be that Instagram Influencers, [YouTubers](https://www.semrush.com/blog/youtube-influencer-marketing/), or others. But their platform is, really, just the distribution channel for their content.
...
In 2018, [Forbes](https://www.forbes.com/sites/barrettwissman/2018/03/02/micro-influencers-the-marketing-force-of-the-future/#161c27f96707) defined this group if influential individuals as *the marketing force of the future*.

[Micro-influencers](https://www.semrush.com/blog/micro-influencers/) aren’t celebrities, just everyday social media users who have built up a following of like-minded people, and usually have [between 1,000 and 10,000 engaged followers](https://blog.hubspot.com/marketing/micro-influencer-marketing).
...
**Traditional ads are declining in effectiveness**, whereas influencer collaborations continue to become increasingly successful. This is largely due to the fact that consumers prefer social posts to traditional ads and engage with them in a totally different way. Seeing an influencer collaboration doesn't feel like you are being advertised to in the same way.**People buy from people**, and influencer collaborations help you show a human side to marketing and add authenticity to your campaign. We are all becoming immune to advertising, yet increasingly receptive to products promoted by influencers who we admire.- With most marketing channels,
**effort and responsibility are one-sided**. When working with influencers, they also want your campaign to perform well, as this can lead to repeat work and collaborations. They are proud of their platforms and want every partnership to perform. **Especially younger generations trust influencers**and their product recommendations and promotions way more than celebrities and others who endorse products, and marketers can make the most of this. After all, why invest in collaborating with someone who your audience doesn’t trust?**You can find highly target influencers**in pretty much any niche, meaning you are able to reach your exact customer demographic with targeted campaign promotions.- Influencer marketing is a
**fantastic way to reach new audiences**who are actively engaging with content and can offer a cost-effective way to quickly increase brand awareness of products and businesses. - Despite what many say,
**you can clearly**of influencer campaigns in the same way as you can other channels, meaning you can shape ongoing investment based on the returns that you see.[measure the ROI](https://www.semrush.com/blog/how-to-measure-influencer-marketing-roi/)
...
**Reach.**If you are looking to raise awareness of your business’ products or services to new audiences, reach may be a great goal. After all, if your influences are targeted, a focus on reach can be a great way to maximize the number of people who become aware of your offering.**Traffic**. Another goal might be to increase the traffic to your website as a result of a collaboration—both direct and as a result of an increase in brand searches on Google.**Sales and Conversions.**At the end of the day, most marketing campaigns have the ultimate goal of making money. Due to the way you can track a campaign, it is definitely possible to run a campaign that has a goal of driving direct sales. Using discount codes can be a great way to incentivize quick sales while also allowing performance to be tracked back to an influencer.
...
At this stage, you will probably want to understand roughly what it costs, on average, to work with influencers across each platform. And thanks to stats from [WebFX](https://www.webfx.com/influencer-marketing-pricing.html), we can reveal these to be:
...
If you are looking to work with celebrity influencers, you almost certainly need to approach them through an agent. with an example being the [Ministry of Talent](http://theministryoftalent.com/talent/) that represents a whole host of influencers. It is very rare that they will be handling their own collaborations.

Most reading this article will be looking to [work with micro-influencers](https://www.semrush.com/blog/how-to-find-micro-influencers/), and the good news is that you can often effectively scope these out and approach them yourself.
...
With Influencer Analytics specifically, you can search for influencers by channel or keyword. As well as see data on influencers’ metrics.

Here’s how you can easily find the right influencers for your needs.

Let’s say you want to run a [YouTube influencer marketing](https://www.semrush.com/blog/youtube-influencer-marketing/) campaign and need creators and celebrities to promote your products.

Start by going to “**Influencer Discovery**” and selecting **YouTube**.

Click “**Filters**” in the top-right corner.

Then set your preferences for subscriber count, category, pricing, country, etc.

You’ll see a list of results based on your criteria.

You can also click into each influencer’s profile to see additional data as well as contact information.

**Note:** For a deeper dive, unlock other helpful data like channel quality and account activity as you review influencer accounts.

And as you search for influencers, save them to a list to review later.

And once you have identified a number of influencers who you think could be great to help you to meet your campaign goals, we recommend hooking these up in [Social Tracker](https://www.semrush.com/social-media/?tool=tracker) from Semrush Social. By adding these influencers as ‘competitors’, you can quickly and easily see their top-performing content.
...
You can also use Prowly’s [Media Monitoring tool](https://prowly.com/media-monitoring/) to find and report on mentions from influencers and their audiences across the web. This will help you add further insights to your campaign analysis.
...
Last year [the FTC posted updated guidelines](https://www.ftc.gov/system/files/documents/plain-language/1001a-influencer-guide-508_1.pdf) on how influencers should disclose paid collaborations. Here are some highlights:
...
The FTC is responsible for the guidelines in the US, and in the UK it is the [ASA](https://www.asa.org.uk/resource/influencers-guide.html).
