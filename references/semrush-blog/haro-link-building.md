...
source_url: https://www.semrush.com/blog/haro-link-building/
category: semrush-blog
section: "Semrush blog — SEO/GEO methodology"
date: 2023-10-05
---

# HARO Link Building: How to Get Backlinks with HARO
...
[Help a Reporter Out (HARO)](https://www.helpareporter.com/) is a platform that connects journalists with sources who can give expert insights on relevant industry topics.
...
Second, you can use HARO’s new pitching platform, [Connectively](https://connectively.us/). This allows you to see journalist requests as they go live. Plus, you can filter opportunities and track your pitches within the platform.
...
Moreover, many SEO agencies now include the HARO link building method in their standard link building campaigns. Alongside techniques like [guest posting](https://www.semrush.com/blog/guest-blogging/).
...
- Build Experience, Expertise, Authoritativeness, and Trustworthiness (
[E-E-A-T](https://www.semrush.com/blog/eeat/)) by being cited as an expert on authoritative websites - Land high-quality backlinks that actually get referral traffic
...
We recommend using HARO’s new pitching platform, [Connectively](https://connectively.us/).
...
If you’re unsure of which pitch topics might be related to your industry, use [Semrush’s Topic Research tool](https://www.semrush.com/topic-research/).
...
**Pro tip**: Filter queries by “Date Posted” to get the most up-to-date opportunities. Responding to queries quickly can mean yours is the first pitch to land in a journalist’s inbox and may get selected over the competition.

If you think a query looks like something you want to pitch, simply click on the title to show the full details.

The query will usually detail the website the article is going to be published on. Use [Semrush’s Domain Overview](https://www.semrush.com/analytics/overview/) to check out the quality and potential SEO value of the website.
...
By using Semrush’s [Backlinks](https://www.semrush.com/analytics/backlinks/) tool, you can see when you get a new link to your site. This way, you can track which pitches have landed you a link and, if needed, tweak your pitching process.
...
With [Semrush’s Brand Monitoring app](https://www.semrush.com/apps/brand-monitoring/), you can see when your website has been mentioned but not linked to.
...
[Qwoted](https://www.qwoted.com/) is a US-based pitching platform that connects industry experts, PR professionals, and journalists all in one place.
...
Moreover, once registered, you will be featured on the [expert database](https://app.qwoted.com/sources?_ga=2.234815323.493263605.1692372005-512354160.1691005423).
...
[Featured](https://featured.com/) (Formally Terkel) is another U.S.-based pitching platform. It directly connects experts and thought leaders with journalists from some of the world’s most high-authority websites, including **SHRM, GoDaddy, Fast Company, Business Insider, and Zapier**.
...
[PressPlugs](https://pressplugs.co.uk/) is a U.K.-based platform that connects expert sources with some of the U.K.’s biggest media outlets, including **Metro, The Daily Mail, BBC News, The Guardian, and The Telegraph**.
...
[SourceBottle](https://www.sourcebottle.com/) is an Australian-based pitching platform that works similarly to Help a Reporter Out.
...
[Help a B2B Writer](https://helpab2bwriter.com/) connects experts with professional writers who write for B2B companies, including Shopify and Content Marketing Institute.
...
To learn more about how to take your link building to new heights, check out our [link building strategies guide](https://www.semrush.com/blog/link-building-strategies/).

And try the [Link Building Tool](https://www.semrush.com/link_building/) today:
