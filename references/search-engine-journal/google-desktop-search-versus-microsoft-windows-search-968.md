---
title: "Google Desktop Search versus Microsoft Windows Search"
source_url: https://www.searchenginejournal.com/google-desktop-search-versus-microsoft-windows-search/968/
...
Once you install the software at [http://desktop.google.com/ ](http://desktop.google.com/)and try it a few times, you’ll be hooked. In fact, if you’re like me, you’ll wonder how you got along without it! My wife is less impressed, but she also said to me, “I KNOW where stuff is on my computer!” That’s because she only has emails and occasional Word documents and photos on her machine and knows where each of them are stored.
...
If you click the “emails” link from those in the top of the Desktop Search links, it lists only the emails that turned up with the search words in them, then click on any one of those results and it shows the email in the browser window. At the bottom of that page it shows “< Older | Newer >” links to see them by date, then “View Entire Thread (2)” and “Reply”,
...
Mike Banks Valentine practices Search Engine Optimism at: [http://SEOptimism.com](http://SEOptimism.com) and operates a search engine blog where you can[ read this article](http://realityseo.com/2004/10/google-desktop-search-versus-microsoft.html) with active links to web resources.

[Tools](https://www.searchenginejournal.com/category/digital-marketing-tools/)
