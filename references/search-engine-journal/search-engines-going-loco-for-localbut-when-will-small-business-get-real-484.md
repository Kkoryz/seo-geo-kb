---
title: "Search Engines Going Loco for Local...But When Will Small Business Get Real?"
source_url: https://www.searchenginejournal.com/search-engines-going-loco-for-localbut-when-will-small-business-get-real/484/
...
Right now it’s free, but you can expect to see paid AdWords in the future. The company plans to include international markets in the coming months. [http://www.local.google.com](http://www.local.google.com)
...
SmartView already displays sponsored links by Overture, which of course is owned by Yahoo! Industry experts say that SmartView is only one piece of Yahoo!’s local search strategy, which it will try to aggregate in a number of different ways. [http://maps.yahoo.com ](http://maps.yahoo.com)
...
Results are returned with business name, address and phone, each linked to a MapQuest map and estimated driving distance. MQSearch results can be sorted alphabetically or by distance, and the search radius can be expanded from 25 to 50 miles. [http://www.mapquest.com/maps/main.adp ](http://www.mapquest.com/maps/main.adp)

———————————————————-

These are just the big ones, there are others, and they are all jockeying for position in the local search race. In addition to search engines, there are specialty local oriented sites such as [www.topix.net](http://www.topix.net), www.vivante.com, and www.mobilemaps.com.
...
Guest Columnist Sharon Fling is the author of “How To Promote Your Local Business On the Internet”, and creator of GeoLocal.com, the web’s largest resource for using the Internet to promote small local business online. Visit [http://www.geolocal.com](http://www.geolocal.com) and subscribe to GeoLocal’s free Tip of the Week.
