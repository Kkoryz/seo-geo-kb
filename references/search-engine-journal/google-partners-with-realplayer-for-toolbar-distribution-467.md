---
title: "Google Partners with RealPlayer for Toolbar Distribution"
source_url: https://www.searchenginejournal.com/google-partners-with-realplayer-for-toolbar-distribution/467/
category: search-engine-journal
section: "Search Engine Journal — SEO/GEO news + guides"
date: 2004-04-20
---

# Google Partners with RealPlayer for Toolbar Distribution
...
With [MSN](https://www.searchenginejournal.com/microsoft-search-engine-to-launch-rival-google-and-yahoo/348/), [Yahoo](https://www.searchenginejournal.com/yahoo-adds-popup-blocker-to-toolbar/136/), [Amazon’s A9](https://www.searchenginejournal.com/amazons-a9-search-engine-launches/454/), [UCMore](https://www.searchenginejournal.com/ucmore-search-engine-tool-cleans-up-image/286/), and other search related toolbars hitting the market left and right, this may start a “toolbar distribution war” among search engine companies.

RealPlayer 10 is the first free media player that enables consumers to play content in any of the major Internet media formats, including RealAudio, RealVideo, AAC, Windows Media, QuickTime MPEG-4 and MP3. By including the Google Toolbar in the RealPlayer download options, consumers can choose to install the free web browser tool which enables them to quickly and easily search Google from any web page. Once Google opens its [GMail email](https://www.searchenginejournal.com/google-gmail-user-review-and-preliminary-impressions/457/) to the puplic, the Google Toolbar will be the ultimate place to promote the new GMail and access one’s inbox.
