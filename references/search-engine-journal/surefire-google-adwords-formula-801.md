---
title: "Surefire Google Adwords Formula"
source_url: https://www.searchenginejournal.com/surefire-google-adwords-formula/801/
...
Hereâ€™s the surefire three-step formula thatâ€™s as easy as oneâ€¦twoâ€¦three.
...
Hereâ€™s early results from a campaign I tested:
...
From here on wait until the challenger accumulates 40 clicks before deciding if it’s better or not. (Unless itâ€™s dramatically out performing the reigning winner.) If so it’s the new champ. If it is, or isn’t, repeat Step 3 trying another idea.

CTR Boosting Ideas to Test

Here are five known CTR boosting tactics you can test:

â€¢ Put the target keyword in the headline. Google will bold it to draw attention to your ad.

â€¢ List the big benefit on the first line of text followed by the features. Does this generate more response than an ad that simply lists various features?

â€¢ Capitalize the first letter of each word verses using all lowercase.

â€¢ Do action inducing words likeâ€¦ sign up, new, right now, today, buy now, save now, apply here â€¦impact response?

â€¢ Qualify by including the price.

Result? Over time you’ll improve your CTR driving more traffic to your site. Making you a winner in the Adwords game.

This is why I say you don’t have to be a marketing Einstein to develop Adwords ads that work. Just know a little bit about your marketâ€™s hot buttons and the market will tell you the rest.

See? a surefire formula that’s as easy as oneâ€¦twoâ€¦three.

So what you waiting for? Start testing today for more traffic tomorrow.

—

Guest columnist John Gergye shares more ideas like this in his just updated eBook “Traffic From Google in 35 Days”. Find out more here: http://www.traffic-test-tube.com/j/tfg35cl.shtml

Or test your search engine IQ by taking his seo quiz http://www.traffic-test-tube.com/search-engine-quiz.shtml and get the free special report “Coming Out On Top”.
