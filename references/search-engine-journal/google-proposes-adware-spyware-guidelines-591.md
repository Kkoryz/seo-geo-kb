...
source_url: https://www.searchenginejournal.com/google-proposes-adware-spyware-guidelines/591/
...
Google’s proposed guidelines are available on [Google ](http://www.google.com/corporate/software_principles.html)and also printed below. We think this is a good step for a web powerhouse like Google to propose these guidelines, even if lawmakers and software programmers ignore them, it states Google’s case (especially if they are planning on partnering with adware companies or releasing more downloadable search tools).
...
Google would like readers to send their opinions and comments to [software-principles@google.com](mailto:software-principles@google.com)
