...
source_url: https://schema.org/RadioBroadcastService
category: schema-org
...
- Canonical URL: https://schema.org/RadioBroadcastService
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+RadioBroadcastService)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<script type="application/ld+json"> { "@context": "https://schema.org/", "@type": "RadioBroadcastService", "name": "NPR Boston", "callSign": "WBUR" } </script>
