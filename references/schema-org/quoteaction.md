---
title: "QuoteAction"
source_url: https://schema.org/QuoteAction
category: schema-org
...
- Canonical URL: https://schema.org/QuoteAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+QuoteAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John quoted a flight for US$ 1,500.--> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "QuoteAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "Flight", "name": "AA123" }, "price": "1500", "priceCurrency": "UDC" } </script>
