---
title: "TradeAction"
source_url: https://schema.org/TradeAction
category: schema-org
...
- Canonical URL: https://schema.org/TradeAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+TradeAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John traded a Book for US$ 50.--> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "TradeAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "Book", "name": "Outliers" }, "price": "50", "priceCurrency": "USD" } </script>
