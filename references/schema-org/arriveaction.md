---
title: "ArriveAction"
source_url: https://schema.org/ArriveAction
category: schema-org
...
- Canonical URL: https://schema.org/ArriveAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+ArriveAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John arrived at the hotel. --> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "ArriveAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "Hotel", "name": "The Hilton" } } </script>
