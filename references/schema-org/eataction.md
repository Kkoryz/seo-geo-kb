---
title: "EatAction"
source_url: https://schema.org/EatAction
category: schema-org
...
- Canonical URL: https://schema.org/EatAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+EatAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John eat a cake. --> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "EatAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "Product", "name": "Cake" } } </script>
