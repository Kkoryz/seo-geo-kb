---
title: "Play"
source_url: https://schema.org/Play
category: schema-org
...
- Canonical URL: https://schema.org/Play
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+Play)

A play is a form of literature, usually consisting of dialogue between characters, intended for theatrical performance rather than just reading. Note: A performance of a Play would be a

[TheaterEvent](/TheaterEvent)or[BroadcastEvent](/BroadcastEvent)- the*Play*being the[workPerformed](/workPerformed).| Property | Expected Type | Description |
|---|---|---|
| Properties from
|
