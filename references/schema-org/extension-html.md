...
source_url: https://schema.org/docs/extension.html
category: schema-org
...
[2011-2014](/docs/old_extension.html) and
[2014-2018](/docs/old_extension_2015.html) docs for details).
...
we relied primarily on the '[hosted extensions](/docs/old_extension_2015.html)' mechanism
...
One label --- '[pending](/docs/extension.html)' --- is kept reserved for enabling us to more rapidly introduce
...
themselves (e.g., [http://gs1.org/voc](http://gs1.org/voc)) will continue as before.
