...
source_url: https://schema.org/Recommendation
category: schema-org
...
- Canonical URL: https://schema.org/Recommendation
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+Recommendation)

[Recommendation](/Recommendation)is a type of

[Review](/Review)that suggests or proposes something as the best option or best course of action. Recommendations may be for products or services, or other concrete things, as in the case of a ranked list or product guide. A

[Guide](/Guide)may list multiple recommendations for different categories. For example, in a

[Guide](/Guide)about which TVs to buy, the author may have several
...
[CategoryCode](/CategoryCode)or[PhysicalActivityCategory](/PhysicalActivityCategory)or[Text](/Text)or[Thing](/Thing)or[URL](/URL)[Review](/Review)
