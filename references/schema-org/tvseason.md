---
title: "TVSeason"
source_url: https://schema.org/TVSeason
category: schema-org
...
- Canonical URL: https://schema.org/TVSeason
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+TVSeason)
...
[Movie](/Movie),[TVEpisode](/TVEpisode),[TVSeason](/TVSeason), and[TVSeries](/TVSeries)can be used for both works and their multiple expressions, it is possible to use[titleEIDR](/titleEIDR)alone (for a general description), or alongside[editEIDR](/editEIDR)for a more edit-specific description.[CreativeWorkSeason](/CreativeWorkSeason)
