---
title: "Comment"
source_url: https://schema.org/Comment
category: schema-org
...
- Canonical URL: https://schema.org/Comment
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+Comment)
...
[Comment](/Comment)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|
...
[CreativeWork](/CreativeWork)or[RsvpAction](/RsvpAction)[parentItem](/parentItem)

[Answer](/Answer)or[Comment](/Comment)or[Question](/Question)[Article](/Article)or other[CreativeWork](/CreativeWork). See also[comment](/comment)which points from something to a comment about it.[resultComment](/resultComment)
