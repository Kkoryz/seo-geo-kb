...
source_url: https://schema.org/WebPageElement
category: schema-org
...
- Canonical URL: https://schema.org/WebPageElement
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+WebPageElement)
...
[WebPageElement](/WebPageElement)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|
