---
title: "Recipe"
source_url: https://schema.org/Recipe
category: schema-org
...
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+Recipe)

A recipe. For dietary restrictions covered by the recipe, a few common restrictions are enumerated via

[suitableForDiet](/suitableForDiet). The[keywords](/keywords)property can also be used to add more detail.| Property | Expected Type | Description |
|---|---|---|
| Properties from
|
...
[Duration](/Duration)[ISO 8601 duration format](http://en.wikipedia.org/wiki/ISO_8601).```
...
[ItemList](/ItemList)or[PropertyValue](/PropertyValue)or[Text](/Text)[ingredients](/ingredients).```
```[recipeInstructions](/recipeInstructions)

[CreativeWork](/CreativeWork)or[ItemList](/ItemList)or[Text](/Text)```
```[recipeYield](/recipeYield)

[QuantitativeValue](/QuantitativeValue)or[Text](/Text)```
```[suitableForDiet](/suitableForDiet)

[Diet](/Diet)or[RestrictedDiet](/RestrictedDiet)[HowTo](/HowTo)

```
```[estimatedCost](/estimatedCost)

[MonetaryAmount](/MonetaryAmount)or[Text](/Text)```
...
[CreativeWork](/CreativeWork)or[HowToSection](/HowToSection)or[HowToStep](/HowToStep)or[Text](/Text)[steps](/steps).```
```[supply](/supply)

[HowToSupply](/HowToSupply)or[Text](/Text)```
```[tool](/tool)

[HowToTool](/HowToTool)or[Text](/Text)```
```[totalTime](/totalTime)

[Duration](/Duration)[ISO 8601 duration format](http://en.wikipedia.org/wiki/ISO_8601).```
```[yield](/yield)

[QuantitativeValue](/QuantitativeValue)or[Text](/Text)[CreativeWork](/CreativeWork)
...
[Recipe](/Recipe)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|

[CookAction](/CookAction)### Examples
