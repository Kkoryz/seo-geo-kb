...
- Equivalent Property: og:image
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+image)

An image of the item. This can be a

[URL](/URL)or a fully described[ImageObject](/ImageObject).### Values expected to be one of these types
