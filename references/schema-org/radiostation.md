---
title: "RadioStation"
source_url: https://schema.org/RadioStation
category: schema-org
...
- Canonical URL: https://schema.org/RadioStation
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+RadioStation)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<script type="application/ld+json"> { "@context": "https://schema.org/", "@type": "RadioStation", "name": [ { "@value": "WKRP", "@language": "en" }, { "@value": "ˈdʌbəljuː ˈkeɪ ˈɑːr ˈpiː", "@language": "en-fonipa" } ] } </script>
