---
title: "DrawAction"
source_url: https://schema.org/DrawAction
category: schema-org
...
- Canonical URL: https://schema.org/DrawAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+DrawAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John drew a painting.--> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "DrawAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "Painting", "name": "Les Demoiselles d'Avignon" } } </script>
