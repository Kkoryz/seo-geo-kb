---
title: "Answer"
source_url: https://schema.org/Answer
category: schema-org
...
- Canonical URL: https://schema.org/Answer
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+Answer)
...
[Comment](/Comment)or[WebContent](/WebContent)```
```[parentItem](/parentItem)

[Comment](/Comment)or[CreativeWork](/CreativeWork)[Article](/Article)or other[CreativeWork](/CreativeWork). See also[comment](/comment)which points from something to a comment about it.[Comment](/Comment)
...
[Answer](/Answer)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|

[Question](/Question)[suggestedAnswer](/suggestedAnswer)

[Question](/Question)### Acknowledgements
