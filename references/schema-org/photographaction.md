...
source_url: https://schema.org/PhotographAction
category: schema-org
...
- Canonical URL: https://schema.org/PhotographAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+PhotographAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John took a photo of Steve.--> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "PhotographAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "ImageObject", "url": "http://john.com/steve.jpg" } } </script>
