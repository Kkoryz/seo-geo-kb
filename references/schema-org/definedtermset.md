...
source_url: https://schema.org/DefinedTermSet
category: schema-org
...
- Canonical URL: https://schema.org/DefinedTermSet
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+DefinedTermSet)
...
[DefinedTermSet](/DefinedTermSet)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|

[DefinedTerm](/DefinedTerm)[DefinedTermSet](/DefinedTermSet)that contains this term.#### More specific Types
