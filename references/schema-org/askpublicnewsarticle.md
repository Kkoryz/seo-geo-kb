...
source_url: https://schema.org/AskPublicNewsArticle
category: schema-org
...
- Canonical URL: https://schema.org/AskPublicNewsArticle
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+AskPublicNewsArticle)

A

[NewsArticle](/NewsArticle)expressing an open call by a[NewsMediaOrganization](/NewsMediaOrganization)asking the public for input, insights, clarifications, anecdotes, documentation, etc., on an issue, for reporting purposes.| Property | Expected Type | Description |
|---|---|---|
| Properties from
|
