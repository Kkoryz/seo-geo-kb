...
source_url: https://schema.org/ProductCollection
category: schema-org
...
- Canonical URL: https://schema.org/ProductCollection
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+ProductCollection)

A set of products (either

[ProductGroup](/ProductGroup)s or specific variants) that are listed together e.g. in an[Offer](/Offer).| Property | Expected Type | Description |
|---|---|---|
| Properties from
|
...
[TypeAndQuantityNode](/TypeAndQuantityNode)[Offer](/Offer)or[ProductCollection](/ProductCollection).[Collection](/Collection)
...
[translationOfWork](/translationOfWork)[Product](/Product)
