...
source_url: https://schema.org/IndividualPhysician
category: schema-org
...
- Canonical URL: https://schema.org/IndividualPhysician
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+IndividualPhysician)

An individual medical practitioner. For their official address use

[address](/address), for affiliations to hospitals use[hospitalAffiliation](/hospitalAffiliation). The[practicesAt](/practicesAt)property can be used to indicate[MedicalOrganization](/MedicalOrganization)hospitals, clinics, pharmacies etc. where this physician practices.| Property | Expected Type | Description |
|---|---|---|
| Properties from
|
...
[MedicalOrganization](/MedicalOrganization)[MedicalOrganization](/MedicalOrganization)where the[IndividualPhysician](/IndividualPhysician)practices.[Physician](/Physician)

```
```[availableService](/availableService)

[MedicalProcedure](/MedicalProcedure)or[MedicalTest](/MedicalTest)or[MedicalTherapy](/MedicalTherapy)```
...
[Text](/Text)[National Provider Identifier](https://en.wikipedia.org/wiki/National_Provider_Identifier)(NPI) is a unique 10-digit identification number issued to health care providers in the United States by the Centers for Medicare and Medicaid Services.[LocalBusiness](/LocalBusiness)
