---
title: "FundingScheme"
source_url: https://schema.org/FundingScheme
category: schema-org
...
- Canonical URL: https://schema.org/FundingScheme
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+FundingScheme)
...
[Grant](/Grant)funding. Examples of funding schemes: Swiss Priority Programmes (SPPs); EU Framework 7 (FP7); Horizon 2020; the NIH-R01 Grant Program; Wellcome institutional strategic support fund. For large scale public sector funding, the management and administration of grant awards is often handled by other, dedicated, organizations -[FundingAgency](/FundingAgency)s such as ERC, REA, ...| Property | Expected Type | Description |
|---|---|---|
| Properties from
|
