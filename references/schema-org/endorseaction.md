---
title: "EndorseAction"
source_url: https://schema.org/EndorseAction
category: schema-org
...
- Canonical URL: https://schema.org/EndorseAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+EndorseAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John endorsed Steve. --> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "EndorseAction", "agent": { "@type": "Person", "name": "John" }, "endorsee": { "@type": "Person", "name": "Steve" } } </script>
