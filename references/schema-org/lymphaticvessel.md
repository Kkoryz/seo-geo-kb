...
source_url: https://schema.org/LymphaticVessel
category: schema-org
...
- Canonical URL: https://schema.org/LymphaticVessel
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+LymphaticVessel)
...
[AnatomicalStructure](/AnatomicalStructure)or[AnatomicalSystem](/AnatomicalSystem)```
```[runsTo](/runsTo)

[Vessel](/Vessel)[AnatomicalStructure](/AnatomicalStructure)
