---
title: "VoteAction"
source_url: https://schema.org/VoteAction
category: schema-org
...
- Canonical URL: https://schema.org/VoteAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+VoteAction)
...
[Person](/Person)[ChooseAction](/ChooseAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John voted on Steve. --> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "VoteAction", "agent": { "@type": "Person", "name": "John" }, "candidate": { "@type": "Person", "name": "Steve" } } </script>
