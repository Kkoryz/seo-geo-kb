...
source_url: https://schema.org/BroadcastChannel
category: schema-org
...
- Canonical URL: https://schema.org/BroadcastChannel
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+BroadcastChannel)
...
[BroadcastChannel](/BroadcastChannel)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|
