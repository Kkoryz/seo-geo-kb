...
source_url: https://schema.org/SubscribeAction
category: schema-org
...
- Canonical URL: https://schema.org/SubscribeAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+SubscribeAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John subscribed to mailing list. --> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "SubscribeAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "Product", "name": "IEEE Mailing List" } } </script>
