---
title: "prepTime"
source_url: https://schema.org/prepTime
category: schema-org
...
- Canonical URL: https://schema.org/prepTime
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+prepTime)

The length of time it takes to prepare the items to be used in instructions or a direction, in

[ISO 8601 duration format](http://en.wikipedia.org/wiki/ISO_8601).### Values expected to be one of these types
