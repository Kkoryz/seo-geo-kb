...
source_url: https://schema.org/OperatingSystem
category: schema-org
...
- Canonical URL: https://schema.org/OperatingSystem
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+OperatingSystem)
...
[OperatingSystem](/OperatingSystem)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|

[SoftwareApplication](/SoftwareApplication)#### Source
