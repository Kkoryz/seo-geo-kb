...
source_url: https://schema.org/CovidTestingFacility
category: schema-org
...
- Canonical URL: https://schema.org/CovidTestingFacility
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+CovidTestingFacility)

A CovidTestingFacility is a

[MedicalClinic](/MedicalClinic)where testing for the COVID-19 Coronavirus disease is available. If the facility is being made available from an established[Pharmacy](/Pharmacy),[Hotel](/Hotel), or other non-medical organization, multiple types can be listed. This makes it easier to re-use existing schema.org information about that place, e.g. contact info, address, opening hours. Note that in an emergency, such information may not always be reliable.| Property | Expected Type | Description |
|---|---|---|
| Properties from
|
...
[MedicalSpecialty](/MedicalSpecialty)[LocalBusiness](/LocalBusiness)
