...
source_url: https://schema.org/ApartmentComplex
category: schema-org
...
- Canonical URL: https://schema.org/ApartmentComplex
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+ApartmentComplex)
...
[URL](/URL)[Place](/Place), such as an[Accommodation](/Accommodation)or[ApartmentComplex](/ApartmentComplex)in a real estate setting, as well as other kinds of tours as appropriate.[Residence](/Residence)
...
[Text](/Text)[Accommodation](/Accommodation)in a multi-storey building. Since counting systems[vary internationally](https://en.wikipedia.org/wiki/Storey#Consecutive_number_floor_designations), the local system should be used where possible.[Place](/Place)
