---
title: "WantAction"
source_url: https://schema.org/WantAction
category: schema-org
...
- Canonical URL: https://schema.org/WantAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+WantAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John and Steve want an ipod. --> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "WantAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "Product", "name": "ipod" }, "participant": { "@type": "Person", "name": "Steve" } } </script>
