---
title: "ConfirmAction"
source_url: https://schema.org/ConfirmAction
category: schema-org
...
- Canonical URL: https://schema.org/ConfirmAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+ConfirmAction)
...
[CancelAction](/CancelAction): The antonym of ConfirmAction.
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John confirmed the game was still on. --> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "ConfirmAction", "agent": { "@type": "Person", "name": "John" }, "event": { "@type": "SportsEvent", "name": "NBA finals" } } </script>
