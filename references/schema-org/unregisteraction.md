...
source_url: https://schema.org/UnRegisterAction
category: schema-org
...
- Canonical URL: https://schema.org/UnRegisterAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+UnRegisterAction)
...
[RegisterAction](/RegisterAction): antonym of UnRegisterAction.[LeaveAction](/LeaveAction): Unlike LeaveAction, UnRegisterAction implies that you are unregistering from a service you were previously registered, rather than leaving a team/group of people.
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John unregistered from Comcast. --> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "UnRegisterAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "Product", "name": "Comcast" } } </script>
