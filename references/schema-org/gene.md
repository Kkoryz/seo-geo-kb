---
title: "Gene"
source_url: https://schema.org/Gene
category: schema-org
...
- Canonical URL: https://schema.org/Gene
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+Gene)

A discrete unit of inheritance which affects one or more biological traits (Source:

[https://en.wikipedia.org/wiki/Gene](https://en.wikipedia.org/wiki/Gene)). Examples include FOXP2 (Forkhead box protein P2), SCARNA21 (small Cajal body-specific RNA 21), A- (agouti genotype).| Property | Expected Type | Description |
|---|---|---|
| Properties from
|
...
[AnatomicalStructure](/AnatomicalStructure)or[AnatomicalSystem](/AnatomicalSystem)or[BioChemEntity](/BioChemEntity)or[DefinedTerm](/DefinedTerm)```
...
[Gene](/Gene)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|

[Gene](/Gene)[isEncodedByBioChemEntity](/isEncodedByBioChemEntity)
