---
title: "HyperToc"
source_url: https://schema.org/HyperToc
category: schema-org
...
- Canonical URL: https://schema.org/HyperToc
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+HyperToc)

A HyperToc represents a hypertext table of contents for complex media objects, such as

[VideoObject](/VideoObject),[AudioObject](/AudioObject). Items in the table of contents are indicated using the[tocEntry](/tocEntry)property, and typed[HyperTocEntry](/HyperTocEntry). For cases where the same larger work is split into multiple files,[associatedMedia](/associatedMedia)can be used on individual[HyperTocEntry](/HyperTocEntry)items.| Property | Expected Type | Description |
|---|---|---|
| Properties from
|
...
[HyperTocEntry](/HyperTocEntry)[HyperTocEntry](/HyperTocEntry)in a[HyperToc](/HyperToc).[CreativeWork](/CreativeWork)
