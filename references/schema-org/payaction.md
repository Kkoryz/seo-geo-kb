---
title: "PayAction"
source_url: https://schema.org/PayAction
category: schema-org
...
- Canonical URL: https://schema.org/PayAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+PayAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John paid US$ 1,500 for a flight.--> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "PayAction", "agent": { "@type": "Person", "name": "John" }, "price": "1500", "priceCurrency": "USD", "recipient": { "@type": "Organization", "name": "An Airline" } } </script>
