---
title: "Clip"
source_url: https://schema.org/Clip
category: schema-org
...
- Canonical URL: https://schema.org/Clip
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+Clip)
...
[HyperTocEntry](/HyperTocEntry)or[Number](/Number)```
```[musicBy](/musicBy)
...
[HyperTocEntry](/HyperTocEntry)or[Number](/Number)[CreativeWork](/CreativeWork)
...
[Clip](/Clip)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|

[CreativeWork](/CreativeWork)[video](/video)
