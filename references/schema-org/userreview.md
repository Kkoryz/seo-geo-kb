---
title: "UserReview"
source_url: https://schema.org/UserReview
category: schema-org
...
- Canonical URL: https://schema.org/UserReview
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+UserReview)

A review created by an end-user (e.g. consumer, purchaser, attendee etc.), in contrast with

[CriticReview](/CriticReview).| Property | Expected Type | Description |
|---|---|---|
| Properties from
|
