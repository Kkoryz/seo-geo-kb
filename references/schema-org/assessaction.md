---
title: "AssessAction"
source_url: https://schema.org/AssessAction
category: schema-org
...
- Canonical URL: https://schema.org/AssessAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+AssessAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John assessed a scholar paper. --> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "AssessAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "ScholarlyArticle", "name": "Does P = NP?" } } </script>
