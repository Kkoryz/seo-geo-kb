---
title: "Episode"
source_url: https://schema.org/Episode
category: schema-org
...
- Canonical URL: https://schema.org/Episode
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+Episode)
...
[Episode](/Episode)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|

[CreativeWorkSeason](/CreativeWorkSeason)or[RadioSeries](/RadioSeries)or[TVSeries](/TVSeries)or[VideoGameSeries](/VideoGameSeries)[episodes](/episodes)

[CreativeWorkSeason](/CreativeWorkSeason)or[RadioSeries](/RadioSeries)or[TVSeries](/TVSeries)or[VideoGameSeries](/VideoGameSeries)[partOfEpisode](/partOfEpisode)
