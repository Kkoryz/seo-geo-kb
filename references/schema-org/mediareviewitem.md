...
source_url: https://schema.org/MediaReviewItem
category: schema-org
...
- Canonical URL: https://schema.org/MediaReviewItem
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+MediaReviewItem)

Represents an item or group of closely related items treated as a unit for the sake of evaluation in a

[MediaReview](/MediaReview). Authorship etc. apply to the items rather than to the curation/grouping or reviewing party.| Property | Expected Type | Description |
|---|---|---|
| Properties from
|
...
[MediaObject](/MediaObject)[MediaReview](/MediaReview), indicates specific media item(s) that are grouped using a[MediaReviewItem](/MediaReviewItem).[CreativeWork](/CreativeWork)
