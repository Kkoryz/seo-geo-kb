...
source_url: https://schema.org/HealthPlanFormulary
category: schema-org
...
- Canonical URL: https://schema.org/HealthPlanFormulary
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+HealthPlanFormulary)
...
[Boolean](/Boolean)or[HealthPlanCostSharingSpecification](/HealthPlanCostSharingSpecification)```
...
[HealthPlanFormulary](/HealthPlanFormulary)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|

[HealthInsurancePlan](/HealthInsurancePlan)#### Source
