---
title: "ImageObject"
source_url: https://schema.org/ImageObject
category: schema-org
...
- Canonical URL: https://schema.org/ImageObject
- Equivalent Class: dcmitype:Image
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+ImageObject)
...
[PropertyValue](/PropertyValue)or[Text](/Text)```
```[representativeOfPage](/representativeOfPage)

[Boolean](/Boolean)[MediaObject](/MediaObject)
...
[ImageObject](/ImageObject)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|

[Product](/Product)[Product](/Product). Should match the textual description specified in the[color](/color)property. This can be a URL or a fully described ImageObject.[diagram](/diagram)

[AnatomicalStructure](/AnatomicalStructure)[image](/image)

[Thing](/Thing)[URL](/URL)or a fully described[ImageObject](/ImageObject).[layoutImage](/layoutImage)

[FloorPlan](/FloorPlan)[logo](/logo)

[Brand](/Brand)or[Certification](/Certification)or[Organization](/Organization)or[Place](/Place)or[Product](/Product)or[Service](/Service)[photo](/photo)

[Place](/Place)[photos](/photos)

[Place](/Place)[primaryImageOfPage](/primaryImageOfPage)

[WebPage](/WebPage)[screenshot](/screenshot)

[SoftwareApplication](/SoftwareApplication)[thumbnail](/thumbnail)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<script type="application/ld+json"> { "@context": "https://schema.org", "@type": "ImageObject", "author": "Jane Doe", "contentLocation": "Puerto Vallarta, Mexico", "contentUrl": "mexico-beach.jpg", "datePublished": "2008-01-25", "description": "I took this picture while on vacation last year.", "name": "Beach in Mexico" } </script>
