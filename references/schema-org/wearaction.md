---
title: "WearAction"
source_url: https://schema.org/WearAction
category: schema-org
...
- Canonical URL: https://schema.org/WearAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+WearAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John wore Calvin Klein. --> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "WearAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "Brand", "name": "Calvin Klein" } } </script>
