---
title: "Physician"
source_url: https://schema.org/Physician
category: schema-org
...
- Canonical URL: https://schema.org/Physician
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+Physician)

An individual physician or a physician's office considered as a

[MedicalOrganization](/MedicalOrganization).| Property | Expected Type | Description |
|---|---|---|
| Properties from
|
