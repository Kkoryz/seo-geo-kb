---
title: "AcceptAction"
source_url: https://schema.org/AcceptAction
category: schema-org
...
- Canonical URL: https://schema.org/AcceptAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+AcceptAction)
...
[RejectAction](/RejectAction): The antonym of AcceptAction.
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John accepted a plan to exercise-->. <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "AcceptAction", "agent": { "@type": "Person", "name": "John" }, "participant": { "@type": "Person", "name": "John's trainer" }, "object": { "@type": "ExercisePlan", "name": "John's weight loss plan" } } </script>
