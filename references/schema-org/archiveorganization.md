...
source_url: https://schema.org/ArchiveOrganization
category: schema-org
...
- Canonical URL: https://schema.org/ArchiveOrganization
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+ArchiveOrganization)
...
[ArchiveComponent](/ArchiveComponent)[fonds](https://en.wikipedia.org/wiki/Fonds), or item held, kept or maintained by an[ArchiveOrganization](/ArchiveOrganization).Inverse property:

[holdingArchive](/holdingArchive)[LocalBusiness](/LocalBusiness)
...
[ArchiveOrganization](/ArchiveOrganization)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|

[ArchiveComponent](/ArchiveComponent)[ArchiveOrganization](/ArchiveOrganization)that holds, keeps or maintains the[ArchiveComponent](/ArchiveComponent).#### Source
