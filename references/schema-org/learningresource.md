...
source_url: https://schema.org/LearningResource
category: schema-org
...
- Canonical URL: https://schema.org/LearningResource
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+LearningResource)

The LearningResource type can be used to indicate





[CreativeWork](/CreativeWork)s (whether physical or digital) that have a particular and explicit orientation towards learning, education, skill acquisition, and other educational purposes.[LearningResource](/LearningResource)is expected to be used as an addition to a primary type such as[Book](/Book),[VideoObject](/VideoObject),[Product](/Product)etc.[EducationEvent](/EducationEvent)serves a similar purpose for event-like things (e.g. a[Trip](/Trip)). A[LearningResource](/LearningResource)may be created as a result of an[EducationEvent](/EducationEvent), for example by recording one.| Property | Expected Type | Description |
|---|---|---|
| Properties from
|
...
[DefinedTerm](/DefinedTerm)or[Text](/Text)[CreativeWork](/CreativeWork)
