---
title: "TipAction"
source_url: https://schema.org/TipAction
category: schema-org
...
- Canonical URL: https://schema.org/TipAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+TipAction)
...
[Audience](/Audience)or[ContactPoint](/ContactPoint)or[Organization](/Organization)or[Person](/Person)[TradeAction](/TradeAction)
...
[PriceSpecification](/PriceSpecification)[Action](/Action)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John tipped $10 to Steve.--> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "TipAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "MonetaryAmount", "currency": "USD", "value": "10" }, "recipient": { "@type": "Person", "name": "Steve" } } </script>
