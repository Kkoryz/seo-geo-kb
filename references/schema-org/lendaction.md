---
title: "LendAction"
source_url: https://schema.org/LendAction
category: schema-org
...
- Canonical URL: https://schema.org/LendAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+LendAction)
...
[BorrowAction](/BorrowAction): Reciprocal of LendAction.
...
[Person](/Person)[TransferAction](/TransferAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John lent $10 to Steve.--> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "LendAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "MonetaryAmount", "currency": "USD", "value": "10" }, "borrower": { "@type": "Person", "name": "Steve" } } </script>
