...
source_url: https://schema.org/MedicalSignOrSymptom
category: schema-org
...
- Canonical URL: https://schema.org/MedicalSignOrSymptom
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+MedicalSignOrSymptom)
...
[Drug](/Drug)or[DrugClass](/DrugClass)or[LifestyleModification](/LifestyleModification)or[MedicalTherapy](/MedicalTherapy)[MedicalCondition](/MedicalCondition)
...
[MedicalSignOrSymptom](/MedicalSignOrSymptom)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|

[DDxElement](/DDxElement)[signOrSymptom](/signOrSymptom)

[MedicalCondition](/MedicalCondition)#### More specific Types
