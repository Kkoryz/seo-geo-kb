...
source_url: https://schema.org/RuntimePlatform
category: schema-org
...
- Canonical URL: https://schema.org/RuntimePlatform
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+RuntimePlatform)
...
[RuntimePlatform](/RuntimePlatform)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|

[SoftwareApplication](/SoftwareApplication)or[SoftwareSourceCode](/SoftwareSourceCode)#### Source
