...
source_url: https://schema.org/CollegeOrUniversity
category: schema-org
...
- Canonical URL: https://schema.org/CollegeOrUniversity
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+CollegeOrUniversity)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<script type="application/ld+json"> { "@context": "https://schema.org/", "@type": "CollegeOrUniversity", "name": "ACME Community College", "hasCredential": { "@type": "EducationalOccupationalCredential", "credentialCategory": "Accreditation", "recognizedBy": { "@type": "Organization", "name": "Accrediting Commission of Career Schools and Colleges" } } } </script>
