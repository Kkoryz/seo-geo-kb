...
source_url: https://schema.org/BefriendAction
category: schema-org
...
- Canonical URL: https://schema.org/BefriendAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+BefriendAction)
...
[FollowAction](/FollowAction): Unlike FollowAction, BefriendAction implies that the connection is reciprocal.
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John befriended Steve. --> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "BefriendAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "Person", "name": "Steve" } } </script>
