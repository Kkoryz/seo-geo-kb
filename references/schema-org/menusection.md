---
title: "MenuSection"
source_url: https://schema.org/MenuSection
category: schema-org
...
- Canonical URL: https://schema.org/MenuSection
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+MenuSection)
...
[MenuSection](/MenuSection)[CreativeWork](/CreativeWork)
...
[MenuSection](/MenuSection)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|

[Menu](/Menu)or[MenuSection](/MenuSection)[menuAddOn](/menuAddOn)
