---
title: "3DModel"
source_url: https://schema.org/3DModel
category: schema-org
...
- Canonical URL: https://schema.org/3DModel
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+3DModel)

A 3D model represents some kind of 3D content, which may have

[encoding](/encoding)s in one or more[MediaObject](/MediaObject)s. Many 3D formats are available (e.g. see[Wikipedia](https://en.wikipedia.org/wiki/Category:3D_graphics_file_formats)); specific encoding formats can be represented using the[encodingFormat](/encodingFormat)property applied to the relevant[MediaObject](/MediaObject). For the case of a single file published after Zip compression, the convention of appending '+zip' to the[encodingFormat](/encodingFormat)can be used. Geospatial, AR/VR, artistic/animation, gaming, engineering and scientific content can all be represented using[3DModel](/3DModel).| Property | Expected Type | Description |
|---|---|---|
| Properties from
|
