...
source_url: https://schema.org/HealthInsurancePlan
category: schema-org
...
- Canonical URL: https://schema.org/HealthInsurancePlan
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+HealthInsurancePlan)
...
[HealthInsurancePlan](/HealthInsurancePlan)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|
