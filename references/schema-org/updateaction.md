---
title: "UpdateAction"
source_url: https://schema.org/UpdateAction
category: schema-org
...
- Canonical URL: https://schema.org/UpdateAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+UpdateAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John updated his movie collection.--> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "UpdateAction", "agent": { "@type": "Person", "name": "John" }, "targetCollection": { "@type": "ItemList", "name": "List of my favorite movies", "url": "http://netflix.com/john/favorite" } } </script>
