...
source_url: https://schema.org/HowToDirection
category: schema-org
...
- Canonical URL: https://schema.org/HowToDirection
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+HowToDirection)
...
[MediaObject](/MediaObject)or[URL](/URL)```
...
[Duration](/Duration)[ISO 8601 duration format](http://en.wikipedia.org/wiki/ISO_8601).[CreativeWork](/CreativeWork)
...
[translationOfWork](/translationOfWork)[ListItem](/ListItem)
