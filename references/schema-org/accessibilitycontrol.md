...
source_url: https://schema.org/accessibilityControl
category: schema-org
...
- Canonical URL: https://schema.org/accessibilityControl
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+accessibilityControl)

Identifies input methods that are sufficient to fully control the described resource. Values should be drawn from the

[approved vocabulary](https://www.w3.org/2021/a11y-discov-vocab/latest/#accessibilityControl-vocabulary).### Values expected to be one of these types
