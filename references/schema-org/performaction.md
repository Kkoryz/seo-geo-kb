---
title: "PerformAction"
source_url: https://schema.org/PerformAction
category: schema-org
...
- Canonical URL: https://schema.org/PerformAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+PerformAction)
...
[EntertainmentBusiness](/EntertainmentBusiness)[PlayAction](/PlayAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John performed as a DJ playing Daft Punk on his turntable at Woodstock.--> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "PerformAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "MusicRecording", "name": "Daft Punk" }, "instrument": { "@type": "Product", "name": "Turntable" }, "event": { "@type": "Festival", "name": "Woodstock" } } </script>
