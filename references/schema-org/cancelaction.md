---
title: "CancelAction"
source_url: https://schema.org/CancelAction
category: schema-org
...
- Canonical URL: https://schema.org/CancelAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+CancelAction)
...
[ConfirmAction](/ConfirmAction): The antonym of CancelAction.
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John cancelled a trip with a travel agency.--> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "CancelAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "Event", "name": "John's trip" }, "instrument": { "@type": "TravelAgency", "name": "AFS" } } </script>
