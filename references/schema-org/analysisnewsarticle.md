...
source_url: https://schema.org/AnalysisNewsArticle
category: schema-org
...
- Canonical URL: https://schema.org/AnalysisNewsArticle
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+AnalysisNewsArticle)

An AnalysisNewsArticle is a

[NewsArticle](/NewsArticle)that, while based on factual reporting, incorporates the expertise of the author/producer, offering interpretations and conclusions.| Property | Expected Type | Description |
|---|---|---|
| Properties from
|
