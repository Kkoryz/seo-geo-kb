...
source_url: https://schema.org/SoftwareSourceCode
category: schema-org
...
[Text](/Text)[sampleType](/sampleType).```
```[programmingLanguage](/programmingLanguage)

[ComputerLanguage](/ComputerLanguage)or[Text](/Text)```
```[runtimePlatform](/runtimePlatform)

[RuntimePlatform](/RuntimePlatform)or[Text](/Text)[runtime](/runtime).```
```[targetProduct](/targetProduct)

[SoftwareApplication](/SoftwareApplication)[CreativeWork](/CreativeWork)
