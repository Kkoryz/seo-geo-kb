---
title: "DataCatalog"
source_url: https://schema.org/DataCatalog
category: schema-org
...
- Canonical URL: https://schema.org/DataCatalog
- Equivalent Class: dcat:Catalog
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+DataCatalog)
...
[Dataset](/Dataset)Inverse property:
...
[DataCatalog](/DataCatalog)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|

[Dataset](/Dataset)[includedDataCatalog](/includedDataCatalog)

[Dataset](/Dataset)[includedInDataCatalog](/includedInDataCatalog)

[Dataset](/Dataset)### Acknowledgements
