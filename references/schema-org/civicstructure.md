...
source_url: https://schema.org/CivicStructure
category: schema-org
...
- Canonical URL: https://schema.org/CivicStructure
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+CivicStructure)
...
[CivicStructure](/CivicStructure)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|

[SpecialAnnouncement](/SpecialAnnouncement)[CivicStructure](/CivicStructure)or[LocalBusiness](/LocalBusiness)associated with the SpecialAnnouncement. For example, a specific testing facility or business with special opening hours. For a larger geographic region like a quarantine of an entire region, use[spatialCoverage](/spatialCoverage).#### More specific Types
