...
source_url: https://schema.org/SoftwareApplication
category: schema-org
...
- Canonical URL: https://schema.org/SoftwareApplication
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+SoftwareApplication)
...
[OperatingSystem](/OperatingSystem)or[Text](/Text)```
...
[RuntimePlatform](/RuntimePlatform)or[Text](/Text)[runtime](/runtime).```
...
[SoftwareApplication](/SoftwareApplication)or[Text](/Text)or[URL](/URL)[requirements](/requirements).```
...
[DataFeed](/DataFeed)[CreativeWork](/CreativeWork)
...
[SoftwareApplication](/SoftwareApplication)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|
...
[EntryPoint](/EntryPoint)[interactionService](/interactionService)

[InteractionCounter](/InteractionCounter)[softwareAddOn](/softwareAddOn)

[SoftwareApplication](/SoftwareApplication)[softwareRequirements](/softwareRequirements)

[SoftwareApplication](/SoftwareApplication)[targetProduct](/targetProduct)

[SoftwareSourceCode](/SoftwareSourceCode)#### More specific Types
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<script type="application/ld+json"> { "@context": "https://schema.org/", "@type": "VideoGame", "name": "Whale Rider", "operatingSystem": { "@type": "OperatingSystem", "name": "Door", "softwareVersion": "44" }, "softwareRequirements": { "@type": "RuntimePlatform", "name": "Passive Y", "softwareVersion": "31" } } </script>
