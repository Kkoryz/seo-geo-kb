---
title: "RejectAction"
source_url: https://schema.org/RejectAction
category: schema-org
...
- Canonical URL: https://schema.org/RejectAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+RejectAction)
...
[AcceptAction](/AcceptAction): The antonym of RejectAction.
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John rejected a plan to exercise.--> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "RejectAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "ExercisePlan", "name": "John's weight loss plan" } } </script>
