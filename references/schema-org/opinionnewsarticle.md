...
source_url: https://schema.org/OpinionNewsArticle
category: schema-org
...
- Canonical URL: https://schema.org/OpinionNewsArticle
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+OpinionNewsArticle)

An

[OpinionNewsArticle](/OpinionNewsArticle)is a[NewsArticle](/NewsArticle)that primarily expresses opinions rather than journalistic reporting of news and events. For example, a[NewsArticle](/NewsArticle)consisting of a column or[Blog](/Blog)/[BlogPosting](/BlogPosting)entry in the Opinions section of a news publication.| Property | Expected Type | Description |
|---|---|---|
| Properties from
|
