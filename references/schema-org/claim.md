---
title: "Claim"
source_url: https://schema.org/Claim
category: schema-org
...
- Canonical URL: https://schema.org/Claim
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+Claim)
...
[Claim](/Claim)in Schema.org represents a specific, factually-oriented claim that could be the[itemReviewed](/itemReviewed)in a[ClaimReview](/ClaimReview). The content of a claim can be summarized with the[text](/text)property. Variations on well known claims can have their common identity indicated via[sameAs](/sameAs)links, and summarized with a[name](/name). Ideally, a[Claim](/Claim)description includes enough contextual information to minimize the risk of ambiguity or inclarity. In practice, many claims are better understood in the context in which they appear or the interpretations provided by claim reviews.Beyond

[ClaimReview](/ClaimReview), the Claim type can be associated with related creative works - for example a[ScholarlyArticle](/ScholarlyArticle)or[Question](/Question)might be[about](/about)some[Claim](/Claim).At this time, Schema.org does not define any types of relationship between claims. This is a natural area for future exploration.
...
[CreativeWork](/CreativeWork)[Claim](/Claim)in some[CreativeWork](/CreativeWork).```
```[claimInterpreter](/claimInterpreter)

[Organization](/Organization)or[Person](/Person)[Claim](/Claim)interpreted from[MediaObject](/MediaObject)content, the[interpretedAsClaim](/interpretedAsClaim)property can be used to indicate a claim contained, implied or refined from the content of a[MediaObject](/MediaObject).```
```[firstAppearance](/firstAppearance)

[CreativeWork](/CreativeWork)[Claim](/Claim)in some[CreativeWork](/CreativeWork).[CreativeWork](/CreativeWork)
...
[Claim](/Claim)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|

[CreativeWork](/CreativeWork)or[MediaObject](/MediaObject)[MediaObject](/MediaObject)or other[CreativeWork](/CreativeWork). The interpreting party can be indicated using[claimInterpreter](/claimInterpreter).#### Source
