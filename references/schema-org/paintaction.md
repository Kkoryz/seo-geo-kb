---
title: "PaintAction"
source_url: https://schema.org/PaintAction
category: schema-org
...
- Canonical URL: https://schema.org/PaintAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+PaintAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John painted Les Demoiselles d'Avignon.--> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "PaintAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "Painting", "name": "Les Demoiselles d'Avignon" } } </script>
