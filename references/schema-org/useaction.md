---
title: "UseAction"
source_url: https://schema.org/UseAction
category: schema-org
...
- Canonical URL: https://schema.org/UseAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+UseAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John used an exercise plan. --> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "UseAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "ExercisePlan", "name": "How to lose 100 calories a day." } } </script>
