---
title: "RentAction"
source_url: https://schema.org/RentAction
category: schema-org
...
- Canonical URL: https://schema.org/RentAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+RentAction)
...
[RealEstateAgent](/RealEstateAgent)[TradeAction](/TradeAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John rented a house from Steve.--> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "RentAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "Residence", "name": "Steve's place" }, "landlord": { "@type": "Person", "name": "Steve" } } </script>
