---
title: "TieAction"
source_url: https://schema.org/TieAction
category: schema-org
...
- Canonical URL: https://schema.org/TieAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+TieAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John tied on a match of chess with Steve. --> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "WinAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "SoftwareApplication", "name": "chess" }, "participant": { "@type": "Person", "name": "Steve" } } </script>
