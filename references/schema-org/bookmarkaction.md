...
source_url: https://schema.org/BookmarkAction
category: schema-org
...
- Canonical URL: https://schema.org/BookmarkAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+BookmarkAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John bookmarked a photo using instagram.--> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "BookmarkAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "ImageObject", "name": "Steve", "url": "http://john.com/steve.jpg" }, "instrument": { "@type": "Product", "name": "Instagram" } } </script>
