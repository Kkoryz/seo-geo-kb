---
title: "LibrarySystem"
source_url: https://schema.org/LibrarySystem
category: schema-org
...
- Canonical URL: https://schema.org/LibrarySystem
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+LibrarySystem)

A

[LibrarySystem](/LibrarySystem)is a collaborative system amongst several libraries.| Property | Expected Type | Description |
|---|---|---|
| Properties from
|
