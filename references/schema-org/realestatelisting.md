...
source_url: https://schema.org/RealEstateListing
category: schema-org
...
- Canonical URL: https://schema.org/RealEstateListing
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+RealEstateListing)

A

[RealEstateListing](/RealEstateListing)is a listing that describes one or more real-estate[Offer](/Offer)s (whose[businessFunction](/businessFunction)is typically to lease out, or to sell). The[RealEstateListing](/RealEstateListing)type itself represents the overall listing, as manifested in some[WebPage](/WebPage).| Property | Expected Type | Description |
|---|---|---|
| Properties from
|
...
[Duration](/Duration)or[QuantitativeValue](/QuantitativeValue)[Accommodation](/Accommodation), either particular to some[Offer](/Offer)or in some cases intrinsic to the property.[WebPage](/WebPage)
