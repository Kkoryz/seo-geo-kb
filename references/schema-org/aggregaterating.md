...
- Canonical URL: https://schema.org/AggregateRating
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+AggregateRating)
...
[AggregateRating](/AggregateRating)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|

[Brand](/Brand)or[CreativeWork](/CreativeWork)or[Event](/Event)or[Offer](/Offer)or[Organization](/Organization)or[Place](/Place)or[Product](/Product)or[Service](/Service)#### More specific Types
