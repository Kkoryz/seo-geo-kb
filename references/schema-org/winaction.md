---
title: "WinAction"
source_url: https://schema.org/WinAction
category: schema-org
...
- Canonical URL: https://schema.org/WinAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+WinAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John won a book about the Nobel prize. --> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "WinAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "Book", "name": "Top 1000 Things You Didn't Know about Nobel prizes" } } </script>
