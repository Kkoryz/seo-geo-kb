---
title: "CreateAction"
source_url: https://schema.org/CreateAction
category: schema-org
...
- Canonical URL: https://schema.org/CreateAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+CreateAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John created a web page. --> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "CreateAction", "agent": { "@type": "Person", "name": "John" }, "result": { "@type": "WebPage", "name": "John's thought about the web" } } </script>
