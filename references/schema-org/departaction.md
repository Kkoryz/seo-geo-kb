---
title: "DepartAction"
source_url: https://schema.org/DepartAction
category: schema-org
...
- Canonical URL: https://schema.org/DepartAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+DepartAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John departed from the hotel. --> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "DepartAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "Hotel", "name": "The Hilton" } } </script>
