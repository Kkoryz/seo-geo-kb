...
source_url: https://schema.org/MedicalRiskFactor
category: schema-org
...
- Canonical URL: https://schema.org/MedicalRiskFactor
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+MedicalRiskFactor)
...
[MedicalRiskFactor](/MedicalRiskFactor)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|

[MedicalRiskEstimator](/MedicalRiskEstimator)[riskFactor](/riskFactor)
