---
title: "MenuItem"
source_url: https://schema.org/MenuItem
category: schema-org
...
- Canonical URL: https://schema.org/MenuItem
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+MenuItem)
...
[MenuItem](/MenuItem)or[MenuSection](/MenuSection)```
```[nutrition](/nutrition)
...
[Diet](/Diet)or[RestrictedDiet](/RestrictedDiet)[Thing](/Thing)
...
[MenuItem](/MenuItem)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|

[Menu](/Menu)or[MenuSection](/MenuSection)[itemOffered](/itemOffered)

[Demand](/Demand)or[Offer](/Offer)[businessFunction](/businessFunction), e.g. sell, lease etc. While several common expected types are listed explicitly in this definition, others can be used. Using a second type, such as Product or a subtype of Product, can clarify the nature of the offer.[menuAddOn](/menuAddOn)

[MenuItem](/MenuItem)### Examples
