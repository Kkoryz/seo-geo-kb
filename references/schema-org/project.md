---
title: "Project"
source_url: https://schema.org/Project
category: schema-org
...
- Canonical URL: https://schema.org/Project
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+Project)

An enterprise (potentially individual but typically collaborative), planned to achieve a particular aim.
Use properties from

[Organization](/Organization),[subOrganization](/subOrganization)/[parentOrganization](/parentOrganization)to indicate project sub-structures.| Property | Expected Type | Description |
|---|---|---|
| Properties from
|
