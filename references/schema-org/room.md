---
title: "Room"
source_url: https://schema.org/Room
category: schema-org
...
- Canonical URL: https://schema.org/Room
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+Room)
...
[http://en.wikipedia.org/wiki/Room](http://en.wikipedia.org/wiki/Room)).See also the
