---
title: "BuyAction"
source_url: https://schema.org/BuyAction
category: schema-org
...
- Canonical URL: https://schema.org/BuyAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+BuyAction)
...
[Organization](/Organization)or[Person](/Person)[vendor](/vendor),[merchant](/merchant).[TradeAction](/TradeAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John bought a Book on amazon.com.--> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "BuyAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "Book", "name": "Outliers" }, "seller": { "@type": "Organization", "name": "Amazon" } } </script>
