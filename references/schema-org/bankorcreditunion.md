...
source_url: https://schema.org/BankOrCreditUnion
category: schema-org
...
- Canonical URL: https://schema.org/BankOrCreditUnion
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+BankOrCreditUnion)
...
[Text](/Text)or[URL](/URL)[LocalBusiness](/LocalBusiness)
...
[BankOrCreditUnion](/BankOrCreditUnion)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|

[MoneyTransfer](/MoneyTransfer)### Examples
