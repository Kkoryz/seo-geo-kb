...
source_url: https://schema.org/InteractAction
category: schema-org
...
- Canonical URL: https://schema.org/InteractAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+InteractAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John interacted with Steve.--> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "InteractAction", "agent": { "@type": "Person", "name": "John" }, "participant": { "@type": "Person", "name": "Steve" } } </script>
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John interacted with the IEEE. --> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "InteractAction", "agent": { "@type": "Person", "name": "John" }, "participant": { "@type": "Organization", "name": "IEEE" } } </script>
