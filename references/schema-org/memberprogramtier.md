...
source_url: https://schema.org/MemberProgramTier
category: schema-org
...
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+MemberProgramTier)
...
[CreditCard](/CreditCard)or[MonetaryAmount](/MonetaryAmount)or[Text](/Text)or[UnitPriceSpecification](/UnitPriceSpecification)```
```[isTierOf](/isTierOf)

[MemberProgram](/MemberProgram)Inverse property:

[hasTiers](/hasTiers)```
```[membershipPointsEarned](/membershipPointsEarned)

[Number](/Number)or[QuantitativeValue](/QuantitativeValue)[Thing](/Thing)
...
[MemberProgramTier](/MemberProgramTier)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|

[MemberProgram](/MemberProgram)[memberOf](/memberOf)

[Organization](/Organization)or[Person](/Person)[validForMemberTier](/validForMemberTier)

[MerchantReturnPolicy](/MerchantReturnPolicy)or[Offer](/Offer)or[OfferShippingDetails](/OfferShippingDetails)or[PriceSpecification](/PriceSpecification)or[ShippingService](/ShippingService)#### Source
