...
source_url: https://schema.org/DiscoverAction
category: schema-org
...
- Canonical URL: https://schema.org/DiscoverAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+DiscoverAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John discovered a Pink! --> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "DiscoverAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "MusicRecording", "name": "Pink" } } </script>
