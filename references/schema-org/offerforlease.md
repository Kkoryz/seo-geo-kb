---
title: "OfferForLease"
source_url: https://schema.org/OfferForLease
category: schema-org
...
- Canonical URL: https://schema.org/OfferForLease
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+OfferForLease)

An

[OfferForLease](/OfferForLease)in Schema.org represents an[Offer](/Offer)to lease out something, i.e. an[Offer](/Offer)whose[businessFunction](/businessFunction)is[lease out](http://purl.org/goodrelations/v1#LeaseOut.). See[Good Relations](https://en.wikipedia.org/wiki/GoodRelations)for background on the underlying concepts.| Property | Expected Type | Description |
|---|---|---|
| Properties from
|
