---
title: "Hospital"
source_url: https://schema.org/Hospital
category: schema-org
...
- Canonical URL: https://schema.org/Hospital
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+Hospital)
...
[CDCPMDRecord](/CDCPMDRecord)or[Dataset](/Dataset)[CDCPMDRecord](/CDCPMDRecord)or as some kind of[Dataset](/Dataset).```
```[medicalSpecialty](/medicalSpecialty)

[MedicalSpecialty](/MedicalSpecialty)[CivicStructure](/CivicStructure)
...
[Hospital](/Hospital)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|

[Physician](/Physician)### Examples
