---
title: "DrinkAction"
source_url: https://schema.org/DrinkAction
category: schema-org
...
- Canonical URL: https://schema.org/DrinkAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+DrinkAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John drank a coke. --> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "DrinkAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "Product", "name": "Coke" } } </script>
