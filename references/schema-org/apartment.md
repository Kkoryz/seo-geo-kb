---
title: "Apartment"
source_url: https://schema.org/Apartment
category: schema-org
...
- Canonical URL: https://schema.org/Apartment
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+Apartment)
...
[http://en.wikipedia.org/wiki/Apartment](http://en.wikipedia.org/wiki/Apartment)).| Property | Expected Type | Description |
|---|---|---|
| Properties from
|
