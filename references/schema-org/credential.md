---
title: "Credential"
source_url: https://schema.org/Credential
category: schema-org
...
- Canonical URL: https://schema.org/Credential
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+Credential)
...
[Credential](/Credential)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|

[Organization](/Organization)or[Person](/Person)[qualifications](/qualifications)

[JobPosting](/JobPosting)or[Occupation](/Occupation)#### More specific Types
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<script type="application/ld+json"> { "@context": "https://schema.org/", "@type": "ProfilePage", "name": "u/ahuff1999", "mainEntity": { "@type": "Person", "name": "Angelo Huff", "alternateName": "ahuff1999", "identifier": "123475623", "hasCredential": { "@type": "Credential", "credentialCategory": "verified", "recognizedBy": { "@type": "Organization", "name": "Big Social Media" } } } } </script>
