---
title: "AssignAction"
source_url: https://schema.org/AssignAction
category: schema-org
...
- Canonical URL: https://schema.org/AssignAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+AssignAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- Dr. John assigned an exercise plan to Steve.--> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "AssignAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "ExercisePlan", "name": "Steve's weight loss plan" }, "participant": { "@type": "Person", "name": "Steve" } } </script>
