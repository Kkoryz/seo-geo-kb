...
source_url: https://schema.org/CategoryCodeSet
category: schema-org
...
- Canonical URL: https://schema.org/CategoryCodeSet
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+CategoryCodeSet)
...
[CategoryCode](/CategoryCode)[DefinedTermSet](/DefinedTermSet)
...
[DefinedTerm](/DefinedTerm)[CreativeWork](/CreativeWork)
...
[CategoryCodeSet](/CategoryCodeSet)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|

[CategoryCode](/CategoryCode)[CategoryCodeSet](/CategoryCodeSet)that contains this category code.#### Source
