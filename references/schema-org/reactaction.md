---
title: "ReactAction"
source_url: https://schema.org/ReactAction
category: schema-org
...
- Canonical URL: https://schema.org/ReactAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+ReactAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John reacted to a scholar paper claiming that P = NP!. --> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "ReactAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "ScholarlyArticle", "name": "We found out that P = NP!" } } </script>
