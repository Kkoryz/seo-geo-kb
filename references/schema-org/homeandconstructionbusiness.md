...
source_url: https://schema.org/HomeAndConstructionBusiness
category: schema-org
...
- Canonical URL: https://schema.org/HomeAndConstructionBusiness
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+HomeAndConstructionBusiness)
...
[LocalBusiness](/LocalBusiness)that provides services around homes and buildings.As a

[LocalBusiness](/LocalBusiness)it can be described as a[provider](/provider)of one or more[Service](/Service)(s).| Property | Expected Type | Description |
|---|---|---|
| Properties from
|
