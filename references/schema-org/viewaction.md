---
title: "ViewAction"
source_url: https://schema.org/ViewAction
category: schema-org
...
- Canonical URL: https://schema.org/ViewAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+ViewAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John viewed Les demoiselles d'avignon. --> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "ViewAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "Painting", "name": "Les demoiselles d'avignon" } } </script>
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John viewed a photo of Steve. --> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "ViewAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "ImageObject", "name": "Steve" } } </script>
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John viewed The Thinker. --> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "ViewAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "Sculpture", "name": "The Thinker" } } </script>
