---
title: "MediaObject"
source_url: https://schema.org/MediaObject
category: schema-org
...
- Canonical URL: https://schema.org/MediaObject
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+MediaObject)
...
[MediaObject](/MediaObject)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|

[HowToDirection](/HowToDirection)[associatedMedia](/associatedMedia)

[CreativeWork](/CreativeWork)or[HyperToc](/HyperToc)or[HyperTocEntry](/HyperTocEntry)[beforeMedia](/beforeMedia)

[HowToDirection](/HowToDirection)[caption](/caption)

[AudioObject](/AudioObject)or[ImageObject](/ImageObject)or[VideoObject](/VideoObject)[encodingFormat](/encodingFormat).[duringMedia](/duringMedia)

[HowToDirection](/HowToDirection)[encoding](/encoding)

[CreativeWork](/CreativeWork)[encodings](/encodings)

[CreativeWork](/CreativeWork)[mediaItemAppearance](/mediaItemAppearance)

[MediaReviewItem](/MediaReviewItem)[MediaReview](/MediaReview), indicates specific media item(s) that are grouped using a[MediaReviewItem](/MediaReviewItem).[originalMediaLink](/originalMediaLink)
