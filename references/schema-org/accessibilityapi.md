...
source_url: https://schema.org/accessibilityAPI
category: schema-org
...
- Canonical URL: https://schema.org/accessibilityAPI
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+accessibilityAPI)

Indicates that the resource is compatible with the referenced accessibility API. Values should be drawn from the

[approved vocabulary](https://www.w3.org/2021/a11y-discov-vocab/latest/#accessibilityAPI-vocabulary).### Values expected to be one of these types
