---
title: "Blog"
source_url: https://schema.org/Blog
category: schema-org
...
- Canonical URL: https://schema.org/Blog
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+Blog)

A

[blog](https://en.wikipedia.org/wiki/Blog), sometimes known as a "weblog". Note that the individual posts ([BlogPosting](/BlogPosting)s) in a[Blog](/Blog)are often colloquially referred to by the same term.| Property | Expected Type | Description |
|---|---|---|
| Properties from
|
...
[BlogPosting](/BlogPosting)[blogPosts](/blogPosts).```
```[issn](/issn)
