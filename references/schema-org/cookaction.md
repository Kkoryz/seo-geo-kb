---
title: "CookAction"
source_url: https://schema.org/CookAction
category: schema-org
...
- Canonical URL: https://schema.org/CookAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+CookAction)
...
[FoodEstablishment](/FoodEstablishment)or[Place](/Place)```
```[foodEvent](/foodEvent)

[FoodEvent](/FoodEvent)```
```[recipe](/recipe)

[Recipe](/Recipe)[Action](/Action)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John cooked a dinner.--> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "CookAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "Thing", "name": "dinner!" } } </script>
