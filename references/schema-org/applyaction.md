---
title: "ApplyAction"
source_url: https://schema.org/ApplyAction
category: schema-org
...
- Canonical URL: https://schema.org/ApplyAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+ApplyAction)
...
[RegisterAction](/RegisterAction): Unlike RegisterAction, ApplyAction has no guarantees that the application will be accepted.
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John applied to Harvard.--> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "ApplyAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "CollegeOrUniversity", "name": "Harvard" } } </script>
