...
source_url: https://schema.org/VideoGameSeries
category: schema-org
...
- Canonical URL: https://schema.org/VideoGameSeries
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+VideoGameSeries)
...
[Text](/Text)or[Thing](/Thing)or[URL](/URL)[video games](http://en.wikipedia.org/wiki/Category:Video_game_platforms).```
```[musicBy](/musicBy)
