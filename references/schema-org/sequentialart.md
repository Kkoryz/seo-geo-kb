---
title: "SequentialArt"
source_url: https://schema.org/SequentialArt
category: schema-org
...
- Canonical URL: https://schema.org/SequentialArt
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+SequentialArt)
...
[Integer](/Integer)[VisualArtwork](/VisualArtwork)
...
[Text](/Text)or[URL](/URL)[surface](/surface).```
```[colorist](/colorist)
