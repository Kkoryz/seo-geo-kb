---
title: "CommentAction"
source_url: https://schema.org/CommentAction
category: schema-org
...
- Canonical URL: https://schema.org/CommentAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+CommentAction)
...
[Comment](/Comment)[CommunicateAction](/CommunicateAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John commented on a blog post. --> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "CommentAction", "agent": { "@type": "Person", "name": "John" }, "resultComment": { "@type": "Comment", "text": "That's cool!" }, "about": { "@type": "ScholarlyArticle", "name": "We found that P = NP!" } } </script>
