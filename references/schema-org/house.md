---
title: "House"
source_url: https://schema.org/House
category: schema-org
...
- Canonical URL: https://schema.org/House
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+House)
...
[http://en.wikipedia.org/wiki/House](http://en.wikipedia.org/wiki/House)).| Property | Expected Type | Description |
|---|---|---|
| Properties from
|
...
[Number](/Number)or[QuantitativeValue](/QuantitativeValue)[Accommodation](/Accommodation)
