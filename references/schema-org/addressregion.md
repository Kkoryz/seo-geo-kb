---
title: "addressRegion"
source_url: https://schema.org/addressRegion
category: schema-org
...
- Canonical URL: https://schema.org/addressRegion
- Equivalent Property: fibo-fnd-plc-adr:hasCountrySubdivision
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+addressRegion)

The region in which the locality is, and which is in the country. For example, California or another appropriate first-level

[Administrative division](https://en.wikipedia.org/wiki/List_of_administrative_divisions_by_country)such as the Province in Italy or Region in Germany.### Values expected to be one of these types
