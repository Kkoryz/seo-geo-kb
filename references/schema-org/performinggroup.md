...
source_url: https://schema.org/PerformingGroup
category: schema-org
...
- Canonical URL: https://schema.org/PerformingGroup
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+PerformingGroup)
...
[PerformingGroup](/PerformingGroup)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|
