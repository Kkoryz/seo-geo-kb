---
title: "FindAction"
source_url: https://schema.org/FindAction
category: schema-org
...
- Canonical URL: https://schema.org/FindAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+FindAction)
...
[SearchAction](/SearchAction): FindAction is generally lead by a SearchAction, but not necessarily.
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John found the answer to life. --> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "FindAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "QuantitativeValue", "name": "42" } } </script>
