---
title: "HyperTocEntry"
source_url: https://schema.org/HyperTocEntry
category: schema-org
...
- Canonical URL: https://schema.org/HyperTocEntry
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+HyperTocEntry)

A HyperToEntry is an item within a

[HyperToc](/HyperToc), which represents a hypertext table of contents for complex media objects, such as[VideoObject](/VideoObject),[AudioObject](/AudioObject). The media object itself is indicated using[associatedMedia](/associatedMedia). Each section of interest within that content can be described with a[HyperTocEntry](/HyperTocEntry), with associated[startOffset](/startOffset)and[endOffset](/endOffset). When several entries are all from the same file,[associatedMedia](/associatedMedia)is used on the overarching[HyperTocEntry](/HyperTocEntry); if the content has been split into multiple files, they can be referenced using[associatedMedia](/associatedMedia)on each[HyperTocEntry](/HyperTocEntry).| Property | Expected Type | Description |
|---|---|---|
| Properties from
|
...
[HyperTocEntry](/HyperTocEntry)[HyperTocEntry](/HyperTocEntry)can have a[tocContinuation](/tocContinuation)indicated, which is another[HyperTocEntry](/HyperTocEntry)that would be the default next item to play or render.```
```[utterances](/utterances)

[Text](/Text)[HyperTocEntry](/HyperTocEntry).[CreativeWork](/CreativeWork)
...
[HyperTocEntry](/HyperTocEntry)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|

[Clip](/Clip)[startOffset](/startOffset)

[Clip](/Clip)or[SeekToAction](/SeekToAction)[tocContinuation](/tocContinuation)

[HyperTocEntry](/HyperTocEntry)[HyperTocEntry](/HyperTocEntry)can have a[tocContinuation](/tocContinuation)indicated, which is another[HyperTocEntry](/HyperTocEntry)that would be the default next item to play or render.[tocEntry](/tocEntry)

[HyperToc](/HyperToc)[HyperTocEntry](/HyperTocEntry)in a[HyperToc](/HyperToc).#### Source
