---
title: "Quotation"
source_url: https://schema.org/Quotation
category: schema-org
...
- Canonical URL: https://schema.org/Quotation
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+Quotation)

A quotation. Often but not necessarily from some written work, attributable to a real world author and - if associated with a fictional character - to any fictional Person. Use

[isBasedOn](/isBasedOn)to link to source/origin. The[recordedIn](/recordedIn)property can be used to reference a Quotation from an[Event](/Event).| Property | Expected Type | Description |
|---|---|---|
| Properties from
|
...
[Organization](/Organization)or[Person](/Person)[CreativeWork](/CreativeWork)
