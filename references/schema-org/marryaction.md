---
title: "MarryAction"
source_url: https://schema.org/MarryAction
category: schema-org
...
- Canonical URL: https://schema.org/MarryAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+MarryAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John married Ann. --> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "MarryAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "Person", "name": "Ann" } } </script>
