---
title: "TVEpisode"
source_url: https://schema.org/TVEpisode
category: schema-org
...
- Canonical URL: https://schema.org/TVEpisode
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+TVEpisode)
...
[Movie](/Movie),[TVEpisode](/TVEpisode),[TVSeason](/TVSeason), and[TVSeries](/TVSeries)can be used for both works and their multiple expressions, it is possible to use[titleEIDR](/titleEIDR)alone (for a general description), or alongside[editEIDR](/editEIDR)for a more edit-specific description.[Episode](/Episode)
...
[CreativeWorkSeries](/CreativeWorkSeries)[partOfTVSeries](/partOfTVSeries).```
