...
source_url: https://schema.org/AuthorizeAction
category: schema-org
...
- Canonical URL: https://schema.org/AuthorizeAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+AuthorizeAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- Dr. John authorized Steve's diet.--> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "AuthorizeAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "Diet", "name": "Steve's weight loss plan" }, "participant": { "@type": "Person", "name": "Steve" } } </script>
