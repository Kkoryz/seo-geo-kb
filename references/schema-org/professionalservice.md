...
source_url: https://schema.org/ProfessionalService
category: schema-org
...
- Canonical URL: https://schema.org/ProfessionalService
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+ProfessionalService)
...
[ProfessionalService](/ProfessionalService)type for local businesses was deprecated due to confusion with[Service](/Service). For reference, the types that it included were:[Dentist](/Dentist),[AccountingService](/AccountingService),[Attorney](/Attorney),[Notary](/Notary), as well as types for several kinds of[HomeAndConstructionBusiness](/HomeAndConstructionBusiness):[Electrician](/Electrician),[GeneralContractor](/GeneralContractor),[HousePainter](/HousePainter),[Locksmith](/Locksmith),[Plumber](/Plumber),[RoofingContractor](/RoofingContractor).[LegalService](/LegalService)was introduced as a more inclusive supertype of[Attorney](/Attorney).| Property | Expected Type | Description |
|---|---|---|
| Properties from
|
