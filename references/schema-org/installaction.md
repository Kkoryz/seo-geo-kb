---
title: "InstallAction"
source_url: https://schema.org/InstallAction
category: schema-org
...
- Canonical URL: https://schema.org/InstallAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+InstallAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John installed fitbit. --> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "InstallAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "MobileApplication", "name": "Fitbit" } } </script>
