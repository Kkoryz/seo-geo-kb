---
title: "BusStop"
source_url: https://schema.org/BusStop
category: schema-org
...
- Canonical URL: https://schema.org/BusStop
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+BusStop)
...
[BusStop](/BusStop)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|

[BusTrip](/BusTrip)[departureBusStop](/departureBusStop)

[BusTrip](/BusTrip)### Examples
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<script type="application/ld+json"> { "@context": "https://schema.org", "@type": "BusStop", "name": "BusStop#7594", "openingHours": "Mo-Su", "address": { "@type": "PostalAddress", "addressCountry": "CA", "addressLocality": "Ottawa", "addressRegion": "ON" }, "latitude": 45.429620, "longitude": -75.683866 } </script>
