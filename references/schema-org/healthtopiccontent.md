...
source_url: https://schema.org/HealthTopicContent
category: schema-org
...
- Canonical URL: https://schema.org/HealthTopicContent
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+HealthTopicContent)

[HealthTopicContent](/HealthTopicContent)is

[WebContent](/WebContent)that is about some aspect of a health topic, e.g. a condition, its symptoms or treatments. Such content may be comprised of several parts or sections and use different types of media. Multiple instances of

[WebContent](/WebContent)(and hence

[HealthTopicContent](/HealthTopicContent)) can be related using

[hasPart](/hasPart)/

[isPartOf](/isPartOf)where there is some kind of content hierarchy, and their content described with

[about](/about)and

[mentions](/mentions)e.g. building upon the existing

[MedicalCondition](/MedicalCondition)vocabulary.
...
[HealthAspectEnumeration](/HealthAspectEnumeration)[HealthTopicContent](/HealthTopicContent). For example, that the content is an overview, or that it talks about treatment, self-care, treatments or their side-effects.[CreativeWork](/CreativeWork)
