---
title: "WebContent"
source_url: https://schema.org/WebContent
category: schema-org
...
- Canonical URL: https://schema.org/WebContent
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+WebContent)

WebContent is a type representing all

[WebPage](/WebPage),[WebSite](/WebSite)and[WebPageElement](/WebPageElement)content. It is sometimes the case that detailed distinctions between Web pages, sites and their parts are not always important or obvious. The[WebContent](/WebContent)type makes it easier to describe Web-addressable content without requiring such distinctions to always be stated. (The intent is that the existing types[WebPage](/WebPage),[WebSite](/WebSite)and[WebPageElement](/WebPageElement)will eventually be declared as subtypes of[WebContent](/WebContent).)| Property | Expected Type | Description |
|---|---|---|
| Properties from
|
...
[WebContent](/WebContent)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|

[Answer](/Answer)[diseasePreventionInfo](/diseasePreventionInfo)

[SpecialAnnouncement](/SpecialAnnouncement)[diseaseSpreadStatistics](/diseaseSpreadStatistics)

[SpecialAnnouncement](/SpecialAnnouncement)[WebContent](/WebContent), or described directly as a[Dataset](/Dataset), or the specific[Observation](/Observation)s in the dataset. When a[WebContent](/WebContent)URL is provided, the page indicated might also contain more such markup.[gettingTestedInfo](/gettingTestedInfo)

[SpecialAnnouncement](/SpecialAnnouncement)[MedicalCondition](/MedicalCondition)), e.g. in the context of a pandemic.[negativeNotes](/negativeNotes)
...
[SpecialAnnouncement](/SpecialAnnouncement)[SpecialAnnouncement](/SpecialAnnouncement)markup on a site.[positiveNotes](/positiveNotes)
...
[SpecialAnnouncement](/SpecialAnnouncement)[quarantineGuidelines](/quarantineGuidelines)

[SpecialAnnouncement](/SpecialAnnouncement)[schoolClosuresInfo](/schoolClosuresInfo)

[SpecialAnnouncement](/SpecialAnnouncement)[travelBans](/travelBans)

[SpecialAnnouncement](/SpecialAnnouncement)#### More specific Types
