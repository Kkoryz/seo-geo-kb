---
title: "WriteAction"
source_url: https://schema.org/WriteAction
category: schema-org
...
- Canonical URL: https://schema.org/WriteAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+WriteAction)
...
[Language](/Language)or[Text](/Text)[IETF BCP 47 standard](http://tools.ietf.org/html/bcp47). See also[availableLanguage](/availableLanguage). Supersedes[language](/language).[Action](/Action)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John wrote an article on algorithms. --> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "WriteAction", "agent": { "@type": "Person", "name": "John" }, "result": { "@type": "ScholarlyArticle", "name": "We found that P = NP!" } } </script>
