---
title: "OrderAction"
source_url: https://schema.org/OrderAction
category: schema-org
...
- Canonical URL: https://schema.org/OrderAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+OrderAction)
...
[DeliveryMethod](/DeliveryMethod)[TradeAction](/TradeAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John ordered a Book on amazon.com.--> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "OrderAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "Book", "name": "Outliers" }, "location": { "@type": "LocalBusiness", "name": "Amazon" } } </script>
