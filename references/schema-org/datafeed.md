---
title: "DataFeed"
source_url: https://schema.org/DataFeed
category: schema-org
...
- Canonical URL: https://schema.org/DataFeed
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+DataFeed)
...
[DataFeedItem](/DataFeedItem)or[Text](/Text)or[Thing](/Thing)[Dataset](/Dataset)
...
[DataFeed](/DataFeed)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|

[SoftwareApplication](/SoftwareApplication)[webFeed](/webFeed)

[PodcastSeries](/PodcastSeries)or[SpecialAnnouncement](/SpecialAnnouncement)#### More specific Types
...
Company Directory last modified: 2015-01-02 Alice: alice@example.com entry added: 2014-07-01 Bob: bob@example.com entry modified: 2015-01-02

Example encoded as

[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<script type="application/ld+json"> { "@context": "https://schema.org/", "@type": "DataFeed", "name": "Company directory", "dateModified": "2015-01-02", "dataFeedElement": [ { "@type": "DataFeedItem", "dateCreated": "2014-07-01", "item": { "@type": "Person", "name": "Alice", "email": "alice@example.com" } }, { "@type": "DataFeedItem", "dateModified": "2015-01-02", "item": { "@type": "Person", "name": "Bob", "email": "bob@example.com" } } ] } </script>
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<script type="application/ld+json"> { "@context": "https://schema.org/", "@type": "MobileApplication", "applicationCategory": "https://en.wikipedia.org/wiki/E-reader", "supportingData": { "@type": "DataFeed", "dataFeedElement": [ { "@type": "Book", "name": "Anna Karenina", "sameAs": "https://en.wikipedia.org/wiki/Anna_Karenina" }, { "@type": "Book", "name": "Pride and Prejudice", "sameAs": "https://en.wikipedia.org/wiki/Pride_and_Prejudice" }, { "@type": "Book", "name": "My Bondage and My Freedom", "sameAs": "https://en.wikipedia.org/wiki/My_Bondage_and_My_Freedom" } ] } } </script>
