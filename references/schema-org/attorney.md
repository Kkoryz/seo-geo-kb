---
title: "Attorney"
source_url: https://schema.org/Attorney
category: schema-org
...
- Canonical URL: https://schema.org/Attorney
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+Attorney)
...
[LegalService](/LegalService)is more inclusive and less ambiguous.| Property | Expected Type | Description |
|---|---|---|
| Properties from
|
