...
source_url: https://schema.org/DownloadAction
category: schema-org
...
- Canonical URL: https://schema.org/DownloadAction
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+DownloadAction)
...
[JSON-LD](https://en.wikipedia.org/wiki/JSON-LD)in a HTML script tag.<!-- John downloaded the java updates.--> <script type="application/ld+json"> { "@context": "https://schema.org", "@type": "DownloadAction", "agent": { "@type": "Person", "name": "John" }, "object": { "@type": "SoftwareApplication", "name": "Java Updates" } } </script>
