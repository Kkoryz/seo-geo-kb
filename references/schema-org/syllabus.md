---
title: "Syllabus"
source_url: https://schema.org/Syllabus
category: schema-org
...
- Canonical URL: https://schema.org/Syllabus
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+Syllabus)

A syllabus that describes the material covered in a course, often with several such sections per

[Course](/Course)so that a distinct[timeRequired](/timeRequired)can be provided for that section of the[Course](/Course).| Property | Expected Type | Description |
|---|---|---|
| Properties from
|
...
[Syllabus](/Syllabus)may appear as a value for the following properties| Property | On Types | Description |
|---|---|---|
|
|
