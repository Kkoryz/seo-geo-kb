...
source_url: https://schema.org/BackgroundNewsArticle
category: schema-org
...
- Canonical URL: https://schema.org/BackgroundNewsArticle
[Check for open issues.](https://github.com/schemaorg/schemaorg/issues?q=is%3Aissue+is%3Aopen+BackgroundNewsArticle)

A

[NewsArticle](/NewsArticle)providing historical context, definition and detail on a specific topic (aka "explainer" or "backgrounder"). For example, an in-depth article or frequently-asked-questions ([FAQ](https://en.wikipedia.org/wiki/FAQ)) document on topics such as Climate Change or the European Union. Other kinds of background material from a non-news setting are often described using[Book](/Book)or[Article](/Article), in particular[ScholarlyArticle](/ScholarlyArticle). See also[NewsArticle](/NewsArticle)for related vocabulary from a learning/education perspective.| Property | Expected Type | Description |
|---|---|---|
| Properties from
|
