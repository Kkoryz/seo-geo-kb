---
title: "Updates to Search Console's API | Google Search Central Blog | Google for Developers"
source_url: https://developers.google.com/search/blog/2020/12/search-console-api-updates
category: google-search-central
section: "Google Search Central — official technical SEO + structured data docs"
date: 2020-12-09
---

# Updates to Search Console's API | Google Search Central Blog | Google for Developers
...
[migrate the Discovery doc](/search/blog/2020/08/search-console-api-announcements#discovery-document-changes)
...
. The data you get for this value will also include fresh data that is not yet final. If you wish to get only final data,
you can either pass this parameter with value set to `final`
...
For all Webmasters service-related imports, change the `webmasters`

package to the `searchconsole.v1`

package,
and the service name, `Webmasters`
