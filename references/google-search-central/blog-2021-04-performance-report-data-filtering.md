---
title: "Improved data filtering and comparison on Performance reports | Google Search Central Blog | Google for Developers"
source_url: https://developers.google.com/search/blog/2021/04/performance-report-data-filtering
category: google-search-central
section: "Google Search Central — official technical SEO + structured data docs"
date: 2021-04-07
---

# Improved data filtering and comparison on Performance reports | Google Search Central Blog | Google for Developers
...
Starting today, the comparison mode fully supports cases where more than a single metric is selected, and we’ve improved the interface to make it easier to view those results side-by-side, almost doubling the area available for the data table. In addition, the comparison mode now supports the new regex filter for queries and pages.
