---
title: "Featured Snippets and Your Website | Google Search Central | Documentation | Google for Developers"
...
- Text marked by the
won't appear in featured snippets or regular snippets either.`data-nosnippet`

HTML attribute - If both
`nosnippet`

and`data-nosnippet`

rules appear in a page,`nosnippet`

takes priority, and snippets won't be shown for the page.
...
shorter your `max-snippet`

rule setting, the less likely the page
...
setting doesn't guarantee that Google will
