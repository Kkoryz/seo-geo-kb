---
title: "One year of Google Search Central | Google Search Central Blog | Google for Developers"
source_url: https://developers.google.com/search/blog/2021/11/one-year-of-search-central
category: google-search-central
section: "Google Search Central — official technical SEO + structured data docs"
date: 2021-11-17
---

# One year of Google Search Central | Google Search Central Blog | Google for Developers

Wednesday, November 17, 2021

A year ago, we [launched our new
site](/search/blog/2020/11/goodbye-google-webmasters) and announced that we were leaving our beloved name, Google Webmasters, behind for a new
...
[actually
came with a ton of work](https://search-off-the-record.libsyn.com/launching-google-search-central-step-by-step) to execute (we were absolutely shocked by this, I tell you).
...
improve our [title elements](/search/docs/appearance/title-link) and
[descriptions](/search/docs/appearance/snippet) across 200+ pages.
...
pages, when our page was just about [site
owner removals only](/search/docs/crawling-indexing/remove-information)).
...
It was also really fun to see reactions from the SEO community after the migration. We're active on Twitter and subscribe to all the SEO publications (we are just regular SEOs after all), so it was awesome to see the feedback, all the articles, and getting a shoutout on the

[Search Off The Record podcast].Thanks to Lizzi, John, and the rest of the Search Relations teams for the opportunity. We're looking forward to continuing our partnership and helping grow

[Google Search Central](shameless internal link plug).–Jason Stevens, Growth Lab SEO (Google's Internal SEO Team)
...
- Simplified the
[introduction to the robots.txt page](/search/docs/crawling-indexing/robots/intro)to make it clearer what is robots.txt and what is its intended use, and expanded the instructions about[creating](/search/docs/crawling-indexing/robots/create-robots-txt)and[updating](/search/docs/crawling-indexing/robots/submit-updated-robots-txt)robots.txt files. - Added new guidance on
[How HTTP status codes, and network and DNS errors affect Google Search](/search/docs/crawling-indexing/http-network-errors). - Significantly expanded our
[redirects guide](/search/docs/crawling-indexing/301-redirects)with the different kinds of redirects and their effects on Google Search. - Wrote new documentation about
[Google Search operators](/search/docs/monitor-debug/search-operators). - Published a new set of guides for
[ecommerce in Google Search](/search/docs/specialty/ecommerce).
...
[parameters in the URL](/search/?card=owner). The simplified
...
SEOs worked in [Keyword Planner](https://ads.google.com/home/tools/keyword-planner/)
...
[JavaScript redirects](/search/docs/crawling-indexing/301-redirects#jslocation)are just as good as[meta redirects](/search/docs/crawling-indexing/301-redirects#metarefresh). - RSS is still popular enough that we had to
[add it to the new blog](https://feeds.feedburner.com/blogspot/amDG). - De-SEOing is as weird as it sounds, but you REALLY want to capture the good traffic.
...
we should add to our site next year? Let us know on [Twitter](https://twitter.com/search?q=%23SearchCentral2022&src=typed_query)
