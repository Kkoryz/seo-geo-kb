---
title: "View-all in search results | Google Search Central Blog | Google for Developers"
source_url: https://developers.google.com/search/blog/2011/09/view-all-in-search-results
category: google-search-central
section: "Google Search Central — official technical SEO + structured data docs"
date: 2011-09-15
---

# View-all in search results | Google Search Central Blog | Google for Developers
...
-
**If your site includes view-all pages:**We aim to detect the view-all version of your content and, if available, its associated component pages. There's nothing more you need to do! However, if you'd like to make it more explicit to us, you can include`rel="canonical"`

from your component pages to your view-all to increase the likelihood that we detect your series of pages appropriately.*Why does this work?*In the diagram,`page-2.html`

of a series may specify the canonical target as`page-all.html`

because`page-all.html`

is a superset of`page-2.html`

's content. When a user searches for a query term and`page-all.html`

is selected in search results, even if the query most related to`page-2.html`

, we know the user will still see`page-2.html`

's relevant information within`page-all.html`

.On the other hand,

`page-2.html`

shouldn't designate`page-1.html`

as the canonical because`page-2.html`

's content isn't included on`page-1.html`

. It's possible that a user's search query is relevant to content on`page-2.html`

, but if`page-2.html`

's canonical is set to`page-1.html`

, the user could then select`page-1.html`
...
using any of the standard methods.`noindex`


-
Make sure the component pages in the series don't include
-
**If you'd like to surface individual, component pages (or there's no view-all available)**: It may be the case that one or both of the situations below apply to your site:- The view-all page is undesirable as a search result (for example, load time too high or too difficult for users to navigate).
...
to specify a relationship between the component pages in your series of content. If done correctly, Google will generally strive to:`rel="next"`

and`rel="prev"`

elements- Consolidate indexing properties, such as links, between the component pages/URLs.
...
attributes as a strong hint for Google to identify the series of pages and still surface a component page in results.`rel="next"`
