---
title: "New Search experiences in EEA: Rich results, aggregator units, and refinement chips | Google Search Central Blog | Google for Developers"
source_url: https://developers.google.com/search/blog/2024/02/search-experiences-in-eea
category: google-search-central
section: "Google Search Central — official technical SEO + structured data docs"
date: 2024-02-15
---

# New Search experiences in EEA: Rich results, aggregator units, and refinement chips | Google Search Central Blog | Google for Developers
...
With these new experiences, users in EEA countries searching for queries such as "hotels near me" may notice more visual and entity focused results. These experiences aim to:
...
[structured data](/search/docs/appearance/structured-data/intro-structured-data)in the markup of a web page to display graphical elements or interactive experiences. Today we're sharing more about a new carousel rich result for travel, local, and shopping queries. Each tile in these new carousels may have information about the price, rating, and images for entities on the page. Users can scroll horizontally to see more entities from a given site. If a web page doesn't have structured data markup on the page, then the standard
...
-
For queries related to ground transportation, hotels, vacation rentals, jobs, local business, and
things to do (for example, events, tours, and activities), use this
[interest form](https://support.google.com/websearch/contact/search_dma) -
For flights queries, use this
[interest form](https://support.google.com/travel/contact/flight_queries_interest) -
For shopping queries, get started with the
[Comparison Shopping Services (CSS) program](https://support.google.com/css-center/answer/7524491)
