---
title: "New for education sites: Practice problems and Math solvers structured data | Google Search Central Blog | Google for Developers"
source_url: https://developers.google.com/search/blog/2021/03/education-sites-practice-problems-math-solver
category: google-search-central
section: "Google Search Central — official technical SEO + structured data docs"
date: 2021-03-25
---

# New for education sites: Practice problems and Math solvers structured data | Google Search Central Blog | Google for Developers
...
In this post, we provide details to help you implement structured data on your [
practice problem](/search/docs/appearance/structured-data/practice-problems) and [math solver](/search/docs/appearance/structured-data/math-solvers) pages to make
...
property for each practice problem that you want to be featured. The structured data must appear on the same page as the practice problem a user can interact with on your web page. - Your web page must include all required structured data properties as described under
[required](/search/docs/appearance/structured-data/practice-problems#structured-data-type-definitions).`Quiz`
