---
title: "BigQuery efficiency tips for Search Console bulk data exports | Google Search Central Blog | Google for Developers"
source_url: https://developers.google.com/search/blog/2023/06/bigquery-efficiency-tips
...
clause does **not**affect the amount of data read.

Since the tables exported are date-partitioned, you can limit the input scan to only days of interest, especially
when you're testing and playing with the data. Use a `WHERE`

clause to limit the date range
