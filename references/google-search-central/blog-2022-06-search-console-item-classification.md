---
title: "Simplifying Search Console reports with an updated item classification | Google Search Central Blog | Google for Developers"
source_url: https://developers.google.com/search/blog/2022/06/search-console-item-classification
category: google-search-central
section: "Google Search Central — official technical SEO + structured data docs"
date: 2022-06-15
---

# Simplifying Search Console reports with an updated item classification | Google Search Central Blog | Google for Developers

Wednesday, June 15, 2022

We are simplifying the way we classify pages, items, and issues in Search Console reports. We hope this will help you focus on critical issues that affect your visibility in Search, and will help you better prioritize your work. We will roll out this change to all properties gradually over the next few months, so you might not see any changes for now.
...
URL Inspection tool](https://support.google.com/webmasters/answer/9012289) when inspecting a particular URL inside Search Console.
