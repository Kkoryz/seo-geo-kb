---
title: "Ad Networks & Translation Search Features | Google Search Central | Documentation | Google for Developers"
source_url: https://developers.google.com/search/docs/appearance/ad-network-and-translation
category: google-search-central
section: "Google Search Central — official technical SEO + structured data docs"
date: 2025-12-10
---

# Ad Networks & Translation Search Features | Google Search Central | Documentation | Google for Developers
...
(comma) character and save it as`encoding_list`
...
and the output begins with`0-`

, remove the`0-`

prefix from the output of step 3. If you removed the prefix, set`is_idn`

to`true`

. Otherwise, set`is_idn`
