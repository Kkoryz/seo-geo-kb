---
title: "A Guide to Google Search Ranking Systems | Google Search Central | Documentation | Google for Developers"
source_url: https://developers.google.com/search/docs/appearance/ranking-systems-guide
...
[canonical markup](/search/docs/crawling-indexing/consolidate-duplicate-urls)
...
The [reviews system](/search/updates/reviews-update) aims to better
...
including [SpamBrain](/search/blog/2022/04/webspam-report-2021), to deal with
content and behaviors that violate our [spam policies](/search/docs/essentials/spam-policies).
These systems are constantly [updated](/search/updates/spam-updates) to keep up
...
[Announced in 2022](/search/blog/2022/08/helpful-content-update) as the
...
traffic. In March 2024, it evolved and [became part of](/search/blog/2024/03/core-update-spam-policies)
...
This was a system designed to combat link spam. [Announced in 2012](/search/blog/2012/04/another-step-to-reward-high-quality)
and given the nickname of the "Penguin Update", it was [integrated](/search/blog/2016/09/penguin-is-now-part-of-our-core)
