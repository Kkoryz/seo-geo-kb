---
title: "Remove your own site's images from Google Search | Google Search Central | Documentation | Google for Developers"
source_url: https://developers.google.com/search/docs/crawling-indexing/prevent-images-on-your-page
category: google-search-central
section: "Google Search Central — official technical SEO + structured data docs"
date: 2025-12-10
---

# Remove your own site's images from Google Search | Google Search Central | Documentation | Google for Developers
...
doesn't provide a way to block images with the `noindex`
...
site that hosts the image, for example `https://yoursite.example.com/robots.txt`
...
For example, if you want Google to exclude the `dogs.jpg`

image that appears on your
site at `yoursite.example.com/images/dogs.jpg`
...
The next time Google crawls the `dogs.jpg`

image, we'll see this rule and drop your
...
To remove multiple images on your site from Google's index, add a `disallow`
...
To remove all files of a specific file type (for example, to include `.jpg`

but not
`.gif`

images), you'd use the following robots.txt entry:
...
###
Remove images with the `noindex`
...
Note that adding the `noimageindex`

robots tag to a particular page will also prevent
...
blocked no matter where it appears, use the `noindex`
