---
title: "Googlebot will soon speak HTTP/2 | Google Search Central Blog | Google for Developers"
source_url: https://developers.google.com/search/blog/2020/09/googlebot-will-soon-speak-http2
category: google-search-central
section: "Google Search Central — official technical SEO + structured data docs"
date: 2020-09-17
---

# Googlebot will soon speak HTTP/2 | Google Search Central Blog | Google for Developers
...
**Multiplexing and concurrency**: Fewer TCP connections open means fewer resources spent.**Header compression**: Drastically reduced HTTP header sizes will save resources.**Server push**: This feature is not yet enabled; it's still in the evaluation phase. It may be beneficial for rendering, but we don't have anything specific to say about it at this point.
