---
title: "Announcing mobile first indexing for the whole web | Google Search Central Blog | Google for Developers"
source_url: https://developers.google.com/search/blog/2020/03/announcing-mobile-first-indexing-for
category: google-search-central
section: "Google Search Central — official technical SEO + structured data docs"
date: 2020-03-05
---

# Announcing mobile first indexing for the whole web | Google Search Central Blog | Google for Developers
...
[structured data](/search/docs/appearance/structured-data/search-gallery)is the same. It's good to double-check these when a website is launched or significantly redesigned. In the

[URL Testing Tools](https://support.google.com/webmasters/answer/9012289)you can easily check both desktop and mobile versions directly. If you use other tools to analyze your website, such as crawlers or monitoring tools, use a mobile user-agent if you want to match what Google Search sees.
