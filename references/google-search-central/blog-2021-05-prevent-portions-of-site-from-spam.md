---
title: "Prevent portions of your site from being abused by spam | Google Search Central Blog | Google for Developers"
source_url: https://developers.google.com/search/blog/2021/05/prevent-portions-of-site-from-spam
category: google-search-central
section: "Google Search Central — official technical SEO + structured data docs"
date: 2021-05-26
---

# Prevent portions of your site from being abused by spam | Google Search Central Blog | Google for Developers
...
your site's topic. For example, search for [

`site:your-domain-name viagra`

] or
[`site:your-domain-name watch online`
...
Alerts](https://www.google.com/alerts). Set up a [`site:your-domain-name spammy-keywords`

] alert using commercial
...
or [rel="ugc"](/search/docs/advanced/guidelines/qualify-outbound-links)
...
[Protect your site from user-generated spam](/search/blog/2017/01/protect-your-site-from-user-generated)[Ways to prevent comment spam](/search/docs/advanced/guidelines/prevent-comment-spam)[Preventing spam on host services](/search/docs/advanced/guidelines/free-web-hosters)[Applying best practices on internal search results](/search/docs/fundamentals/seo-starter-guide#no-find)[Fixing hacked pages](/web/fundamentals/security/hacked)
