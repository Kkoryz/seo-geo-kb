---
title: "More information on how Google generates titles for web page results | Google Search Central Blog | Google for Developers"
source_url: https://developers.google.com/search/blog/2021/09/more-info-about-titles
category: google-search-central
section: "Google Search Central — official technical SEO + structured data docs"
date: 2021-09-17
---

# More information on how Google generates titles for web page results | Google Search Central Blog | Google for Developers
...
Our system tries to understand if the title isn't accurately showing what a page is about. If so, it might modify the title so that the use better knows what to expect, like this:

Stuffed animals - Site Name

### Micro-boilerplate titles

Boilerplate titles are fairly easy to detect. We see the same title on all or nearly all the pages within a site. Micro-boilerplate titles are where we see boilerplate title elements within a subset of pages within a site. Our system detects and helps with these cases, just as we do with boilerplate title elements overall.
...
Our system can detect the season number used in large, prominent headline text and insert those in the title, so the titles are more helpful:
