---
title: "Announcing the store widget: build shopper confidence and drive sales | Google Search Central Blog | Google for Developers"
source_url: https://developers.google.com/search/blog/2025/09/store-widget
category: google-search-central
section: "Google Search Central — official technical SEO + structured data docs"
date: 2025-09-18
---

# Announcing the store widget: build shopper confidence and drive sales | Google Search Central Blog | Google for Developers

Thursday, September 18, 2025

When shoppers are online, knowing which store to buy from can be a tough decision. The new
[store widget powered by Google](https://support.google.com/merchants/answer/14428754)
...
The store widget is a dynamic, interactive element you can [embed directly onto any page](https://support.google.com/merchants/answer/14428754)
...
[store quality ratings](https://support.google.com/merchants/answer/14261098).
...
**Top Quality store widget**shows if your business earned[Top Quality store](https://support.google.com/googleshopping/answer/11115998)status, showcasing your dedication to a high-quality shopping experience: -
The

**Store rating widget**appears if you have a high Google store rating but aren't a top-quality merchant yet: -
The

**generic store widget**is for stores who are on the path to earn these badges:

## How retailers can participate

If you're a retailer and don't have the store widget enabled yet, learn
[how to participate](https://support.google.com/merchants/answer/14428754).
