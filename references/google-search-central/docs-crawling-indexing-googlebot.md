---
title: "What Is Googlebot | Google Search Central | Documentation | Google for Developers"
source_url: https://developers.google.com/search/docs/crawling-indexing/googlebot
category: google-search-central
section: "Google Search Central — official technical SEO + structured data docs"
date: 2026-02-03
---

# What Is Googlebot | Google Search Central | Documentation | Google for Developers
...
: a desktop crawler that simulates a user on desktop.**Googlebot Desktop**
...
[supported file type](/search/docs/crawling-indexing/indexable-file-types), and
...
[different limits](/crawling/docs/crawlers-fetchers/overview-google-crawlers#file-size-limits).
