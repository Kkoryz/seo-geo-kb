---
title: "Crawling December: HTTP caching | Google Search Central Blog | Google for Developers"
source_url: https://developers.google.com/search/blog/2024/12/crawling-december-caching
...
header must be formatted according to the[HTTP standard](https://www.rfc-editor.org/rfc/rfc9110.html). To avoid parsing issues, we recommend using the following date format: "Weekday, DD Mon YYYY HH:MM:SS Timezone". For example, "Fri, 4 Sep 1998 19:15:56 GMT". -
While not required, consider also setting the
`max-age`

field of the`Cache-Control`

header to help crawlers determine when to recrawl the specific URL. Set the value of the`max-age`
...
|
HTTP/1.1 200 OK Content-Type: text/plain Date: Fri, 4 Sep 1998 19:15:50 GMT |
HTTP/1.1 200 OK Content-Type: text/plain Date: Fri, 4 Sep 1998 19:15:50 GMT |
...
request headers.
|
GET /hello.world HTTP/1.1 Host: www.example.com Accept-Language: en, hu User-Agent: Googlebot/2.1 (+http://www.google.com/bot.html) |
GET /hello.world HTTP/1.1 Host: www.example.com Accept-Language: en, hu User-Agent: Googlebot/2.1 (+http://www.google.com/bot.html) |
