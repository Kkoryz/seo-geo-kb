---
title: "In-Depth Guide to How Google Search Works | Google Search Central | Documentation | Google for Developers"
...
-
Google downloads text, images, and videos from pages it found on the internet with automated programs called crawlers.**Crawling:** -
Google analyzes the text, images, and video files on the page, and stores the information in the Google index, which is a large database.**Indexing:** -
When a user searches on Google, Google returns information that's relevant to the user's query.**Serving search results:**
...
[Network issues](/crawling/docs/troubleshooting/dns-network-errors) -
...
[videos](/search/docs/appearance/video), and more.
