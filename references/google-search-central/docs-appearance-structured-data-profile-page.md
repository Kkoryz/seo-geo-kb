---
title: "Profile Page (ProfilePage) Schema Markup | Google Search Central | Documentation | Google for Developers"
...
# Profile Page (ProfilePage) Schema Markup | Google Search Central | Documentation | Google for Developers
...
and [Recipe](/search/docs/appearance/structured-data/recipe) structured data have authors,
and there are often several authors present in [discussion forum](/search/docs/appearance/structured-data/discussion-forum)
and [Q&A page](/search/docs/appearance/structured-data/qapage) structured data.
...
**Valid use cases**:- A user profile page on a forum or social media site
- An author page on a news site
- An "About Me" page on a blog site
- An employee page on a company website

**Invalid use cases**:- The main home page of a store (usually contains lots of non-profile info)
...
|---|---|
`dateCreated` |
The date and time that the profile was created, if applicable, in
|
`dateModified` |
The date and time that information in the profile was modified, if applicable, in
|
...
Google recognizes the following [https://schema.org/FollowAction](https://schema.org/FollowAction): The number of other accounts being followed.[https://schema.org/LikeAction](https://schema.org/LikeAction): The number of likes (generally of other entity's posts).[https://schema.org/WriteAction](https://schema.org/WriteAction): The number of posts.[https://schema.org/ShareAction](https://schema.org/ShareAction): The number of reshares of posts.
|
`alternateName` |
...
`image` |
The URL or Additional image guidelines: - Image URLs must be crawlable and indexable. To check if Google can access your URLs, use
the
...
Google recognizes the following [https://schema.org/FollowAction](https://schema.org/FollowAction): The number of followers.[https://schema.org/LikeAction](https://schema.org/LikeAction): The number of likes of this entity.[https://schema.org/BefriendAction](https://schema.org/BefriendAction): A bi-directional relationship.
|
`sameAs` |
