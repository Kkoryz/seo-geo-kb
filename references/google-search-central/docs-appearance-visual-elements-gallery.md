---
title: "Visual Elements Gallery of Google Search | Google Search Central | Documentation | Google for Developers"
source_url: https://developers.google.com/search/docs/appearance/visual-elements-gallery
category: google-search-central
section: "Google Search Central — official technical SEO + structured data docs"
date: 2026-02-04
---

# Visual Elements Gallery of Google Search | Google Search Central | Documentation | Google for Developers
...
more likely to show for image-seeking queries. Learn more about the |
|
Video result |
A result that's based on a video that's embedded on that web page. A video result is
more likely to show for video-seeking queries. Learn more about the |
|
...
|---|---|---|---|---|---|
## Favicon |
The small icon that's associated with the site. Learn how to |
||||
## Site name |
The name of the site. Learn how to |
||||
## Visible URL |
...
||
## Sitelinks group |
Two or more links from the same domain or its A sitelinks group contains two or more sitelinks:
|
...
|
## Attribution |
The source information for the web page that's embedding the image. Learn |
...
|
## Title link |
The title link for the video landing page. Learn how to |
## Attribution |
The source information for the video landing page. Learn |
## Upload date |
